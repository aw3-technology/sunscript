...
import { MenuRegistry, MenuId, SubmenuItemAction, registerAction2, MenuItemAction, Action2 } from '../../../../platform/actions/common/actions.js';
import { IMenuService } from '../../../../platform/actions/common/actions.service.js';
import { getMenuBarVisibility, hasNativeTitlebar, TitleBarSetting } from '../../../../platform/window/common/window.js';
import { IContextKeyService } from '../../../../platform/contextkey/common/contextkey.service.js';
import { Separator, toAction, ActionRunner, Action, SubmenuAction } from '../../../../base/common/actions.js';
import { addDisposableListener, EventType, Dimension } from '../../../../base/browser/dom.js';
import { IKeybindingService } from '../../../../platform/keybinding/common/keybinding.service.js';
import { isMacintosh, isNative, isWeb, isIOS } from '../../../../base/common/platform.js';
...
import { unmnemonicLabel, mnemonicMenuLabel } from '../../../../base/common/labels.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'File',
        original: 'File',
        mnemonicTitle: ( localize(6951, "&&File")),
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Edit',
        original: 'Edit',
        mnemonicTitle: ( localize(6952, "&&Edit"))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Selection',
        original: 'Selection',
        mnemonicTitle: ( localize(6953, "&&Selection"))
    },
    order: 3
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'View',
        original: 'View',
        mnemonicTitle: ( localize(6954, "&&View"))
    },
    order: 4
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Go',
        original: 'Go',
        mnemonicTitle: ( localize(6955, "&&Go"))
    },
    order: 5
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Terminal',
        original: 'Terminal',
        mnemonicTitle: ( localize(6956, "&&Terminal"))
    },
    order: 7
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Help',
        original: 'Help',
        mnemonicTitle: ( localize(6957, "&&Help"))
    },
    order: 8
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        ...
        mnemonicTitle: ( localize(6958, "Preferences"))
    },
...
class MenubarControl extends Disposable {
    ...
    notifyUserOfCustomMenubarAccessibility() {
        ...
        this.notificationService.prompt(Severity$1.Info, message, [
            {
                label: ( localize(6960, "Open Settings")),
                run: () => {
...
let CustomMenubarControl = class CustomMenubarControl extends MenubarControl {
            ...
            this._register(registerAction2(class extends Action2 {
                constructor() {
                    super({
                        ...
                        title: ( localize2(6961, 'Focus Application Menu')),
                        keybinding: {
                            primary: KeyMod$1.Alt | KeyCode.F10,
    ...
    getUpdateAction() {
        ...
        switch (state.type) {
            case StateType.Idle:
                return (
                     (new Action('update.check', ( localize(6962, "Check for &&Updates...")), undefined, true, () => this.updateService.checkForUpdates(true)))
                );
            case StateType.CheckingForUpdates:
                return (
                     (new Action('update.checking', ( localize(6963, "Checking for Updates...")), undefined, false))
                );
            case StateType.AvailableForDownload:
                return (
                     (new Action('update.downloadNow', ( localize(6964, "D&&ownload Update")), undefined, true, () => this.updateService.downloadUpdate()))
                );
            case StateType.Downloading:
                return (
                     (new Action('update.downloading', ( localize(6965, "Downloading Update...")), undefined, false))
                );
            case StateType.Downloaded:
                return isMacintosh ? null : ( (new Action('update.install', ( localize(6966, "Install &&Update...")), undefined, true, () => this.updateService.applyUpdate())));
            case StateType.Updating:
                return (
                     (new Action('update.updating', ( localize(6967, "Installing Update...")), undefined, false))
                );
            case StateType.Ready:
                return (
                     (new Action('update.restart', ( localize(6968, "Restart to &&Update")), undefined, true, () => this.updateService.quitAndInstall()))
                );
            default:
                return null;
        }
    ...
    getMenubarItemsDimensions() {
        if (this.menubar) {
            return (
                 (new Dimension(this.menubar.getWidth(), this.menubar.getHeight()))
            );
        }
        return (
             (new Dimension(0, 0))

...
import { EditorInputCapabilities, EditorsOrder, CloseDirection, isEditorInputWithOptionsAndGroup } from '../../../common/editor.js';
import { DiffEditorInput } from '../../../common/editor/diffEditorInput.js';
import { SideBySideEditorInput } from '../../../common/editor/sideBySideEditorInput.js';
import { columnToEditorGroup } from '../../../services/editor/common/editorGroupColumn.js';
import { GroupsOrder, GroupLocation, preferredSideBySideGroupDirection, GroupDirection } from '../../../services/editor/common/editorGroupsService.js';
...
function registerActiveEditorMoveCopyCommand() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(5535, "Move the active editor by tabs or groups")),
            args: [
                {
                    name: ( localize(5536, "Active editor move argument")),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(5538, "Copy the active editor by groups")),
            args: [
                {
                    name: ( localize(5539, "Active editor copy argument")),
                    description: ( localize(
                        5540,
...
function registerOpenEditorAtIndexCommands() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        KeybindingsRegistry.registerCommandAndKeybindingRule({
            ...
            weight: KeybindingWeight.WorkbenchContrib,
            when: undefined,
            primary: KeyMod$1.Alt | toKeyCode(visibleIndex),
            mac: { primary: KeyMod$1.WinCtrl | toKeyCode(visibleIndex) },
...
function registerFocusEditorGroupAtIndexCommands() {
    for (let groupIndex = 1; groupIndex < 8; groupIndex++) {
        KeybindingsRegistry.registerCommandAndKeybindingRule({
            ...
            weight: KeybindingWeight.WorkbenchContrib,
            when: undefined,
            primary: KeyMod$1.CtrlCmd | toKeyCode(groupIndex),
            handler: accessor => {
                const editorGroupsService = accessor.get(IEditorGroupsService);
                const configurationService = accessor.get(IConfigurationService);
...
function registerCloseEditorCommands() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        win: { primary: KeyMod$1.CtrlCmd | KeyCode.F4, secondary: [KeyMod$1.CtrlCmd | KeyCode.KeyW] },
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        weight: KeybindingWeight.WorkbenchContrib,
        when: undefined,
        primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.KeyW),
        handler: (accessor, ...args) => {
            const resolvedContext = resolveCommandsContext(args, accessor.get(IEditorService), accessor.get(IEditorGroupsService), accessor.get(IListService));
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        weight: KeybindingWeight.WorkbenchContrib,
        when: undefined,
        primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.KeyU),
        handler: (accessor, ...args) => {
            const resolvedContext = resolveCommandsContext(args, accessor.get(IEditorService), accessor.get(IEditorGroupsService), accessor.get(IListService));
            return Promise.all(( (resolvedContext.groupedEditors.map(async ({ group }) => {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        when: undefined,
        primary: undefined,
        mac: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyT },
        handler: (accessor, ...args) => {
            const resolvedContext = resolveCommandsContext(args, accessor.get(IEditorService), accessor.get(IEditorGroupsService), accessor.get(IListService));
            return Promise.all(( (resolvedContext.groupedEditors.map(async ({ group, editors }) => {
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5541, 'Split Editor in Group')),
                ...
                keybinding: {
                    ...
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Backslash)
                }
            });
        }
        run(accessor, ...args) {
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5542, 'Join Editor in Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5543, 'Toggle Split Editor in Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5544, 'Toggle Layout of Split Editor in Group')),
                category: Categories.View,
                precondition: SideBySideEditorActiveContext,
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5545, 'Focus First Side in Active Editor')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5546, 'Focus Second Side in Active Editor')),
                category: Categories.View,
                precondition: ( (ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext))),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5547, 'Focus Other Side in Active Editor')),
                category: Categories.View,
                precondition: ( (ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext))),
                f1: true
            });
...
function registerOtherEditorCommands() {
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        weight: KeybindingWeight.WorkbenchContrib,
        when: undefined,
        primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.Enter),
        handler: async (accessor, ...args) => {
            const resolvedContext = resolveCommandsContext(args, accessor.get(IEditorService), accessor.get(IEditorGroupsService), accessor.get(IListService));
            for (const { group, editors } of resolvedContext.groupedEditors) {
                for (const editor of editors) {
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5548, 'Toggle Editor Group Lock')),
                category: Categories.View,
                f1: true
            });
        }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5549, 'Lock Editor Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(5550, 'Unlock Editor Group')),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.Shift | KeyCode.Enter),
        handler: async (accessor, ...args) => {
            const resolvedContext = resolveCommandsContext(args, accessor.get(IEditorService), accessor.get(IEditorGroupsService), accessor.get(IListService));
            for (const { group, editors } of resolvedContext.groupedEditors) {
                for (const editor of editors) {

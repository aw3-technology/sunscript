...
import { EditorsOrder, EditorInputCapabilities, SaveReason, CloseDirection, EditorResourceAccessor, DEFAULT_EDITOR_ASSOCIATION } from '../../../common/editor.js';
...
import { GoFilter } from '../../../services/history/common/history.js';
import { IHistoryService } from '../../../services/history/common/history.service.js';
import { IKeybindingService } from '../../../../platform/keybinding/common/keybinding.service.js';
import { ICommandService } from '../../../../platform/commands/common/commands.service.js';
import { SPLIT_EDITOR, SPLIT_EDITOR_UP, SPLIT_EDITOR_DOWN, CLOSE_EDITOR_COMMAND_ID, UNPIN_EDITOR_COMMAND_ID, COPY_ACTIVE_EDITOR_COMMAND_ID, LAYOUT_EDITOR_GROUPS_COMMAND_ID, splitEditor, SPLIT_EDITOR_LEFT, SPLIT_EDITOR_RIGHT, TOGGLE_MAXIMIZE_EDITOR_GROUP, MOVE_ACTIVE_EDITOR_COMMAND_ID, MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, NEW_EMPTY_EDITOR_WINDOW_COMMAND_ID } from './editorCommands.js';
import { GroupOrientation, preferredSideBySideGroupDirection, GroupsOrder, GroupDirection, GroupLocation, GroupsArrangement, MergeGroupMode } from '../../../services/editor/common/editorGroupsService.js';
...
import { AutoSaveMode } from '../../../services/filesConfiguration/common/filesConfigurationService.js';
...
import { isNative, isWindows, isLinux } from '../../../../base/common/platform.js';
...
class SplitEditorAction extends AbstractSplitEditorAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9606, 'Split Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyCode.Backslash
            },
...
class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9607, 'Split Editor Orthogonal')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
            },
            category: Categories.View
        });
    }
...
class SplitEditorLeftAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9608, 'Split Editor Left')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorRightAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9609, 'Split Editor Right')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorUpAction extends ExecuteCommandAction {
    static { this.LABEL = ( localize(9610, "Split Editor Up")); }
    constructor() {
        super({
            id: SPLIT_EDITOR_UP,
            title: ( localize2(9610, "Split Editor Up")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorDownAction extends ExecuteCommandAction {
    static { this.LABEL = ( localize(9611, "Split Editor Down")); }
    constructor() {
        super({
            id: SPLIT_EDITOR_DOWN,
            title: ( localize2(9611, "Split Editor Down")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class JoinTwoGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9612, 'Join Editor Group with Next Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class JoinAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9613, 'Join All Editor Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class NavigateBetweenGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9614, 'Navigate Between Editor Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusActiveGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9615, 'Focus Active Editor Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusFirstGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9616, 'Focus First Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyCode.Digit1
            },
            category: Categories.View
...
class FocusLastGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9617, 'Focus Last Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusNextGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9618, 'Focus Next Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusPreviousGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9619, 'Focus Previous Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusLeftGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9620, 'Focus Left Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.LeftArrow)
            },
            category: Categories.View
...
class FocusRightGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9621, 'Focus Right Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.RightArrow)
            },
            category: Categories.View
...
class FocusAboveGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9622, 'Focus Editor Group Above')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.UpArrow)
            },
            category: Categories.View
...
class FocusBelowGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9623, 'Focus Editor Group Below')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.DownArrow)
            },
            category: Categories.View
...
let CloseEditorAction = class CloseEditorAction extends Action {
    ...
    static { this.LABEL = ( localize(9624, "Close Editor")); }
...
let UnpinEditorAction = class UnpinEditorAction extends Action {
    ...
    static { this.LABEL = ( localize(9625, "Unpin Editor")); }
    constructor(id, label, commandService) {
...
let CloseEditorTabAction = class CloseEditorTabAction extends Action {
    static { this.ID = 'workbench.action.closeActiveEditor'; }
    static { this.LABEL = ( localize(9626, "Close")); }
...
class RevertAndCloseEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9627, 'Revert and Close Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseLeftEditorsInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9628, 'Close Editors to the Left in Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class AbstractCloseAllAction extends Action2 {
    ...
    revertEditors(editorService, logService, progressService, editors) {
        return progressService.withProgress({
            ...
            delay: 800,
            title: ( localize(9629, "Reverting Editors...")),
...
class CloseAllEditorsAction extends AbstractCloseAllAction {
    ...
    static { this.LABEL = ( localize2(9630, 'Close All Editors')); }
    constructor() {
        super({
            ...
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyW)
            },
...
class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
    constructor() {
        super({
            ...
            title: ( localize2(9631, 'Close All Editor Groups')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyW)
            },
            category: Categories.View
        });
    }
...
class CloseEditorsInOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9632, 'Close Editors in Other Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseEditorInAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9633, 'Close Editor in All Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class MoveGroupLeftAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9634, 'Move Editor Group Left')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.LeftArrow)
            },
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class MoveGroupRightAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9635, 'Move Editor Group Right')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.RightArrow)
            },
            category: Categories.View
...
class MoveGroupUpAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9636, 'Move Editor Group Up')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.UpArrow)
            },
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class MoveGroupDownAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9637, 'Move Editor Group Down')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.DownArrow)
            },
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9638, 'Duplicate Editor Group Left')),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9639, 'Duplicate Editor Group Right')),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9640, 'Duplicate Editor Group Up')),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9641, 'Duplicate Editor Group Down')),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class MinimizeOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9642, 'Expand Editor Group')),
            f1: true,
            category: Categories.View,
...
class MinimizeOtherGroupsHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9643, 'Expand Editor Group and Hide Side Bars')),
            f1: true,
            category: Categories.View,
...
class ResetGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9644, 'Reset Editor Group Sizes')),
            f1: true,
            category: Categories.View
        });
    }
...
class ToggleGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9645, 'Toggle Editor Group Sizes')),
            f1: true,
            category: Categories.View
        });
    }
...
class MaximizeGroupHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9646, 'Maximize Editor Group and Hide Side Bars')),
            f1: true,
            category: Categories.View,
...
class ToggleMaximizeEditorGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9647, 'Toggle Maximize Editor Group')),
            f1: true,
            category: Categories.View,
            precondition: ( (ContextKeyExpr.or(
                EditorPartMultipleEditorGroupsContext,
            ...
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyM),
            },
            menu: [{
...
class OpenNextEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9648, 'Open Next Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyCode.PageDown,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.RightArrow,
                    secondary: [KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.BracketRight]
                }
            },
            category: Categories.View
        });
...
class OpenPreviousEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9649, 'Open Previous Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyCode.PageUp,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.LeftArrow,
                    secondary: [KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.BracketLeft]
                }
            },
            category: Categories.View
        });
...
class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9650, 'Open Next Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.PageDown),
                mac: {
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.RightArrow)
                }
            },
            category: Categories.View
        });
...
class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9651, 'Open Previous Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.PageUp),
                mac: {
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.LeftArrow)
                }
            },
            category: Categories.View
        });
...
class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9652, 'Open First Editor in Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9653, 'Open Last Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.Alt | KeyCode.Digit0,
                secondary: [KeyMod$1.CtrlCmd | KeyCode.Digit9],
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyCode.Digit0,
                    secondary: [KeyMod$1.CtrlCmd | KeyCode.Digit9]
                }
            },
            category: Categories.View
...
class NavigateForwardAction extends Action2 {
    ...
    static { this.LABEL = ( localize(9654, "Go Forward")); }
    constructor() {
        super({
            id: NavigateForwardAction.ID,
            title: {
                ...( localize2(9654, "Go Forward")),
                mnemonicTitle: ( localize(9655, "&&Forward"))
            },
            f1: true,
            ...
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                win: { primary: KeyMod$1.Alt | KeyCode.RightArrow },
                mac: { primary: KeyMod$1.WinCtrl | KeyMod$1.Shift | KeyCode.Minus },
                linux: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Minus }
            },
            menu: [
...
class NavigateBackwardsAction extends Action2 {
    ...
    static { this.LABEL = ( localize(9656, "Go Back")); }
    constructor() {
        super({
            id: NavigateBackwardsAction.ID,
            title: {
                ...( localize2(9656, "Go Back")),
                mnemonicTitle: ( localize(9657, "&&Back"))
            },
            f1: true,
            ...
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                win: { primary: KeyMod$1.Alt | KeyCode.LeftArrow },
                mac: { primary: KeyMod$1.WinCtrl | KeyCode.Minus },
                linux: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Minus }
            },
            menu: [
...
class NavigatePreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9658, 'Go Previous')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateForwardInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9659, 'Go Forward in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9660, 'Go Back in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9661, 'Go Previous in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastEditLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9662, 'Go to Last Edit Location')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyQ)
            }
        });
    }
    async run(accessor) {
...
class NavigateForwardInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9663, 'Go Forward in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9664, 'Go Back in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9665, 'Go Previous in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastNavigationLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9666, 'Go to Last Navigation Location')),
            f1: true
        });
    }
    async run(accessor) {
...
class ReopenClosedEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9667, 'Reopen Closed Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyT
            },
            category: Categories.View
        });
    }
...
class ClearRecentFilesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9668, 'Clear Recently Opened...')),
            f1: true,
    ...
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: ( localize(9669, "Do you want to clear all recently opened files and workspaces?")),
            detail: ( localize(9670, "This action is irreversible!")),
            primaryButton: ( localize(9671, "&&Clear"))
        });
        if (!confirmed) {
            return;
        }
...
class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9672, 'Show Editors in Active Group By Most Recently Used')),
            f1: true,
            category: Categories.View
        });
    }
...
class ShowAllEditorsByAppearanceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9673, 'Show All Editors By Appearance')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyP),
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Tab
                }
            },
            category: Categories.File
        });
...
class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9674, 'Show All Editors By Most Recently Used')),
            f1: true,
            category: Categories.View
        });
    }
...
class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9675, 'Quick Open Previous Recently Used Editor')),
            f1: true,
            category: Categories.View
...
class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9676, 'Quick Open Least Recently Used Editor')),
            f1: true,
            category: Categories.View
        }, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
    }
...
class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9677, 'Quick Open Previous Recently Used Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyCode.Tab,
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyCode.Tab
                }
            },
...
class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(9678, 'Quick Open Least Recently Used Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Tab,
                mac: {
                    primary: KeyMod$1.WinCtrl | KeyMod$1.Shift | KeyCode.Tab
                }
            },
            precondition: ( (ActiveEditorGroupEmptyContext.toNegated())),
            category: Categories.View
...
class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9679, 'Quick Open Previous Editor from History')),
            f1: true
        });
    }
    async run(accessor) {
...
class OpenNextRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9680, 'Open Next Recently Used Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9681, 'Open Previous Recently Used Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9682, 'Open Next Recently Used Editor In Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9683, 'Open Previous Recently Used Editor In Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class ClearEditorHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9684, 'Clear Editor History')),
            f1: true
        });
    }
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: ( localize(9685, "Do you want to clear the history of recently opened editors?")),
            detail: ( localize(9670, "This action is irreversible!")),
            primaryButton: ( localize(9671, "&&Clear"))
        });
        if (!confirmed) {
...
class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9686, 'Move Editor Left')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.PageUp,
                mac: {
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.LeftArrow)
                }
            },
            f1: true,
            category: Categories.View
...
class MoveEditorRightInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9687, 'Move Editor Right')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.PageDown,
                mac: {
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.RightArrow)
                }
            },
            f1: true,
            category: Categories.View
...
class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9688, 'Move Editor into Previous Group')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.LeftArrow,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.WinCtrl | KeyCode.LeftArrow
                }
            },
            f1: true,
            category: Categories.View,
...
class MoveEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9689, 'Move Editor into Next Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.RightArrow,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.WinCtrl | KeyCode.RightArrow
                }
            },
            category: Categories.View
...
class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9690, 'Move Editor into Group Above')),
            f1: true,
            category: Categories.View
...
class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9691, 'Move Editor into Group Below')),
            f1: true,
            category: Categories.View
...
class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9692, 'Move Editor into Left Group')),
            f1: true,
            category: Categories.View
...
class MoveEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9693, 'Move Editor into Right Group')),
            f1: true,
            category: Categories.View
...
class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9694, 'Move Editor into First Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.Digit1,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.WinCtrl | KeyCode.Digit1
                }
            },
            category: Categories.View
...
class MoveEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9695, 'Move Editor into Last Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.Digit9,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.WinCtrl | KeyCode.Digit9
                }
            },
            category: Categories.View
...
class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9696, 'Split Editor into Previous Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9697, 'Split Editor into Next Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9698, 'Split Editor into Group Above')),
            f1: true,
            category: Categories.View
...
class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9699, 'Split Editor into Group Below')),
            f1: true,
            category: Categories.View
...
class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
    ...
    static { this.LABEL = ( localize(9700, "Split Editor into Left Group")); }
    constructor() {
        super({
            id: 'workbench.action.splitEditorToLeftGroup',
            title: ( localize2(9700, "Split Editor into Left Group")),
            f1: true,
            category: Categories.View
...
class SplitEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9701, 'Split Editor into Right Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9702, 'Split Editor into First Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(9703, 'Split Editor into Last Group')),
            f1: true,
            category: Categories.View
...
class EditorLayoutSingleAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9704, 'Single Column Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9705, 'Two Columns Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}], orientation: GroupOrientation.HORIZONTAL });
    }
...
class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9706, 'Three Columns Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.HORIZONTAL });
    }
...
class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9707, 'Two Rows Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9708, 'Three Rows Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.VERTICAL });
    }
...
class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9709, 'Grid Editor Layout (2x2)')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9710, 'Two Columns Bottom Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(9711, 'Two Rows Right Editor Layout')),
            f1: true,
            category: Categories.View
...
class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9712, 'New Editor Group to the Left')),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9713, 'New Editor Group to the Right')),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9714, 'New Editor Group Above')),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(9715, 'New Editor Group Below')),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class ToggleEditorTypeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9716, 'Toggle Editor Type')),
            f1: true,
            category: Categories.View,
...
class ReOpenInTextEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9717, 'Reopen Editor With Text Editor')),
            f1: true,
            category: Categories.View,
            precondition: ActiveEditorAvailableEditorIdsContext
        });
...
class MoveEditorToNewWindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(9718, "Move Editor into New Window")),
            mnemonicTitle: ( localize(9719, "&&Move Editor into New Window")),
        }, undefined, true);
    }
}
class CopyEditorToNewindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(9720, "Copy Editor into New Window")),
            mnemonicTitle: ( localize(9721, "&&Copy Editor into New Window")),
        }, { primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.KeyO), weight: KeybindingWeight.WorkbenchContrib }, false);
    }
}
...
class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(9722, "Move Editor Group into New Window")),
            mnemonicTitle: ( localize(9723, "&&Move Editor Group into New Window")),
        }, true);
    }
}
class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(9724, "Copy Editor Group into New Window")),
            mnemonicTitle: ( localize(9725, "&&Copy Editor Group into New Window")),
        }, false);
    }
}
class RestoreEditorsToMainWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(9726, "Restore Editors into Main Window")),
                mnemonicTitle: ( localize(9727, "&&Restore Editors into Main Window")),
            },
            f1: true,
...
class NewEmptyEditorWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(9728, "New Empty Editor Window")),
                mnemonicTitle: ( localize(9729, "&&New Empty Editor Window")),
            },
            f1: true,
            category: Categories.View
        });

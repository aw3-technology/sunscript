...
import { Dimension, $, multibyteAwareBtoa, clearNode } from '../../../../base/browser/dom.js';
import { Registry } from '../../../../platform/registry/common/platform.js';
import { SIDE_BY_SIDE_EDITOR_ID, SideBySideEditor as SideBySideEditor$1, EditorExtensions, isEditorPaneWithSelection, EditorPaneSelectionCompareResult } from '../../../common/editor.js';
...
let SideBySideEditor = class SideBySideEditor extends AbstractEditorWithViewState {
    ...
    constructor(group, telemetryService, instantiationService, themeService, storageService, configurationService, textResourceConfigurationService, editorService, editorGroupService) {
        ...
        this.orientation = this.configurationService.getValue(SideBySideEditor_1.SIDE_BY_SIDE_LAYOUT_SETTING) === 'vertical' ? Orientation.VERTICAL : Orientation.HORIZONTAL;
    ...
    getTitle() {
        ...
        return ( localize(8675, "Side by Side Editor"));
    }
    ...
    toEditorViewStateResource(input) {
        ...
        return (
             (URI.from(
                { scheme: 'sideBySide', path: `${multibyteAwareBtoa(( (secondary.toString())))}${multibyteAwareBtoa(( (primary.toString())))}` }
            ))
        );
    }
    updateStyles() {

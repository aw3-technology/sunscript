...
import { getActiveDocument, isHTMLTextAreaElement, isHTMLInputElement, addDisposableListener, isHTMLElement, EventHelper, getWindow } from '../../../base/browser/dom.js';
...
let TextInputActionsProvider = class TextInputActionsProvider extends Disposable {
    ...
    createActions() {
        return [
            (
            (new Action('undo', ( localize(750, "Undo")), undefined, true, async () => getActiveDocument().execCommand('undo')))),
            ( (new Action('redo', ( localize(751, "Redo")), undefined, true, async () => getActiveDocument().execCommand('redo')))),
            ( (new Separator())),
            (
            (new Action('editor.action.clipboardCutAction', ( localize(752, "Cut")), undefined, true, async () => getActiveDocument().execCommand('cut')))),
            ( (new Action('editor.action.clipboardCopyAction', ( localize(753, "Copy")), undefined, true, async () => getActiveDocument().execCommand('copy')))),
            ( (new Action('editor.action.clipboardPasteAction', ( localize(754, "Paste")), undefined, true, async (element) => {
            if (isNative) {
            ...
            ( (new Separator())),
            (
            (new Action('editor.action.selectAll', ( localize(755, "Select All")), undefined, true, async () => getActiveDocument().execCommand('selectAll'))))
        ];
    }
    registerListeners() {

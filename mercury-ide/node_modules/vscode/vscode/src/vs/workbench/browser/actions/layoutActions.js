...
import { Position, Parts, LayoutSettings, EditorTabsMode, ZenModeSettings, EditorActionsLocation, positionToString } from '../../services/layout/browser/layoutService.js';
...
const menubarIcon = registerIcon('menuBar', Codicon.layoutMenubar, ( localize(6828, "Represents the menu bar")));
const activityBarLeftIcon = registerIcon('activity-bar-left', Codicon.layoutActivitybarLeft, ( localize(6829, "Represents the activity bar in the left position")));
const activityBarRightIcon = registerIcon('activity-bar-right', Codicon.layoutActivitybarRight, ( localize(6830, "Represents the activity bar in the right position")));
const panelLeftIcon = registerIcon('panel-left', Codicon.layoutSidebarLeft, ( localize(6831, "Represents a side bar in the left position")));
const panelLeftOffIcon = registerIcon('panel-left-off', Codicon.layoutSidebarLeftOff, ( localize(6832, "Represents a side bar in the left position toggled off")));
const panelRightIcon = registerIcon('panel-right', Codicon.layoutSidebarRight, ( localize(6833, "Represents side bar in the right position")));
const panelRightOffIcon = registerIcon('panel-right-off', Codicon.layoutSidebarRightOff, ( localize(6834, "Represents side bar in the right position toggled off")));
const panelIcon = registerIcon('panel-bottom', Codicon.layoutPanel, ( localize(6835, "Represents the bottom panel")));
const statusBarIcon = registerIcon('statusBar', Codicon.layoutStatusbar, ( localize(6836, "Represents the status bar")));
const panelAlignmentLeftIcon = registerIcon('panel-align-left', Codicon.layoutPanelLeft, ( localize(6837, "Represents the bottom panel alignment set to the left")));
const panelAlignmentRightIcon = registerIcon('panel-align-right', Codicon.layoutPanelRight, ( localize(6838, "Represents the bottom panel alignment set to the right")));
const panelAlignmentCenterIcon = registerIcon('panel-align-center', Codicon.layoutPanelCenter, ( localize(6839, "Represents the bottom panel alignment set to the center")));
const panelAlignmentJustifyIcon = registerIcon('panel-align-justify', Codicon.layoutPanelJustify, ( localize(6840, "Represents the bottom panel alignment set to justified")));
const fullscreenIcon = registerIcon('fullscreen', Codicon.screenFull, ( localize(6841, "Represents full screen")));
const centerLayoutIcon = registerIcon('centerLayoutIcon', Codicon.layoutCentered, ( localize(6842, "Represents centered layout mode")));
const zenModeIcon = registerIcon('zenMode', Codicon.target, ( localize(6843, "Represents zen mode")));
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'workbench.action.closeSidebar',
            title: ( localize2(6844, 'Close Primary Side Bar')),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6845, "Toggle Centered Layout")),
                mnemonicTitle: ( localize(6846, "&&Centered Layout")),
            },
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, ( localize2(6847, "Move Primary Side Bar Right")), Position.RIGHT);
    }
}
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    static { this.ID = 'workbench.action.moveSideBarLeft'; }
    constructor() {
        super(MoveSidebarLeftAction.ID, ( localize2(6848, "Move Primary Side Bar Left")), Position.LEFT);
    }
}
...
class ToggleSidebarPositionAction extends Action2 {
    ...
    static { this.LABEL = ( localize(6849, "Toggle Primary Side Bar Position")); }
    static getLabel(layoutService) {
        return layoutService.getSideBarPosition() === Position.LEFT ? ( localize(6847, "Move Primary Side Bar Right")) : ( localize(6848, "Move Primary Side Bar Left"));
    }
    constructor() {
        super({
            id: ToggleSidebarPositionAction.ID,
            title: ( localize2(6849, "Toggle Primary Side Bar Position")),
            category: Categories.View,
            f1: true
        });
    }
...
const configureLayoutIcon = registerIcon('configure-layout-icon', Codicon.layout, ( localize(6850, 'Icon represents workbench layout configuration.')));
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
    submenu: MenuId.LayoutControlMenuSubmenu,
    title: ( localize(6851, "Configure Layout")),
...
MenuRegistry.appendMenuItems([{
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(6852, "Move Primary Side Bar Right"))
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(6853, "Move Primary Side Bar Right"))
            },
            when: ( (ContextKeyExpr.and(
                 (ContextKeyExpr.notEquals('config.workbench.sideBar.location', 'right')),
                 (ContextKeyExpr.equals(
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(6854, "Move Primary Side Bar Left"))
            },
            when: ( (ContextKeyExpr.and(
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(6855, "Move Secondary Side Bar Left"))
            },
            when: ( (ContextKeyExpr.and(
                 (ContextKeyExpr.notEquals('config.workbench.sideBar.location', 'right')),
                 (ContextKeyExpr.equals(
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(6856, "Move Secondary Side Bar Right"))
            },
            when: ( (ContextKeyExpr.and(
                 (ContextKeyExpr.equals('config.workbench.sideBar.location', 'right')),
                 (ContextKeyExpr.equals(
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(6857, "&&Move Primary Side Bar Right"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(6858, "&&Move Primary Side Bar Left"))
    },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6859, "Toggle Editor Area Visibility")),
                mnemonicTitle: ( localize(6860, "Show &&Editor Area")),
            },
            category: Categories.View,
            f1: true,
...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    group: '2_appearance',
    title: ( localize(6861, "&&Appearance")),
...
class ToggleSidebarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6862, 'Toggle Primary Side Bar Visibility')),
            toggled: {
                condition: SideBarVisibleContext,
                title: ( localize(6863, "Primary Side Bar")),
                mnemonicTitle: ( localize(6864, "&&Primary Side Bar")),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItems([
    {
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarVisibilityAction.ID,
                title: ( localize(6865, "Hide Primary Side Bar")),
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarVisibilityAction.ID,
                title: ( localize(6866, "Toggle Primary Side Bar")),
...
class ToggleStatusbarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6867, "Toggle Status Bar Visibility")),
                mnemonicTitle: ( localize(6868, "S&&tatus Bar")),
            },
            category: Categories.View,
            f1: true,
...
class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(6869, 'Hide Editor Tabs'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.NONE, title, HideEditorTabsAction.ID, precondition, ( localize2(6870, "Hide Tab Bar")));
    }
}
class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        const precondition = ( (ContextKeyExpr.and(
             (( (ContextKeyExpr.equals(`config.${ZenModeSettings.SHOW_TABS}`, EditorTabsMode.NONE))).negate()),
            InEditorZenModeContext
        )));
        const title = ( localize2(6871, 'Hide Editor Tabs in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.NONE, title, ZenHideEditorTabsAction.ID, precondition, ( localize2(6872, "Hide Tab Bar in Zen Mode")));
    }
}
class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        const precondition = ( (ContextKeyExpr.and(
             (( (ContextKeyExpr.equals(`config.${LayoutSettings.EDITOR_TABS_MODE}`, EditorTabsMode.MULTIPLE))).negate()),
             (InEditorZenModeContext.negate())
        )));
        const title = ( localize2(6873, 'Show Multiple Editor Tabs'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.MULTIPLE, title, ShowMultipleEditorTabsAction.ID, precondition, ( localize2(6874, "Show Tab Bar with multiple tabs")));
    }
}
class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        const precondition = ( (ContextKeyExpr.and(
             (( (ContextKeyExpr.equals(`config.${ZenModeSettings.SHOW_TABS}`, EditorTabsMode.MULTIPLE))).negate()),
            InEditorZenModeContext
        )));
        const title = ( localize2(6875, 'Show Multiple Editor Tabs in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.MULTIPLE, title, ZenShowMultipleEditorTabsAction.ID, precondition, ( localize2(6876, "Show Tab Bar in Zen Mode")));
    }
}
class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        const precondition = ( (ContextKeyExpr.and(
             (( (ContextKeyExpr.equals(`config.${LayoutSettings.EDITOR_TABS_MODE}`, EditorTabsMode.SINGLE))).negate()),
             (InEditorZenModeContext.negate())
        )));
        const title = ( localize2(6877, 'Show Single Editor Tab'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.SINGLE, title, ShowSingleEditorTabAction.ID, precondition, ( localize2(6878, "Show Tab Bar with one Tab")));
    }
}
class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        const precondition = ( (ContextKeyExpr.and(
             (( (ContextKeyExpr.equals(`config.${ZenModeSettings.SHOW_TABS}`, EditorTabsMode.SINGLE))).negate()),
            InEditorZenModeContext
        )));
        const title = ( localize2(6879, 'Show Single Editor Tab in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.SINGLE, title, ZenShowSingleEditorTabAction.ID, precondition, ( localize2(6880, "Show Tab Bar in Zen Mode with one Tab")));
    }
}
...
class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6882, "Move Editor Actions to Title Bar")),
            category: Categories.View,
            precondition: ( (( (ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.TITLEBAR
            ))).negate())),
            metadata: { description: ( localize2(6883, "Move Editor Actions from the tab bar to the title bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class EditorActionsDefaultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6884, "Move Editor Actions to Tab Bar")),
            category: Categories.View,
            ...
            metadata: { description: ( localize2(6885, "Move Editor Actions from the title bar to the tab bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class HideEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6886, "Hide Editor Actions")),
            category: Categories.View,
            precondition: ( (( (ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            ))).negate())),
            metadata: { description: ( localize2(6887, "Hide Editor Actions in the tab and title bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class ShowEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6888, "Show Editor Actions")),
            category: Categories.View,
            precondition: ( (ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            ))),
            metadata: { description: ( localize2(6889, "Make Editor Actions visible.")) },
            f1: true
        });
    }
    run(accessor) {
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(6890, "Editor Actions Position")),
    group: '3_workbench_layout_move',
    order: 11
});
class ConfigureEditorTabsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6891, "Configure Tabs ...")),
            category: Categories.View,
        });
    }
    run(accessor) {
...
class ConfigureEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6892, "Configure Editor ...")),
            category: Categories.View,
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6893, "Separate Pinned Editor Tabs")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6895, "Toggle Zen Mode")),
                mnemonicTitle: ( localize(6896, "Zen Mode")),
            },
            precondition: ( (IsAuxiliaryWindowFocusedContext.toNegated())),
            category: Categories.View,
            f1: true,
...
if (isWindows || isLinux || isWeb) {
    registerAction2(class ToggleMenubarAction extends Action2 {
        constructor() {
            super({
                ...
                title: {
                    ...( localize2(6897, "Toggle Menu Bar")),
                    mnemonicTitle: ( localize(6898, "Menu &&Bar")),
                },
                category: Categories.View,
                f1: true,
    ...
    for (const menuId of [MenuId.TitleBarContext, MenuId.TitleBarTitleContext]) {
        MenuRegistry.appendMenuItem(menuId, {
            ...
            when: ( (ContextKeyExpr.and(
                 (IsAuxiliaryWindowFocusedContext.toNegated()),
                 (ContextKeyExpr.notEquals(TitleBarStyleContext.key, TitlebarStyle.NATIVE)),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6900, "Reset View Locations")),
            category: Categories.View,
            f1: true
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6901, "Move View")),
            category: Categories.View,
            f1: true
        });
    }
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(6902, "Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(6903, "Panel / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(6904, "Secondary Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
    ...
    async getView(quickInputService, viewDescriptorService, paneCompositePartService, viewId) {
        ...
        quickPick.placeholder = ( localize(6905, "Select a View to Move"));
...
class MoveFocusedViewAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6906, "Move Focused View")),
            category: Categories.View,
    ...
    run(accessor, viewId) {
        ...
        if (focusedViewId === undefined || focusedViewId.trim() === '') {
            dialogService.error(( localize(6907, "There is no view currently focused.")));
            return;
        }
        const viewDescriptor = viewDescriptorService.getViewDescriptorById(focusedViewId);
        if (!viewDescriptor || !viewDescriptor.canMoveView) {
            dialogService.error(( localize(6908, "The currently focused view is not movable.")));
            return;
        }
        const quickPick = quickInputService.createQuickPick();
        quickPick.placeholder = ( localize(6909, "Select a Destination for the View"));
        quickPick.title = ( localize(6910, "View: Move {0}", viewDescriptor.name.value));
        const items = [];
        ...
        items.push({
            type: 'separator',
            label: ( localize(6916, "Secondary Side Bar"))
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6917, "Reset Focused View Location")),
            category: Categories.View,
            f1: true,
            precondition: ( (FocusedViewContext.notEqualsTo('')))
        });
    ...
    run(accessor) {
        ...
        if (!viewDescriptor) {
            dialogService.error(( localize(6918, "There is no view currently focused.")));
            return;
        }
...
class IncreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(6919, 'Increase Current View Size')),
            f1: true,
            precondition: ( (IsAuxiliaryWindowFocusedContext.toNegated()))
        });
    }
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(6920, 'Increase Editor Width')),
            f1: true,
            precondition: ( (IsAuxiliaryWindowFocusedContext.toNegated()))
        });
    }
...
class IncreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(6921, 'Increase Editor Height')),
            f1: true,
            precondition: ( (IsAuxiliaryWindowFocusedContext.toNegated()))
        });
    }
...
class DecreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(6922, 'Decrease Current View Size')),
            f1: true,
            precondition: ( (IsAuxiliaryWindowFocusedContext.toNegated()))
        });
    }
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(6923, 'Decrease Editor Width')),
            f1: true,
            precondition: ( (IsAuxiliaryWindowFocusedContext.toNegated()))
        });
    }
...
class DecreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(6924, 'Decrease Editor Height')),
            f1: true,
            precondition: ( (IsAuxiliaryWindowFocusedContext.toNegated()))
        });
    }
...
const CreateToggleLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(6925, "Select to Hide")),
        inactiveAriaLabel: ( localize(6926, "Select to Show")),
        useButtons: true,
    };
};
const CreateOptionLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(6927, "Active")),
        useButtons: false
    };
};
...
if (!isMacintosh || !isNative) {
    ToggleVisibilityActions.push(CreateToggleLayoutItem('workbench.action.toggleMenuBar', MenuBarToggledContext, ( localize(6928, "Menu Bar")), menubarIcon));
}
ToggleVisibilityActions.push(...[
    CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ( (ContextKeyExpr.notEquals('config.workbench.activityBar.location', 'hidden'))), ( localize(6929, "Activity Bar")), { whenA: ( (ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'))), iconA: activityBarLeftIcon, iconB: activityBarRightIcon }),
    CreateToggleLayoutItem(ToggleSidebarVisibilityAction.ID, SideBarVisibleContext, ( localize(6930, "Primary Side Bar")), { whenA: ( (ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'))), iconA: panelLeftIcon, iconB: panelRightIcon }),
    CreateToggleLayoutItem(ToggleAuxiliaryBarAction.ID, AuxiliaryBarVisibleContext, ( localize(6916, "Secondary Side Bar")), { whenA: ( (ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'))), iconA: panelRightIcon, iconB: panelLeftIcon }),
    CreateToggleLayoutItem(TogglePanelAction.ID, PanelVisibleContext, ( localize(6915, "Panel")), panelIcon),
    CreateToggleLayoutItem(ToggleStatusbarVisibilityAction.ID, ( (ContextKeyExpr.equals('config.workbench.statusBar.visible', true))), ( localize(6931, "Status Bar")), statusBarIcon),
]);
const MoveSideBarActions = [
    CreateOptionLayoutItem(MoveSidebarLeftAction.ID, ( (ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'))), ( localize(6932, "Left")), panelLeftIcon),
    CreateOptionLayoutItem(MoveSidebarRightAction.ID, ( (ContextKeyExpr.equals('config.workbench.sideBar.location', 'right'))), ( localize(6933, "Right")), panelRightIcon),
];
const AlignPanelActions = [
    CreateOptionLayoutItem('workbench.action.alignPanelLeft', ( (PanelAlignmentContext.isEqualTo('left'))), ( localize(6934, "Left")), panelAlignmentLeftIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelRight', ( (PanelAlignmentContext.isEqualTo('right'))), ( localize(6935, "Right")), panelAlignmentRightIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelCenter', ( (PanelAlignmentContext.isEqualTo('center'))), ( localize(6936, "Center")), panelAlignmentCenterIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelJustify', ( (PanelAlignmentContext.isEqualTo('justify'))), ( localize(6937, "Justify")), panelAlignmentJustifyIcon),
];
const MiscLayoutOptions = [
    CreateOptionLayoutItem('workbench.action.toggleFullScreen', IsMainWindowFullscreenContext, ( localize(6938, "Full Screen")), fullscreenIcon),
    CreateOptionLayoutItem('workbench.action.toggleZenMode', InEditorZenModeContext, ( localize(6939, "Zen Mode")), zenModeIcon),
    CreateOptionLayoutItem('workbench.action.toggleCenteredLayout', IsMainEditorCenteredLayoutContext, ( localize(6940, "Centered Layout")), centerLayoutIcon),
];
...
registerAction2(class CustomizeLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6941, "Customize Layout...")),
            f1: true,
            icon: configureLayoutIcon,
            menu: [
                {
    ...
    getItems(contextKeyService, keybindingService) {
        ...
        return [
            {
                type: 'separator',
                label: ( localize(6942, "Visibility"))
            },
            ...( (ToggleVisibilityActions.map(toQuickPickItem))),
            {
                type: 'separator',
                label: ( localize(6943, "Primary Side Bar Position"))
            },
            ...( (MoveSideBarActions.map(toQuickPickItem))),
            {
                type: 'separator',
                label: ( localize(6944, "Panel Alignment"))
            },
            ...( (AlignPanelActions.map(toQuickPickItem))),
            {
                type: 'separator',
                label: ( localize(6945, "Modes")),
            },
    ...
    run(accessor) {
        ...
        quickPick.title = ( localize(6946, "Customize Layout"));
        const closeButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.close),
            tooltip: ( localize(6947, "Close"))
        };
        const resetButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.discard),
            tooltip: ( localize(6948, "Restore Defaults"))
        };
        quickPick.buttons = [
            resetButton,
            closeButton

...
let AbstractTextEditor = class AbstractTextEditor extends AbstractEditorWithViewState {
    ...
    computeAriaLabel() {
        return this.input ? computeEditorAriaLabel(this.input, undefined, this.group, this.editorGroupService.count) : ( localize(11473, "Editor"));
    }
    ...
    getSelection() {
        ...
        if (mainControl) {
            ...
            if (selection) {
                return (
                     (new TextEditorPaneSelection(selection))
                );
            }
        }
        return undefined;

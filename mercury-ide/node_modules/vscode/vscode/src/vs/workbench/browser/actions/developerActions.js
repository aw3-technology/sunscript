...
import { createStyleSheet, createCSSRule, getActiveDocument, getDomNodePagePosition, append, $, getWindows, onDidRegisterWindow } from '../../../base/browser/dom.js';
...
import { Action2, registerAction2, MenuRegistry } from '../../../platform/actions/common/actions.js';
...
class InspectContextKeysAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(756, 'Inspect Context Keys')),
...
class ToggleScreencastModeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(757, 'Toggle Screencast Mode')),
            category: Categories.Developer,
            f1: true
        });
    }
...
class LogStorageAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(758, "Log Storage Database Contents")),
            category: Categories.Developer,
            f1: true
        });
    }
    run(accessor) {
        ...
        )), ( localize(760, "Open developer tools from the menu and select the Console tab.")));
    }
}
class LogWorkingCopiesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(761, "Log Working Copies")),
            category: Categories.Developer,
            f1: true
        });
    }
...
class RemoveLargeStorageEntriesAction extends Action2 {
    static { this.SIZE_THRESHOLD = 1024 * 16; }
    constructor() {
        super({
            id: 'workbench.action.removeLargeStorageDatabaseEntries',
            title: ( localize2(762, 'Remove Large Storage Database Entries...')),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
                    ...
                    if (value && (!environmentService.isBuilt  || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: ( localize(
                                763,
                                "Scope: {0}, Target: {1}",
                                scope === StorageScope.APPLICATION ? ( localize(764, "Global")) : scope === StorageScope.PROFILE ? ( localize(765, "Profile")) : ( localize(766, "Workspace")),
                                target === StorageTarget.MACHINE ? ( localize(767, "Machine")) : ( localize(768, "User"))
                            )),
                        });
                    }
                }
        ...
        const selectedItems = await ( (new Promise(resolve => {
            ...
            picker.customLabel = ( localize(769, "Remove"));
            picker.placeholder = ( localize(770, "Select large entries to remove from storage"));
            if (items.length === 0) {
                picker.description = ( localize(771, "There are no large storage entries to remove."));
            }
            picker.show();
        ...
        const { confirmed } = await dialogService.confirm({
            ...
            primaryButton: ( localize(774, "&&Remove"))
        });
        if (!confirmed) {
            return;
        }
...
class StartTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(775, 'Start Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
class SnapshotTrackedDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(776, 'Snapshot Tracked Disposables')),
            category: Categories.Developer,
            f1: true,
...
class StopTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(777, 'Stop Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
configurationRegistry.registerConfiguration({
    id: 'screencastMode',
    order: 9,
    title: ( localize(778, "Screencast Mode")),
    type: 'object',
    properties: {
        ...
        'screencastMode.fontSize': {
            ...
            minimum: 20,
            maximum: 100,
            description: ( localize(780, "Controls the font size (in pixels) of the screencast mode keyboard."))
        },
        'screencastMode.keyboardOptions': {
            type: 'object',
            description: ( localize(781, "Options for customizing the keyboard overlay in screencast mode.")),
            properties: {
                'showKeys': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(782, "Show raw keys."))
                },
                'showKeybindings': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(783, "Show keyboard shortcuts."))
                },
                'showCommands': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(784, "Show command names."))
                },
                'showCommandGroups': {
                    type: 'boolean',
                    default: false,
                    description: ( localize(785, "Show command group names, when commands are also shown."))
                },
                'showSingleEditorCursorMoves': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(786, "Show single editor cursor move commands."))
                }
            },
            default: {
                'showKeys': true,

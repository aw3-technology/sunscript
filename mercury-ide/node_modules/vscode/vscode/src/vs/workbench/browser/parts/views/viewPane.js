...
import { append, $, addDisposableListener, asCssValueWithDefault, createCSSRule, asCSSUrl, after, trackFocus, EventType, Dimension, reset } from '../../../../base/browser/dom.js';
...
import { ViewContainerLocation, ViewContainerLocationToString, defaultViewIcon, Extensions } from '../../../common/views.js';
...
import { SIDE_BAR_BACKGROUND, SIDE_BAR_STICKY_SCROLL_BACKGROUND, SIDE_BAR_STICKY_SCROLL_BORDER, SIDE_BAR_STICKY_SCROLL_SHADOW, PANEL_BACKGROUND, PANEL_STICKY_SCROLL_BACKGROUND, PANEL_STICKY_SCROLL_BORDER, PANEL_STICKY_SCROLL_SHADOW } from '../../../common/theme.js';
var ViewPane_1;
...
const viewPaneContainerExpandedIcon = registerIcon('view-pane-container-expanded', Codicon.chevronDown, ( localize(5342, 'Icon for an expanded view pane container.')));
const viewPaneContainerCollapsedIcon = registerIcon('view-pane-container-collapsed', Codicon.chevronRight, ( localize(5343, 'Icon for a collapsed view pane container.')));
...
let ViewWelcomeController = class ViewWelcomeController {
    ...
    onDidChangeViewWelcomeState() {
        ...
        this.scrollableElement = ( (new DomScrollableElement(
            this.element,
            { alwaysConsumeMouseWheel: true, horizontal: ScrollbarVisibility.Hidden, vertical: ScrollbarVisibility.Visible, }
        )));
...
let ViewPane = class ViewPane extends Pane {
    ...
    renderHeader(container) {
        ...
        this.toolbar = this.instantiationService.createInstance(WorkbenchToolBar, actions, {
            ...
            ariaLabel: ( localize(5344, "{0} actions", this.title)),
    ...
    _getAriaLabel(title) {
        ...
        return ( localize(5345, 'Use Alt+F1 for accessibility help {0}', title));
    }
    updateTitle(title) {
        const calculatedTitle = this.calculateTitle(title);
    ...
    getProgressIndicator() {
        ...
        if (this.progressIndicator === undefined) {
            const that = this;
            this.progressIndicator = this._register(( (new ScopedProgressIndicator(
...
export { FilterViewPane, VIEWPANE_FILTER_ACTION, ViewAction, ViewPane, ViewPaneShowActions, getLocationBasedViewColors };

...
const auxiliaryBarRightIcon = registerIcon('auxiliarybar-right-layout-icon', Codicon.layoutSidebarRight, ( localize(9350, 'Icon to toggle the auxiliary bar off in its right position.')));
const auxiliaryBarRightOffIcon = registerIcon('auxiliarybar-right-off-layout-icon', Codicon.layoutSidebarRightOff, ( localize(9351, 'Icon to toggle the auxiliary bar on in its right position.')));
const auxiliaryBarLeftIcon = registerIcon('auxiliarybar-left-layout-icon', Codicon.layoutSidebarLeft, ( localize(9352, 'Icon to toggle the auxiliary bar in its left position.')));
const auxiliaryBarLeftOffIcon = registerIcon('auxiliarybar-left-off-layout-icon', Codicon.layoutSidebarLeftOff, ( localize(9353, 'Icon to toggle the auxiliary bar on in its left position.')));
class ToggleAuxiliaryBarAction extends Action2 {
    static { this.ID = 'workbench.action.toggleAuxiliaryBar'; }
    static { this.LABEL = ( localize2(9354, "Toggle Secondary Side Bar Visibility")); }
    constructor() {
        super({
            ...
            toggled: {
                ...
                title: ( localize(9355, "Secondary Side Bar")),
                mnemonicTitle: ( localize(9356, "Secondary Si&&de Bar")),
            },
...
registerAction2(class FocusAuxiliaryBarAction extends Action2 {
    ...
    static { this.LABEL = ( localize2(9357, "Focus into Secondary Side Bar")); }
    constructor() {
        super({
...
MenuRegistry.appendMenuItems([
    {
        ...
        item: {
            ...
            command: {
                id: ToggleAuxiliaryBarAction.ID,
                title: ( localize(9358, "Toggle Secondary Side Bar")),
        ...
        item: {
            ...
            command: {
                id: ToggleAuxiliaryBarAction.ID,
                title: ( localize2(9359, 'Hide Secondary Side Bar')),
            },

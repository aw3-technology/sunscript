...
import { DragAndDropObserver, addDisposableListener, EventType, getWindow, isAncestor } from '../../../../base/browser/dom.js';
...
import { KeyChord, KeyCode, KeyMod as KeyMod$1 } from '../../../../base/common/keyCodes.js';
import { toDisposable, combinedDisposable, DisposableStore } from '../../../../base/common/lifecycle.js';
...
import { ViewContainerLocation, ViewContainerLocationToString, ViewVisibilityState } from '../../../common/views.js';
...
import { LayoutSettings, isHorizontal } from '../../../services/layout/browser/layoutService.js';
...
registerAction2(class MoveViewUp extends MoveViewPosition {
    constructor() {
        super({
            id: 'views.moveViewUp',
            title: ( localize(5296, "Move View Up")),
            keybinding: {
...
registerAction2(class MoveViewLeft extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(5297, "Move View Left")),
            keybinding: {
...
registerAction2(class MoveViewDown extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(5298, "Move View Down")),
            keybinding: {
...
registerAction2(class MoveViewRight extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(5299, "Move View Right")),
            keybinding: {
...
registerAction2(class MoveViews extends Action2 {
    constructor() {
        super({
            id: 'vscode.moveViews',
            title: ( localize(5300, "Move Views")),
        });
    }

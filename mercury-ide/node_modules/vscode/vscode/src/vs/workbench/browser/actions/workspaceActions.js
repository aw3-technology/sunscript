...
import { hasWorkspaceFileExtension, WorkbenchState } from '../../../platform/workspace/common/workspace.js';
...
const workspacesCategory = ( localize2(5384, 'Workspaces'));
class OpenFileAction extends Action2 {
    static { this.ID = 'workbench.action.files.openFile'; }
    constructor() {
        super({
            id: OpenFileAction.ID,
            title: ( localize2(5385, 'Open File...')),
            category: Categories.File,
            f1: true,
            keybinding: {
                when: ( (IsMacNativeContext.toNegated())),
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyCode.KeyO
            }
        });
    }
...
class OpenFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(5386, 'Open Folder...')),
            category: Categories.File,
            f1: true,
            ...
            keybinding: {
                ...
                primary: undefined,
                linux: {
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyO)
                },
                win: {
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyO)
                }
...
class OpenFileFolderAction extends Action2 {
    ...
    static { this.LABEL = ( localize2(5387, 'Open...')); }
    constructor() {
        super({
...
class OpenWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(5388, 'Open Workspace from File...')),
            category: Categories.File,
            f1: true,
...
class CloseWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(5389, 'Close Workspace')),
            ...
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.KeyF)
            }
        });
    }
    async run(accessor) {
...
class OpenWorkspaceConfigFileAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(5390, 'Open Workspace Configuration File')),
            category: workspacesCategory,
            f1: true,
...
class RemoveRootFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(5391, 'Remove Folder from Workspace...')),
            category: workspacesCategory,
            f1: true,
            precondition: ( (ContextKeyExpr.and(
...
class SaveWorkspaceAsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(5392, 'Save Workspace As...')),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
...
class DuplicateWorkspaceInNewWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(5393, 'Duplicate As Workspace in New Window')),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenFolderAction.ID,
        title: ( localize(5395, "Open &&Folder..."))
    },
    order: 2,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenWorkspaceAction.ID,
        title: ( localize(5397, "Open Wor&&kspace from File..."))
    },
    order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(5398, "A&&dd Folder to Workspace..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: SaveWorkspaceAsAction.ID,
        title: ( localize(5399, "Save Workspace As..."))
    },
    order: 2,
    when: EnterMultiRootWorkspaceSupportContext
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: DuplicateWorkspaceInNewWindowAction.ID,
        title: ( localize(5400, "Duplicate Workspace"))
    },
    order: 3,
    when: EnterMultiRootWorkspaceSupportContext
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(5401, "Close &&Folder"))
    },
    order: 3,
    when: ( (ContextKeyExpr.and(
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(5402, "Close &&Workspace"))
    },
    order: 3,
    when: ( (ContextKeyExpr.and(
         (WorkbenchStateContext.isEqualTo('workspace')),

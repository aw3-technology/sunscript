...
import { ConfigurationScope, Extensions as Extensions$1 } from '../../platform/configuration/common/configurationRegistry.js';
import { isNative, isMacintosh, isWeb, isWindows, isLinux } from '../../base/common/platform.js';
import { ConfigurationMigrationWorkbenchContribution, DynamicWorkbenchSecurityConfiguration, workbenchConfigurationNodeBase, windowConfigurationNodeBase, DynamicWindowConfiguration, problemsConfigurationNodeBase, Extensions } from '../common/configuration.js';
import { isStandalone } from '../../base/browser/browser.js';
import { registerWorkbenchContribution2, WorkbenchPhase } from '../common/contributions.js';
import { LayoutSettings, EditorTabsMode, EditorActionsLocation, ActivityBarPosition } from '../services/layout/browser/layoutService.js';
...
(function registerConfiguration() {
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            [LayoutSettings.EDITOR_TABS_MODE]: {
                ...
                'enumDescriptions': [
                    ( localize(914, "Each editor is displayed as a tab in the editor title area.")),
                    ( localize(
                        915,
                        "The active editor is displayed as a single large tab in the editor title area."
                    )),
                    ( localize(916, "The editor title area is not displayed.")),
                ],
                'description': ( localize(
                    917,
            ...
            [LayoutSettings.EDITOR_ACTIONS_LOCATION]: {
                ...
                'markdownEnumDescriptions': [
                    ...
                    ( localize(920, "Editor actions are not shown.")),
                ],
                'markdownDescription': ( localize(921, "Controls where the editor actions are shown.")),
                'default': 'default'
            },
            ...
            'workbench.editor.decorations.badges': {
                'type': 'boolean',
                'markdownDescription': ( localize(926, "Controls whether editor file decorations should use badges.")),
                'default': true
            },
            'workbench.editor.decorations.colors': {
                'type': 'boolean',
                'markdownDescription': ( localize(927, "Controls whether editor file decorations should use colors.")),
                'default': true
            },
            ...
            'workbench.editor.labelFormat': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(938, "Show the name of the file followed by its directory name.")),
                    ( localize(
                        939,
                        "Show the name of the file followed by its path relative to the workspace folder."
                    )),
                    ( localize(940, "Show the name of the file followed by its absolute path."))
                ],
                'default': 'default',
                'description': ( localize(941, "Controls the format of the label for an editor.")),
            },
            'workbench.editor.untitled.labelFormat': {
                ...
                'default': 'content',
                'description': ( localize(944, "Controls the format of the label for an untitled editor.")),
            },
            ...
            'workbench.editor.languageDetectionHints': {
                ...
                properties: {
                    untitledEditors: {
                        type: 'boolean',
                        description: ( localize(950, "Show in untitled text editors")),
                    },
                    notebookEditors: {
                        type: 'boolean',
                        description: ( localize(951, "Show in notebook editors")),
                    }
                }
            },
            ...
            'workbench.editor.tabActionCloseVisibility': {
                type: 'boolean',
                default: true,
                description: ( localize(953, "Controls the visibility of the tab close action button."))
            },
            'workbench.editor.tabActionUnpinVisibility': {
                type: 'boolean',
                default: true,
                description: ( localize(954, "Controls the visibility of the tab unpin action button."))
            },
            'workbench.editor.tabSizing': {
                ...
                'default': 'fit',
                'enumDescriptions': [
                    ( localize(955, "Always keep tabs large enough to show the full editor label.")),
                    ( localize(
                        956,
            ...
            'workbench.editor.pinnedTabSizing': {
                ...
                'default': 'normal',
                'enumDescriptions': [
                    ( localize(962, "A pinned tab inherits the look of non pinned tabs.")),
                    ( localize(
                        963,
            ...
            'workbench.editor.preventPinnedEditorClose': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(968, "Prevent closing the pinned editor when using the keyboard.")),
                    ( localize(969, "Prevent closing the pinned editor when using mouse middle click.")),
                    ( localize(970, "Never prevent closing a pinned editor."))
                ],
                description: ( localize(
                    971,
            ...
            'workbench.editor.splitSizing': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(973, "Splits all the editor groups to equal parts.")),
                    ( localize(974, "Splits the active editor group to equal parts."))
                ],
                'description': ( localize(975, "Controls the size of editor groups when splitting them."))
            },
            ...
            'workbench.editor.navigationScope': {
                ...
                'enumDescriptions': [
                    ( localize(990, "Navigate across all opened editors and editor groups.")),
                    ( localize(991, "Navigate only in editors of the active editor group.")),
                    ( localize(992, "Navigate only in the active editor."))
                ],
            },
            ...
            'workbench.editor.splitInGroupLayout': {
                ...
                'enumDescriptions': [
                    ( localize(996, "Editors are positioned from top to bottom.")),
                    ( localize(997, "Editors are positioned from left to right."))
                ]
            },
            ...
            'workbench.editor.doubleClickTabToToggleEditorGroupSizes': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(1003, "No editor group is resized when double clicking on a tab."))
                ]
            },
            ...
            'workbench.commandPalette.experimental.askChatLocation': {
                'type': 'string',
                tags: ['experimental'],
                'description': ( localize(1016, "Controls where the command palette should ask chat questions.")),
                'default': 'chatView',
                enum: ['chatView', 'quickChat'],
                enumDescriptions: [
                    ( localize(1017, "Ask chat questions in the Chat view.")),
                    ( localize(1018, "Ask chat questions in Quick Chat."))
                ]
            },
            ...
            'workbench.panel.opensMaximized': {
                ...
                'enumDescriptions': [
                    ( localize(1028, "Always maximize the panel when opening it.")),
                    ( localize(
                        1029,
                        "Never maximize the panel when opening it. The panel will open un-maximized."
                    )),
                    ( localize(1030, "Open the panel to the state that it was in, before it was closed."))
                ]
            },
            ...
            [LayoutSettings.ACTIVITY_BAR_LOCATION]: {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(1036, "Hide the Activity Bar in the Primary and Secondary Side Bars."))
                ],
            },
            'workbench.activityBar.iconClickBehavior': {
                ...
                'enumDescriptions': [
                    ( localize(1038, "Hide the Primary Side Bar if the clicked item is already visible.")),
                    ( localize(1039, "Focus the Primary Side Bar if the clicked item is already visible."))
                ]
            },
            ...
            'workbench.fontAliasing': {
                ...
                'default': 'default',
                'description': ( localize(1041, "Controls font aliasing method in the workbench.")),
                'enumDescriptions': [
                    ( localize(
                        1042,
                    ...
                    ( localize(1044, "Disables font smoothing. Text will show with jagged sharp edges.")),
                    ( localize(
                        1045,
            ...
            'workbench.settings.editor': {
                ...
                'enum': ['ui', 'json'],
                'enumDescriptions': [
                    ( localize(1046, "Use the settings UI editor.")),
                    ( localize(1047, "Use the JSON file editor.")),
                ],
                'description': ( localize(1048, "Determines which settings editor to use by default.")),
                'default': 'ui',
            ...
            'workbench.reduceMotion': {
                ...
                'enumDescriptions': [
                    ( localize(1051, "Always render with reduced motion.")),
                    ( localize(1052, "Do not render with reduced motion")),
                    ( localize(1053, "Render with reduced motion based on OS configuration.")),
                ],
                default: 'auto',
                tags: ['accessibility'],
                enum: ['on', 'off', 'auto']
            ...
            [LayoutSettings.LAYOUT_ACTIONS]: {
                ...
                'markdownDescription': isWeb ?
                    ( localize(1054, "Controls whether the layout control in the title bar is shown.")) :
                    ( localize(
                        1055,
            ...
            'workbench.layoutControl.type': {
                ...
                'enumDescriptions': [
                    ( localize(1056, "Shows a single button with a dropdown of layout options.")),
                    ( localize(
                        1057,
                        "Shows several buttons for toggling the visibility of the panels and side bar."
                    )),
                    ( localize(1058, "Shows both the dropdown and toggle buttons.")),
                ],
                'default': 'both',
                'description': ( localize(
                    1059,
            ...
            'workbench.tips.enabled': {
                'type': 'boolean',
                'default': true,
                'description': ( localize(1060, "When enabled, will show the watermark tips when no editor is open."))
            },
        }
    });
    ...
    windowTitleDescription += '\n- ' + [
        ( localize(1062, "`${activeEditorShort}`: the file name (e.g. myFile.txt).")),
        ( localize(
            1063,
        ...
        ( localize(1074, "`${appName}`: e.g. VS Code.")),
        ( localize(1075, "`${remoteName}`: e.g. SSH")),
        ( localize(
            1076,
            "`${dirty}`: an indicator for when the active editor has unsaved changes."
        )),
        ( localize(1077, "`${focusedView}`: the name of the view that is currently focused.")),
        ( localize(
            1078,
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'window.titleSeparator': {
                ...
                'markdownDescription': ( localize(1081, "Separator used by {0}.", '`#window.title#`'))
            },
            [LayoutSettings.COMMAND_CENTER]: {
                type: 'boolean',
                default: true,
                markdownDescription: isWeb ?
                    ( localize(1082, "Show command launcher together with the window title.")) :
                    ( localize(
                        1083,
            ...
            'window.menuBarVisibility': {
                ...
                'markdownEnumDescriptions': [
                    ...
                    ( localize(1088, "Menu is always hidden.")),
                    isWeb ?
                        ( localize(1089, "Menu is displayed as a compact button in the side bar.")) :
                        ( localize(
                            1090,
            ...
            'window.openFilesInNewWindow': {
                ...
                'enum': ['on', 'off', 'default'],
                'enumDescriptions': [
                    ( localize(1095, "Files will open in a new window.")),
                    ( localize(
                        1096,
            ...
            'window.openFoldersInNewWindow': {
                ...
                'enum': ['on', 'off', 'default'],
                'enumDescriptions': [
                    ( localize(1101, "Folders will open in a new window.")),
                    ( localize(1102, "Folders will replace the last active window.")),
                    ( localize(
                        1103,
            ...
            'window.confirmBeforeClose': {
                ...
                'enumDescriptions': [
                    isWeb ?
                        ...
                        ( localize(1106, "Always ask for confirmation.")),
                    isWeb ?
                        ( localize(
                            1107,
                        ...
                        ( localize(1108, "Only ask for confirmation if a keybinding was used.")),
                    isWeb ?
                        ( localize(
                            1109,
                            "Never explicitly ask for confirmation unless data loss is imminent."
                        )) :
                        ( localize(1110, "Never explicitly ask for confirmation."))
                ],
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'zenMode.centerLayout': {
                'type': 'boolean',
                'default': true,
                'description': ( localize(1116, "Controls whether turning on Zen Mode also centers the layout."))
            },
            'zenMode.showTabs': {
                'type': 'string',
                ...
                'enumDescriptions': [
                    ( localize(1118, "Each editor is displayed as a tab in the editor title area.")),
                    ( localize(
                        1119,
                        "The active editor is displayed as a single large tab in the editor title area."
                    )),
                    ( localize(1120, "The editor title area is not displayed.")),
                ],
                'default': 'multiple'
            },
...
( (Registry.as(Extensions.ConfigurationMigration)))
    .registerConfigurationMigrations([{
        key: LayoutSettings.ACTIVITY_BAR_LOCATION, migrateFn: (value) => {
            const results = [];
            if (value === 'side') {
...
( (Registry.as(Extensions.ConfigurationMigration)))
    .registerConfigurationMigrations([{
        ...
        key: LayoutSettings.EDITOR_TABS_MODE, migrateFn: (value) => {
            const results = [];
            if (typeof value === 'boolean') {

...
import { Pane, IPaneStyles, IPaneOptions } from '../../../../base/browser/ui/splitview/paneview.js';
...
declare enum ViewPaneShowActions {
...
declare abstract class ViewPane extends Pane implements IView {
...
interface IViewPaneLocationColors {
    background: string;
    listOverrideStyles: PartialExcept<IListStyles, 'listBackground' | 'treeStickyScrollBackground'>;
}

export { type IViewPaneLocationColors, type IViewPaneOptions, ViewPane, ViewPaneShowActions };

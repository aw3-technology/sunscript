...
import { append, getWindow, getDomNodePagePosition, $, trackFocus } from '../../../../base/browser/dom.js';
...
import { DisposableStore, MutableDisposable, toDisposable, combinedDisposable } from '../../../../base/common/lifecycle.js';
...
import { WorkbenchListFocusContextKey, WorkbenchDataTree, WorkbenchAsyncDataTree } from '../../../../platform/list/browser/listService.js';
...
import { IBreadcrumbsService } from './breadcrumbs.service.js';
...
const separatorIcon = registerIcon('breadcrumb-separator', Codicon.chevronRight, ( localize(11507, 'Icon for the separator in the breadcrumbs.')));
let BreadcrumbsControl = class BreadcrumbsControl {
    ...
    static { this.CK_BreadcrumbsPossible = ( (new RawContextKey('breadcrumbsPossible', false, ( localize(11508, "Whether the editor can show breadcrumbs"))))); }
    static { this.CK_BreadcrumbsVisible = ( (new RawContextKey('breadcrumbsVisible', false, ( localize(11509, "Whether breadcrumbs are currently visible"))))); }
    static { this.CK_BreadcrumbsActive = ( (new RawContextKey('breadcrumbsActive', false, ( localize(11510, "Whether breadcrumbs have focus"))))); }
    ...
    update() {
        ...
        const updateBreadcrumbs = () => {
            ...
            const items = ( (model.getElements().map(
                element => element instanceof FileElement ? ( (new FileItem(model, element, options, this._labels, this._hoverDelegate))) : ( (new OutlineItem(model, element, options)))
            )));
            if (items.length === 0) {
                this._widget.setEnabled(false);
                this._widget.setItems([new (class extends BreadcrumbsItem {
                        render(container) {
                            container.innerText = ( localize(11511, "no elements"));
                        }
                        equals(other) {
                            return other === this;
                        }
...
registerAction2(class ToggleBreadcrumb extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(11512, "Toggle Breadcrumbs")),
                mnemonicTitle: ( localize(11513, "Toggle &&Breadcrumbs")),
            },
            category: Categories.View,
            toggled: {
                condition: ( (ContextKeyExpr.equals('config.breadcrumbs.enabled', true))),
                title: ( localize(11514, "Toggle Breadcrumbs")),
                mnemonicTitle: ( localize(11515, "Toggle &&Breadcrumbs"))
            },
            menu: [
...
registerAction2(class FocusAndSelectBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11516, "Focus and Select Breadcrumbs")),
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Period,
...
registerAction2(class FocusBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11517, "Focus Breadcrumbs")),
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Semicolon,
                when: BreadcrumbsControl.CK_BreadcrumbsPossible,
            },
            f1: true
        });
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    secondary: [KeyMod$1.CtrlCmd | KeyCode.RightArrow],
    mac: {
        primary: KeyCode.RightArrow,
        secondary: [KeyMod$1.Alt | KeyCode.RightArrow],
    },
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    secondary: [KeyMod$1.CtrlCmd | KeyCode.LeftArrow],
    mac: {
        primary: KeyCode.LeftArrow,
        secondary: [KeyMod$1.Alt | KeyCode.LeftArrow],
    },
    when: ( (ContextKeyExpr.and(
        BreadcrumbsControl.CK_BreadcrumbsVisible,
        BreadcrumbsControl.CK_BreadcrumbsActive
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    mac: {
        primary: KeyMod$1.Alt | KeyCode.RightArrow,
    },
    when: ( (ContextKeyExpr.and(
        BreadcrumbsControl.CK_BreadcrumbsVisible,
        BreadcrumbsControl.CK_BreadcrumbsActive,
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    weight: KeybindingWeight.WorkbenchContrib + 1,
    primary: KeyMod$1.CtrlCmd | KeyCode.LeftArrow,
    mac: {
        primary: KeyMod$1.Alt | KeyCode.LeftArrow,
    },
    when: ( (ContextKeyExpr.and(
        BreadcrumbsControl.CK_BreadcrumbsVisible,
        BreadcrumbsControl.CK_BreadcrumbsActive,
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    secondary: [KeyMod$1.CtrlCmd | KeyCode.Enter],
    when: ( (ContextKeyExpr.and(
        BreadcrumbsControl.CK_BreadcrumbsVisible,
        BreadcrumbsControl.CK_BreadcrumbsActive
    ))),

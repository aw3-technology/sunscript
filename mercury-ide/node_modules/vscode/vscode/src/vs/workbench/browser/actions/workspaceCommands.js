...
const ADD_ROOT_FOLDER_LABEL = ( localize2(5518, 'Add Folder to Workspace...'));
...
async function selectWorkspaceFolders(accessor) {
    ...
    const folders = await dialogsService.showOpenDialog({
        openLabel: mnemonicButtonLabel(( localize(5519, "&&Add"))),
        title: ( localize(5520, "Add Folder to Workspace")),
...
CommandsRegistry.registerCommand(PICK_WORKSPACE_FOLDER_COMMAND_ID, async function (accessor, args) {
    ...
    if (!options.placeHolder) {
        options.placeHolder = ( localize(5521, "Select workspace folder"));
    }

...
import { isWindows, isMacintosh, isWeb, isNative } from '../../../../base/common/platform.js';
...
let WindowTitle = class WindowTitle extends Disposable {
    ...
    static { this.NLS_USER_IS_ADMIN = isWindows ? ( localize(4821, "[Administrator]")) : ( localize(4822, "[Superuser]")); }
    static { this.NLS_EXTENSION_HOST = ( localize(4823, "[Extension Development Host]")); }

...
import { FileSystemProviderCapabilities, FileChangeType as FileChangeType$1 } from '../../../platform/files/common/files.js';
            ...
            for (const e of event) {
                ...
                switch (type) {
                    case FileChangeType.Changed:
                        newType = FileChangeType$1.UPDATED;
                        break;
                    case FileChangeType.Created:
                        newType = FileChangeType$1.ADDED;
                        break;
                    case FileChangeType.Deleted:
                        newType = FileChangeType$1.DELETED;
                        break;
                    default:

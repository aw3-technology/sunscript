...
import { LanguageModelError, LanguageModelChatMessageRole, LanguageModelFunctionResultPart, LanguageModelTextPart, LanguageModelFunctionUsePart } from './extHostTypes.js';
    ...
    *_streams() {
    ...
    handleFragment(fragment) {
        ...
        if (fragment.part.type === 'text') {
            ...
            out = new LanguageModelFunctionUsePart(fragment.part.name, fragment.part.parameters);
        }
...
let ExtHostLanguageModels = class ExtHostLanguageModels {
    ...
    async $startChatRequest(handle, requestId, from, messages, options, token) {
        ...
        const progress = ( (new Progress(async (fragment) => {
            ...
            let part;
            if (fragment.part instanceof LanguageModelFunctionUsePart) {
    ...
    _convertMessages(extension, messages) {
        ...
        for (const message of messages) {
            ...
            if (message.content2 instanceof LanguageModelFunctionResultPart) {
    ...
    async _getAuthAccess(from, to, justification, silent) {
        ...
        try {
            const detail = justification
                ? ( localize(577, "Justification: {1}", to.displayName, justification))
                : undefined;

...
import { TestsDiffOp, isStartControllerTests, TestRunProfileBitset, TestControllerCapability, AbstractIncrementalTestCollection, TestResultState } from '../../contrib/testing/common/testTypes.js';
...
let ExtHostTesting = class ExtHostTesting extends Disposable {
    ...
    async runControllerTestRequest(req, isContinuous, token) {
        ...
        const excludeTests = ( req.excludeExtIds
            ...
            .filter(isDefined)
            .filter(exclude => ( includeTests.some(include => include.fullId.compare(exclude.fullId) === TestPosition.IsChild)));

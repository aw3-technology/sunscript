...
import { SymbolKind, SymbolKinds, SymbolTag } from '../../../../editor/common/languages.js';
...
let SymbolsQuickAccessProvider = class SymbolsQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    constructor(labelService, openerService, editorService, configurationService, codeEditorService) {
        super(SymbolsQuickAccessProvider_1.PREFIX, {
            ...
            noResultsPick: {
                label: ( localize(8319, "No matching workspace symbols"))
            }
        });
                ...
                buttons: [
                    {
                        ...
                        tooltip: openSideBySideDirection === 'right' ? ( localize(8320, "Open to the Side")) : ( localize(8321, "Open to the Bottom"))
                    }
                ],

...
import { MouseTargetType, ContentWidgetPositionPreference } from '../../../../editor/browser/editorBrowser.js';
import { EditorOption } from '../../../../editor/common/config/editorOptions.js';
import { Range } from '../../../../editor/common/core/range.js';
import { ILanguageService } from '../../../../editor/common/languages/language.js';
import { GlyphMarginLane, TrackedRangeStickiness, OverviewRulerLane } from '../../../../editor/common/model.js';
...
import { BREAKPOINT_EDITOR_CONTRIBUTION_ID, CONTEXT_BREAKPOINT_WIDGET_VISIBLE, BreakpointWidgetContext, State, DebuggerString } from '../common/debug.js';
...
const breakpointHelperDecoration = {
    ...
    glyphMarginHoverMessage: ( (new MarkdownString())).appendText(( localize(5819, "Click to add a breakpoint"))),
...
let BreakpointEditorContribution = class BreakpointEditorContribution {
            ...
            if (e.event.rightButton || (isMacintosh && e.event.leftButton && e.event.ctrlKey)) {
                ...
                if (breakpoints.length) {
                    ...
                    if (isShiftPressed) {
                        ...
                        const breakpointType = logPoint ? ( localize(5820, "Logpoint")) : ( localize(5821, "Breakpoint"));
                        const disabledBreakpointDialogMessage = ( localize(
                            ...
                            logPoint ? ( localize(5823, "message")) : ( localize(5824, "condition"))
                        ));
                        ...
                        await this.dialogService.prompt({
                            ...
                            buttons: [
                                {
                                    label: ( localize(5826, "&&Remove {0}", breakpointType)),
                                    run: () => breakpoints.forEach(bp => this.debugService.removeBreakpoints(bp.getId()))
                                },
                                {
                                    label: ( localize(5827, "{0} {1}", enabled ? ( localize(5828, "&&Disable")) : ( localize(5829, "&&Enable")), breakpointType)),
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            const breakpointType = breakpoints[0].logMessage ? ( localize(5820, "Logpoint")) : ( localize(5821, "Breakpoint"));
            actions.push(( (new Action('debug.removeBreakpoint', ( localize(5830, "Remove {0}", breakpointType)), undefined, true, async () => {
                await this.debugService.removeBreakpoints(breakpoints[0].getId());
            }))));
            actions.push(( (new Action('workbench.debug.action.editBreakpointAction', ( localize(5831, "Edit {0}...", breakpointType)), undefined, true, () => Promise.resolve(this.showBreakpointWidget(breakpoints[0].lineNumber, breakpoints[0].column))))));
            actions.push(( (new Action(
                `workbench.debug.viewlet.action.toggleBreakpoint`,
                breakpoints[0].enabled ? ( localize(5832, "Disable {0}", breakpointType)) : ( localize(5833, "Enable {0}", breakpointType)),
                undefined,
                true,
            ...
            actions.push(( (new SubmenuAction('debug.removeBreakpoints', ( localize(5834, "Remove Breakpoints")),  (sorted.map(
                bp => ( (new Action('removeInlineBreakpoint', bp.column ? ( localize(5835, "Remove Inline Breakpoint on Column {0}", bp.column)) : ( localize(5836, "Remove Line Breakpoint")), undefined, true, () => this.debugService.removeBreakpoints(bp.getId()))))
            ))))));
            actions.push(( (new SubmenuAction('debug.editBreakpoints', ( localize(5837, "Edit Breakpoints")),  (sorted.map(
                bp => ( (new Action('editBreakpoint', bp.column ? ( localize(5838, "Edit Inline Breakpoint on Column {0}", bp.column)) : ( localize(5839, "Edit Line Breakpoint")), undefined, true, () => Promise.resolve(this.showBreakpointWidget(bp.lineNumber, bp.column)))))
            ))))));
            actions.push(( (new SubmenuAction('debug.enableDisableBreakpoints', ( localize(5840, "Enable/Disable Breakpoints")),  (sorted.map(bp => ( (new Action(
                bp.enabled ? 'disableColumnBreakpoint' : 'enableColumnBreakpoint',
                bp.enabled ? (bp.column ? ( localize(5841, "Disable Inline Breakpoint on Column {0}", bp.column)) : ( localize(5842, "Disable Line Breakpoint")))
                    : (bp.column ? ( localize(5843, "Enable Inline Breakpoint on Column {0}", bp.column)) : ( localize(5844, "Enable Line Breakpoint"))),
                undefined,
                true,
            ...
            actions.push(( (new Action('addBreakpoint', ( localize(5845, "Add Breakpoint")), undefined, true, () => this.debugService.addBreakpoints(uri, [{ lineNumber, column }])))));
            actions.push(( (new Action('addConditionalBreakpoint', ( localize(5846, "Add Conditional Breakpoint...")), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column, BreakpointWidgetContext.CONDITION))))));
            actions.push(( (new Action('addLogPoint', ( localize(5847, "Add Logpoint...")), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column, BreakpointWidgetContext.LOG_MESSAGE))))));
            actions.push(( (new Action('addTriggeredBreakpoint', ( localize(5848, "Add Triggered Breakpoint...")), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column, BreakpointWidgetContext.TRIGGER_POINT))))));
        }
        if (this.debugService.state === State.Stopped) {
            actions.push(( (new Separator())));
            actions.push(( (new Action('runToLine', ( localize(5849, "Run to Line")), undefined, true, () => this.debugService.runTo(uri, lineNumber).catch(onUnexpectedError)))));
        }
        return actions;
    }
...
const debugIconBreakpointForeground = registerColor('debugIcon.breakpointForeground', '#E51400', ( localize(5850, 'Icon color for breakpoints.')));
const debugIconBreakpointDisabledForeground = registerColor('debugIcon.breakpointDisabledForeground', '#848484', ( localize(5851, 'Icon color for disabled breakpoints.')));
const debugIconBreakpointUnverifiedForeground = registerColor('debugIcon.breakpointUnverifiedForeground', '#848484', ( localize(5852, 'Icon color for unverified breakpoints.')));
const debugIconBreakpointCurrentStackframeForeground = registerColor('debugIcon.breakpointCurrentStackframeForeground', { dark: '#FFCC00', light: '#BE8700', hcDark: '#FFCC00', hcLight: '#BE8700' }, ( localize(5853, 'Icon color for the current breakpoint stack frame.')));
const debugIconBreakpointStackframeForeground = registerColor('debugIcon.breakpointStackframeForeground', '#89D185', ( localize(5854, 'Icon color for all breakpoint stack frames.')));

...
( ((function(CommentAccessibilityHelpNLS) {
    ...
    CommentAccessibilityHelpNLS.commentCommands = ( localize(5354, "Some useful comment commands include:"));
    CommentAccessibilityHelpNLS.escape = ( localize(5355, "- Dismiss Comment (Escape)"));
    ...
    CommentAccessibilityHelpNLS.submitComment = ( localize(5361, "- Submit Comment{0}.", `<keybinding:${CommentCommandId.Submit}>`));

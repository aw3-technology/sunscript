...
import { SELECT_KERNEL_ID, NOTEBOOK_ACTIONS_CATEGORY } from '../controller/coreActions.js';
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10718, 'Select Notebook Kernel')),
            ...
            metadata: {
                description: ( localize(10719, "Notebook Kernel Args")),
                args: [
                    {
                        name: 'kernelInfo',

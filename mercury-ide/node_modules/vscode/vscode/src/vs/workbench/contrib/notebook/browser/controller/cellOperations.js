...
import { SelectionStateType, CellKind, CellEditType } from '../../common/notebookCommon.js';
import { cellRangesToIndexes, cellRangeContains } from '../../common/notebookRange.js';
...
async function joinSelectedCells(bulkEditService, notificationService, context) {
    ...
    if (!isSameKind) {
        const message = ( localize(10600, "Cannot join cells of different kinds"));
    ...
    if (edits.length) {
        await bulkEditService.apply(edits, { quotableLabel: ( localize(10601, "Join Notebook Cells")) });
    }
}

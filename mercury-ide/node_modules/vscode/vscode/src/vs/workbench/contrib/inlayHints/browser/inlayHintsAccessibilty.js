...
import { registerEditorContribution, EditorContributionInstantiation, EditorAction2 } from '../../../../editor/browser/editorExtensions.js';
...
let InlayHintsAccessibility = class InlayHintsAccessibility {
    ...
    static { this.IsReading = ( (new RawContextKey(
        ...
        false,
        { type: 'boolean', description: ( localize(746, "Whether the current line and its inlay hints are currently focused")) }
    ))); }
    ...
    constructor(_editor, contextKeyService, _accessibilitySignalService, _instaService) {
        ...
        this._ariaElement.setAttribute('aria-description', ( localize(747, "Code with Inlay Hint Information")));
...
registerAction2(class StartReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(748, "Read Line With Inline Hints")),
...
registerAction2(class StopReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(749, "Stop Inlay Hints Reading")),

...
registerAction2(class RestrictSearchToFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8380, "Restrict Search to Folder")),
            category,
            keybinding: {
...
registerAction2(class ExpandSelectedTreeCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(8381, "Expand Recursively")),
            category,
            menu: [{
                    id: MenuId.SearchContext,
                    when: ( (ContextKeyExpr.and(SearchContext.FolderFocusKey, SearchContext.HasSearchResults))),
                    group: 'search',
                    order: 4
                }]
        });
...
registerAction2(class ExcludeFolderFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8382, "Exclude Folder from Search")),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class RevealInSideBarForSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8383, "Reveal in Explorer View")),
            category,
            menu: [{
                    id: MenuId.SearchContext,
...
registerAction2(class FindInFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(8384, "Find in Files")),
                mnemonicTitle: ( localize(8385, "Find &&in Files")),
            },
            metadata: {
                description: ( localize(8386, "Open a workspace search")),
                args: [
                    {
                        name: ( localize(8387, "A set of options for the search")),
                        schema: {
                            type: 'object',
                            properties: {
                                query: { 'type': 'string' },
...
registerAction2(class FindInFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8388, "Find in Folder...")),
            category,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class FindInWorkspaceAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8389, "Find in Workspace...")),
            category,
            menu: [
                {
                    id: MenuId.ExplorerContext,

...
import { formatDocumentWithSelectedProvider, FormattingMode, formatDocumentRangesWithSelectedProvider } from '../../../../editor/contrib/format/browser/format.js';
...
let CodeActionOnSaveParticipant = class CodeActionOnSaveParticipant extends Disposable {
    ...
    async participate(model, context, progress, token) {
        ...
        progress.report({ message: ( localize(725, "Quick Fixes")) });
        ...
        for (const codeActionKind of codeActionsOnSave) {
            ...
            try {
                for (const action of actionsToRun.validActions) {
                    progress.report({ message: ( localize(727, "Applying code action '{0}'.", action.action.title)) });

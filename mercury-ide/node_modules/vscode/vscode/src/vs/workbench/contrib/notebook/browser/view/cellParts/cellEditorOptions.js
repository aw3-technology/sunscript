...
( (Registry.as(Extensions.Configuration))).registerConfiguration({
    ...
    'properties': {
        'notebook.lineNumbers': {
            ...
            enum: ['off', 'on'],
            default: 'off',
            markdownDescription: ( localize(11382, "Controls the display of line numbers in the cell editor."))
        }
    }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11383, 'Toggle Notebook Line Numbers')),
            ...
            toggled: {
                ...
                title: ( localize(11384, "Notebook Line Numbers")),
            }
        });
    }
    async run(accessor) {
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: ( localize(11385, "Show Cell Line Numbers")),
            ...
            toggled: ( (ContextKeyExpr.or(
                 ...
                 (ContextKeyExpr.and(
                     ...
                     (ContextKeyExpr.equals('config.notebook.lineNumbers', 'on'))
                ))
            )))
        });
    }

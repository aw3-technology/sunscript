...
import { append, $, addDisposableListener, EventHelper, EventType, trackFocus, getTotalWidth } from '../../../../base/browser/dom.js';
...
import { isWorkspaceFolder, WorkbenchState } from '../../../../platform/workspace/common/workspace.js';
...
let SettingsTargetsWidget = class SettingsTargetsWidget extends Widget {
    ...
    resetLabels() {
        ...
        this.userLocalSettings.label = ( localize(10331, "User"));
        this.userRemoteSettings.label = ( localize(10332, "Remote")) + (hostLabel ? ` [${hostLabel}]` : '');
        this.workspaceSettings.label = ( localize(10333, "Workspace"));
        this.folderSettingsAction.label = ( localize(10334, "Folder"));
    }
    create(parent) {
        ...
        this.settingsSwitcherBar = this._register(( (new ActionBar(settingsTabsWidget, {
            ...
            ariaLabel: ( localize(10335, "Settings Switcher")),
            ariaRole: 'tablist',
        ...
        this.userLocalSettings.tooltip = ( localize(10331, "User"));
        ...
        const remoteAuthority = this.environmentService.remoteAuthority;
        const hostLabel = remoteAuthority && this.labelService.getHostLabel(Schemas.vscodeRemote, remoteAuthority);
        this.userRemoteSettings.tooltip = ( localize(10332, "Remote")) + (hostLabel ? ` [${hostLabel}]` : '');
    ...
    setResultCount(settingsTarget, count) {
        if (settingsTarget === ConfigurationTarget.WORKSPACE) {
            let label = ( localize(10333, "Workspace"));
            if (count) {
                label += ` (${count})`;
            }
    ...
    async update() {
        ...
        this.workspaceSettings.tooltip = ( localize(10333, "Workspace"));
    }
};

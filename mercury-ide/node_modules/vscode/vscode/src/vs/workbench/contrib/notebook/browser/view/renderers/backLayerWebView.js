...
import { Schemas, FileAccess, matchesScheme, matchesSomeScheme } from '../../../../../../base/common/network.js';
import { equals } from '../../../../../../base/common/objects.js';
import { isAbsolute } from '../../../../../../base/common/path.js';
import { isWeb, isMacintosh } from '../../../../../../base/common/platform.js';
import { dirname, isEqual, extname, joinPath } from '../../../../../../base/common/resources.js';
...
import { editorFindMatch, editorFindMatchHighlight } from '../../../../../../platform/theme/common/colors/editorColors.js';
...
import { RendererMessagingSpec, CellUri } from '../../../common/notebookCommon.js';
...
import { WebviewOriginStore, WebviewContentPurpose } from '../../../../webview/browser/webview.js';
import { IWebviewService } from '../../../../webview/browser/webview.service.js';
import { WebviewWindowDragMonitor } from '../../../../webview/browser/webviewWindowDragMonitor.js';
import { webviewGenericCspSource, asWebviewUri } from '../../../../webview/common/webview.js';
...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            'notebook-cell-markup-empty-content': ( localize(10692, "Empty markdown cell, double-click or press enter to edit.")),
            'notebook-cell-renderer-not-found-error': ( localize(10693, "No renderer found for '$0'")),
            'notebook-cell-renderer-fallbacks-exhausted': ( localize(10694, "Could not render content for '$0'")),
        };
    }
    ...
    getRendererData() {
        return (
             (this.notebookService.getRenderers().map((renderer) => {
                const entrypoint = {
                ...
                case 'clickMarkupCell': {
                    ...
                    if (cell) {
                        if (data.shiftKey || (isMacintosh ? data.metaKey : data.ctrlKey)) {
                            this.notebookEditor.toggleNotebookCellSelection(cell,  data.shiftKey);
                        }
                        else {
    ...
    _createInset(webviewService, content) {
        ...
        const webview = webviewService.createWebviewElement({
            ...
            title: ( localize(10695, "Notebook webview content")),
            options: {

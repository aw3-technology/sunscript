...
import { VIEW_ID, VIEWLET_ID, ExplorerViewletVisibleContext } from '../common/files.js';
...
import { ViewContainerLocation, Extensions, ViewContentGroups } from '../../../common/views.js';
...
import { WorkbenchStateContext, OpenFolderWorkspaceSupportContext, RemoteNameContext } from '../../../common/contextkeys.js';
import { IsWebContext } from '../../../../platform/contextkey/common/contextkeys.js';
import { AddRootFolderAction, OpenFileFolderAction, OpenFolderAction, OpenFolderViaWorkspaceAction } from '../../../browser/actions/workspaceActions.js';
import { OpenRecentAction } from '../../../browser/actions/windowActions.js';
import { isMacintosh, isWeb } from '../../../../base/common/platform.js';
import { Codicon } from '../../../../base/common/codicons.js';
import { registerIcon } from '../../../../platform/theme/common/iconRegistry.js';
import { isMouseEvent } from '../../../../base/browser/dom.js';
const explorerViewIcon = registerIcon('explorer-view-icon', Codicon.files, ( localize(5522, 'View icon of the explorer view.')));
const openEditorsViewIcon = registerIcon('open-editors-view-icon', Codicon.book, ( localize(5523, 'View icon of the open editors view.')));
    ...
    createOpenEditorsViewDescriptor() {
        return {
            ...
            focusCommand: {
                ...
                keybindings: { primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.KeyE) }
            }
        };
    }
...
const VIEW_CONTAINER = viewContainerRegistry.registerViewContainer({
    ...
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        title: ( localize2(5525, "Explorer")),
        mnemonicTitle: ( localize(5526, "&&Explorer")),
        keybindings: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyE },
        order: 0
    },
}, ViewContainerLocation.Sidebar, { isDefault: true });
const openFolder = ( localize(5527, "Open Folder"));
const addAFolder = ( localize(5528, "add a folder"));
const openRecent = ( localize(5529, "Open Recent"));
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(5532, "Connected to remote.\n{0}", openFolderButton)),
    when: ( (ContextKeyExpr.and(
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(5534, "You have not yet opened a folder.\n{0}", openFolderButton)),
    when: ( (ContextKeyExpr.and(

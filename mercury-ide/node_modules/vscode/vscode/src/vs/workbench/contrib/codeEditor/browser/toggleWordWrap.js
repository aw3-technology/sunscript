...
import { registerEditorContribution, registerDiffEditorContribution, registerEditorAction, EditorContributionInstantiation, EditorAction } from '../../../../editor/browser/editorExtensions.js';
...
const EDITOR_WORD_WRAP = ( (new RawContextKey('editorWordWrap', false, ( localize(736, 'Whether the editor is currently using word wrapping.')))));
...
class ToggleWordWrapAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(737, "View: Toggle Word Wrap")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(738, "Disable wrapping for this file")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(739, "Enable wrapping for this file")),
        icon: Codicon.wordWrap
    },
    group: 'navigation',
    order: 1,

...
const testStateNames = {
    [TestResultState.Errored]: ( localize(4063, 'Errored')),
    [TestResultState.Failed]: ( localize(4064, 'Failed')),
    [TestResultState.Passed]: ( localize(4065, 'Passed')),
    [TestResultState.Queued]: ( localize(4066, 'Queued')),
    [TestResultState.Running]: ( localize(4067, 'Running')),
    [TestResultState.Skipped]: ( localize(4068, 'Skipped')),
    [TestResultState.Unset]: ( localize(4069, 'Not yet run')),
};
const labelForTestInState = (label, state) => ( localize(4070, '{0} ({1})', stripIcons(label), testStateNames[state]));
const testConfigurationGroupNames = {
    [TestRunProfileBitset.Debug]: ( localize(4071, 'Debug')),
    [TestRunProfileBitset.Run]: ( localize(4072, 'Run')),
    [TestRunProfileBitset.Coverage]: ( localize(4073, 'Coverage')),
};
var TestCommandId;

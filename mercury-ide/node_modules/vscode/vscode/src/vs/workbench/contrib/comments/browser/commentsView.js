...
let CommentsPanel = class CommentsPanel extends FilterViewPane {
    ...
    constructor(options, instantiationService, viewDescriptorService, editorService, configurationService, contextKeyService, contextMenuService, keybindingService, openerService, themeService, commentService, telemetryService, hoverService, uriIdentityService, storageService) {
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: ( localize(5329, "Filter (e.g. text, author)")),
                ariaLabel: ( localize(5330, "Filter comments")),
    ...
    updateFilter() {
        ...
        this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : ( localize(5331, "Showing {0} of {1}", filtered, total)));
    ...
    getScreenReaderInfoForNode(element, forAriaLabel) {
        ...
        if (forAriaLabel && this.configurationService.getValue(AccessibilityVerbositySettingId.Comments)) {
            ...
            accessibleViewHint = kbLabel ? ( localize(5332, "Inspect this in the accessible view ({0}).\n", kbLabel)) : ( localize(
                5333,
    ...
    getReplyCountAsString(node, forAriaLabel) {
        return node.replies.length && !forAriaLabel ? ( localize(5339, " {0} replies,", node.replies.length)) : '';
    }
    createTree() {
            ...
            accessibilityProvider: {
                getAriaLabel: (element) => {
                    if (element instanceof CommentsModel) {
                        return ( localize(5340, "Comments for current workspace"));
                    }

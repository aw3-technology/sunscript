...
import { SpeechToTextStatus, HasSpeechProvider, SpeechToTextInProgress } from '../../../speech/common/speechService.js';
...
class EditorDictationStartAction extends EditorAction2 {
    constructor() {
        super({
            ...
            f1: true,
            keybinding: {
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyV,
                weight: KeybindingWeight.WorkbenchContrib,
                secondary: isWindows ? [
                    KeyMod$1.Alt | KeyCode.Backquote
                ] : undefined
            }
        });
    }
...
class EditorDictationStopAction extends EditorAction2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(10422, "Stop Dictation in Editor")),
            category: VOICE_CATEGORY,
...
class DictationWidget extends Disposable {
    constructor(editor, keybindingService) {
        ...
        actionBar.push(toAction({
            id: EditorDictationStopAction.ID,
            label: stopActionKeybinding ? ( localize(10423, "Stop Dictation ({0})", stopActionKeybinding)) : ( localize(10424, "Stop Dictation")),

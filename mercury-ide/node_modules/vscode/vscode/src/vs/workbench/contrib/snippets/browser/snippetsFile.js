...
import { SnippetParser, Placeholder, Variable, Text } from '../../../../editor/contrib/snippet/browser/snippetParser.js';
...
class SnippetFile {
    ...
    _parseSnippet(name, snippet, bucket) {
        ...
        if (this._extension) {
            ...
            source = ( localize(6745, "Workspace Snippet"));
        }
        else {
            if (this.isGlobalSnippets) {
                source = ( localize(6746, "Global User Snippet"));
            }
            else {
                source = ( localize(6747, "User Snippet"));
            }
        }

...
import { ITerminalCapabilityStore, IMarkProperties, ITerminalCommand } from '../../../../platform/terminal/common/capabilities/capabilities.js';
import { IMergedEnvironmentVariableCollection } from '../../../../platform/terminal/common/environmentVariable.js';
import { IShellLaunchConfig, ITerminalTabLayoutInfoById, TerminalLocation, ITerminalProfile, IExtensionTerminalProfile, TerminalIcon, IReconnectionProperties, WaitOnExitValue, TerminalShellType, ITerminalLaunchError, TerminalExitReason, TitleEventSource, ITerminalDimensions, IShellIntegration } from '../../../../platform/terminal/common/terminal.js';
import { IColorTheme } from '../../../../platform/theme/common/themeService.js';
import { IWorkspaceFolder } from '../../../../platform/workspace/common/workspace.js';
import { ITerminalStatusList } from './terminalStatusList.js';
import { XtermTerminal } from './xterm/xtermTerminal.js';
import { ITerminalProcessInfo, ITerminalFont } from '../common/terminal.js';
import { IMarker, IBufferRange, ITheme, Terminal } from '@xterm/xterm';
 ...
 * been initialized.
 */
interface ITerminalContribution extends IDisposable {
...
declare const enum TerminalConnectionState {
    Connecting = 0,
    Connected = 1
}
 ...
 */
interface IBaseTerminalInstance {
 ...
 */
interface IDetachedTerminalInstance extends IDisposable, IBaseTerminalInstance {
...
interface ITerminalServiceNativeDelegate {
    getWindowCount(): Promise<number>;
}
type ITerminalLocationOptions = TerminalLocation | TerminalEditorLocation | {
    parentTerminal: Promise<ITerminalInstance> | ITerminalInstance;
} | {
    splitActiveTerminal: boolean;
};
interface ICreateTerminalOptions {
    /**
...
interface TerminalEditorLocation {
 ...
 */
interface ITerminalInstanceHost {
...
interface ITerminalInstance extends IBaseTerminalInstance {
    /**
...
interface IXtermAttachToElementOptions {
    /**
     * Whether GPU rendering should be enabled for this element, defaults to true.
     */
    enableGpu: boolean;
}
interface IXtermTerminal extends IDisposable {
    /**
...
interface IDetachedXtermTerminal extends IXtermTerminal {
    /**
...
interface IInternalXtermTerminal {
    /**
...
export { Direction, type IBaseTerminalInstance, type ICreateTerminalOptions, type IDetachedTerminalInstance, type IDetachedXTermOptions, type IDetachedXtermTerminal, type IInternalXtermTerminal, type IMarkTracker, type IRequestAddInstanceToGroupEvent, type ISearchOptions, type ITerminalContribution, type ITerminalGroup, type ITerminalInstance, type ITerminalInstanceHost, type ITerminalLocationOptions, type ITerminalServiceNativeDelegate, type IXtermAttachToElementOptions, type IXtermColorProvider, type IXtermTerminal, TerminalConnectionState, type TerminalEditorLocation };

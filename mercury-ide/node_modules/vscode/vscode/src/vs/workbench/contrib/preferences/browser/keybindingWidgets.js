...
let DefineKeybindingWidget = class DefineKeybindingWidget extends Widget {
    ...
    constructor(parent, instantiationService) {
        ...
        const message = ( localize(8667, "Press desired key combination and then press ENTER."));
    ...
    printExisting(numberOfExisting) {
        if (numberOfExisting > 0) {
            ...
            const text = numberOfExisting === 1 ? ( localize(8668, "1 existing command has this keybinding", numberOfExisting)) : ( localize(8669, "{0} existing commands have this keybinding", numberOfExisting));
    ...
    onKeybinding(keybinding) {
        ...
        if (this._chords) {
            for (let i = 1; i < this._chords.length; i++) {
                this._outputNode.appendChild(document.createTextNode(( localize(8670, "chord to"))));

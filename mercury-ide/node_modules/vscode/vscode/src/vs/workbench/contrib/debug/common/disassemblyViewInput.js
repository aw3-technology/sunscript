...
const DisassemblyEditorIcon = registerIcon('disassembly-editor-label-icon', Codicon.debug, ( localize(5817, 'Icon of the disassembly editor label.')));
class DisassemblyViewInput extends EditorInput {
    ...
    getName() {
        return ( localize(5818, "Disassembly"));
    }
    getIcon() {

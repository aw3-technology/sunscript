...
import { getWindow, append, $, modify, setVisibility, safeInnerHtml, runAtThisOrScheduleAtNextAnimationFrame, hide, show } from '../../../../../../base/browser/dom.js';
...
let CodeCell = class CodeCell extends Disposable {
    ...
    _reigsterModelListeners(model) {
        this._register(model.onDidChangeTokens(() => {
            if (this.viewCell.isInputCollapsed && this._inputCollapseElement) {
                ...
                safeInnerHtml(this._inputCollapseElement, content);
    ...
    _collapseInput() {
        ...
        safeInnerHtml(element, richEditorText);
    ...
    _attachInputExpandButton(element) {
        ...
        if (keybinding) {
            element.title = ( localize(11386, "Double-click to expand cell input ({0})", keybinding.getLabel()));
            expandIcon.title = ( localize(11387, "Expand Cell Input ({0})", keybinding.getLabel()));
        }

...
import { $, trackFocus, createStyleSheet, addDisposableListener, EventType } from '../../../../base/browser/dom.js';
...
import { textLinkForeground, textLinkActiveForeground, focusBorder, textBlockQuoteBackground, textBlockQuoteBorder, contrastBorder } from '../../../../platform/theme/common/colors/baseColors.js';
import '../../../../platform/theme/common/colors/chartsColors.js';
import '../../../../platform/theme/common/colors/editorColors.js';
import { inputValidationErrorBorder, inputValidationErrorBackground, inputValidationErrorForeground } from '../../../../platform/theme/common/colors/inputColors.js';
...
let CommentThreadWidget = class CommentThreadWidget extends Disposable {
    ...
    _setAriaLabel() {
        let ariaLabel = ( localize(11238, "Comment"));
        let keybinding;
        ...
        if (keybinding) {
            ariaLabel = ( localize(11239, "{0}, use ({1}) for accessibility help", ariaLabel, keybinding));
        }
        else {
            ariaLabel = ( localize(
                11240,
    ...
    async updateCommentThread(commentThread) {
        const shouldCollapse = (this._commentThread.collapsibleState === CommentThreadCollapsibleState.Expanded) && (this._commentThreadState === CommentThreadState.Unresolved)
            && (commentThread.state === CommentThreadState.Resolved);

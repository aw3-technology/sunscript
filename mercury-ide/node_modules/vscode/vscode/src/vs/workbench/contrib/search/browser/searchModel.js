...
import { Emitter, PauseableEmitter, Event } from '../../../../base/common/event.js';
...
import { TrackedRangeStickiness, OverviewRulerLane, MinimapPosition, FindMatch } from '../../../../editor/common/model.js';
...
import { isINotebookFileMatchWithModel, contentMatchesToTextSearchMatches, webviewMatchesToTextSearchMatches, isINotebookCellMatchWithModel, getIDFromINotebookCellMatch } from './notebookSearch/searchNotebookHelpers.js';
...
import { resultIsMatch, DEFAULT_MAX_SEARCH_RESULTS, OneLineRange, SearchSortOrder, QueryType, SearchCompletionExitCode } from '../../../services/search/common/search.js';
...
let SearchModel = class SearchModel extends Disposable {
    ...
    async addAIResults(onProgress) {
        if (this.searchResult.count(true)) {
            ...
            if (this._searchQuery) {
                await this.aiSearch({ ...this._searchQuery, contentPattern: this._searchQuery.contentPattern.pattern, type: QueryType.aiText }, onProgress, this.currentCancelTokenSource?.token);
            }
        }
    }
...
export { CellMatch, FileMatch, FolderMatch, FolderMatchNoRoot, FolderMatchWithResource, FolderMatchWorkspaceRoot, Match, MatchInNotebook, RangeHighlightDecorations, SearchModel, SearchModelLocation, SearchResult, SearchViewModelWorkbenchService, arrayContainsElementOrParent, compareNotebookPos, searchComparer, searchMatchComparer, textSearchMatchesToNotebookMatches };

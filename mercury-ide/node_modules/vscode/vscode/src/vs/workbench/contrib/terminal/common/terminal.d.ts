...
import { TitleEventSource, IFixedTerminalDimensions, IProcessProperty, IProcessReadyWindowsPty, ITerminalLaunchError, ITerminalBackend, TerminalLocationString, ITerminalProfileObject } from '../../../../platform/terminal/common/terminal.js';

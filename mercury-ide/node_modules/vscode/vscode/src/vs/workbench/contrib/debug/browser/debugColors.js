...
import { foreground, errorForeground, contrastBorder } from '../../../../platform/theme/common/colors/baseColors.js';
import '../../../../platform/theme/common/colors/chartsColors.js';
import { editorInfoForeground, editorWarningForeground, toolbarHoverBackground } from '../../../../platform/theme/common/colors/editorColors.js';
import { inputBorder } from '../../../../platform/theme/common/colors/inputColors.js';
import { listDeemphasizedForeground } from '../../../../platform/theme/common/colors/listColors.js';
...
const debugToolBarBackground = registerColor('debugToolBar.background', {
    ...
    hcDark: '#000000',
    hcLight: '#FFFFFF'
}, ( localize(5934, "Debug toolbar background color.")));
const debugToolBarBorder = registerColor('debugToolBar.border', null, ( localize(5935, "Debug toolbar border color.")));
const debugIconStartForeground = registerColor('debugIcon.startForeground', {
    dark: '#89D185',
    light: '#388A34',
    hcDark: '#89D185',
    hcLight: '#388A34'
}, ( localize(5936, "Debug toolbar icon for start debugging.")));
function registerColors() {
    ...
    registerThemingParticipant((theme, collector) => {
        ...
        if (debugIconDisconnectColor) {
            collector.addRule(`.monaco-workbench .part > .title > .title-actions .action-label${ThemeIcon.asCSSSelector(debugDisconnect)},.monaco-workbench .debug-view-content ${ThemeIcon.asCSSSelector(debugDisconnect)}, .monaco-workbench .debug-toolbar ${ThemeIcon.asCSSSelector(debugDisconnect)}, .monaco-workbench .command-center-center ${ThemeIcon.asCSSSelector(debugDisconnect)} { color: ${debugIconDisconnectColor}; }`);
        }

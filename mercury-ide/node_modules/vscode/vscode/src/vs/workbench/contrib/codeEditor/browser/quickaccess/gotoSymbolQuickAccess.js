...
import { accessibleViewIsShown, accessibilityHelpIsShown } from '../../../accessibility/browser/accessibilityConfiguration.js';
import { parseLabelWithIcons, matchesFuzzyIconAware } from '../../../../../base/common/iconLabels.js';
        ...
        this.outlineService.createOutline(pane, OutlineTarget.QuickPick, cts.token).then(outline => {
            ...
            const updatePickerItems = () => {
                ...
                if (filteredItems.length === 0) {
                    const label = ( localize(883, 'No matching entries'));
...
class GotoSymbolAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(884, "Go to Symbol in Editor...")),
                mnemonicTitle: ( localize(885, "Go to &&Symbol in Editor...")),
            },
            f1: true,
            keybinding: {
...
( (Registry.as(Extensions.Quickaccess))).registerQuickAccessProvider({
    ...
    placeholder: ( localize(886, "Type the name of a symbol to go to.")),
    helpEntries: [
        {
            description: ( localize(887, "Go to Symbol in Editor")),
            prefix: AbstractGotoSymbolQuickAccessProvider.PREFIX,
            commandId: GotoSymbolAction.ID,
            commandCenterOrder: 40
        },
        {
            description: ( localize(888, "Go to Symbol in Editor by Category")),

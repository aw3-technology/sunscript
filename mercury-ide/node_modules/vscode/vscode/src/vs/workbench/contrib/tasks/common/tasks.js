...
const TASK_RUNNING_STATE = ( (new RawContextKey('taskRunning', false, ( localize(3790, "Whether a task is currently running.")))));
const TASKS_CATEGORY = ( localize2(3791, "Tasks"));
var ShellQuoting;
...
export { CUSTOMIZED_TASK_TYPE, CommandOptions, CommandString, CommonTask, ConfiguringTask, ContributedTask, CustomTask, DependsOrder, ExecutionEngine, InMemoryTask, JsonSchemaVersion, KeyedTaskIdentifier, PanelKind, PresentationOptions, RevealKind, RevealProblemKind, RunOnOptions, RunOptions, RuntimeType, ShellQuoting, TASKS_CATEGORY, TASK_RUNNING_STATE, TaskDefinition, TaskEvent, TaskEventKind, TaskGroup, TaskRunSource, TaskRunType, TaskScope, TaskSettingId, TaskSorter, TaskSourceKind, TasksSchemaProperties, USER_TASKS_GROUP_KEY };

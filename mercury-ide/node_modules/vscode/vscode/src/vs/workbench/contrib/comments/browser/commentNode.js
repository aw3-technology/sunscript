...
import { $, append, addDisposableListener, EventType, scheduleAtNextAnimationFrame, getWindow, getContentWidth, getContentHeight } from '../../../../base/browser/dom.js';
...
import { Separator, ActionRunner, Action } from '../../../../base/common/actions.js';
...
let CommentNode = class CommentNode extends Disposable {
        ...
        this.toolbar = ( (new ToolBar(this._actionsToolbarContainer, this.contextMenuService, {
            actionViewItemProvider: (action, options) => {
                if (action.id === ToggleReactionsAction.ID) {
                    return (
                         (new DropdownMenuActionViewItem(action, action.menuActions, this.contextMenuService, {
                            ...options,
    ...
    createReactionPicker(reactionGroup) {
        ...
        }, ( localize(11540, "Toggle Reaction"))))));
                        ...
                        async () => {
                            try {
                                ...
                                const error = e.message
                                    ? ( localize(11541, "Toggling the comment reaction failed: {0}.", e.message))
                                    : ( localize(11542, "Toggling the comment reaction failed"));

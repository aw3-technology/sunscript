...
( (function(AccessibilityCommandId) {
    ...
    AccessibilityCommandId["NextCodeBlock"] = "editor.action.accessibleViewNextCodeBlock";
    AccessibilityCommandId["PreviousCodeBlock"] = "editor.action.accessibleViewPreviousCodeBlock";
    AccessibilityCommandId["AccessibilityHelpConfigureKeybindings"] = "editor.action.accessibilityHelpConfigureKeybindings";
    AccessibilityCommandId["AccessibilityHelpConfigureAssignedKeybindings"] = "editor.action.accessibilityHelpConfigureAssignedKeybindings";
    AccessibilityCommandId["AccessibilityHelpOpenHelpLink"] = "editor.action.accessibilityHelpOpenHelpLink";
})(AccessibilityCommandId || (AccessibilityCommandId = {})));
export { AccessibilityCommandId };

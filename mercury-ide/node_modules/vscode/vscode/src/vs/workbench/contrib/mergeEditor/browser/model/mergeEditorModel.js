...
import { equals, CompareResult } from '../../../../../base/common/arrays.js';
...
import { keepObserved } from '../../../../../base/common/observableInternal/utils.js';
import { waitForState } from '../../../../../base/common/observableInternal/promise.js';
import { Range } from '../../../../../editor/common/core/range.js';
import { ILanguageService } from '../../../../../editor/common/languages/language.js';
import { localize } from '../../../../../nls.js';
import { UndoRedoElementType, UndoRedoGroup } from '../../../../../platform/undoRedo/common/undoRedo.js';
...
import { TextModelDiffs, TextModelDiffState, TextModelDiffChangeReason } from './textModelDiffs.js';
import { leftJoin } from '../utils.js';
import { ModifiedBaseRange, ModifiedBaseRangeStateKind, ModifiedBaseRangeState } from './modifiedBaseRange.js';
let MergeEditorModel = class MergeEditorModel extends EditorModel {
        ...
        this.baseResultMapping = derived(this, reader => {
            ...
            return (
                 (new DocumentLineRangeMap(
                     (map.lineRangeMappings.map((m) => m.inputRange.isEmpty || m.outputRange.isEmpty
                        ? ( (new
                    LineRangeMapping(m.inputRange.deltaStart(-1), m.outputRange.deltaStart(-1))))
                        : m)),
                    map.inputLineCount
                ))
            );
    ...
    hasBaseRange(baseRange) {
        return (
             (this.modifiedBaseRangeResultStates.get().has(baseRange))
        );
    }
    ...
    setState(baseRange, state, _markInputAsHandled, tx, _pushStackElement = false) {
        ...
        if (!input1Handled || !input2Handled) {
            this.undoRedoService.pushElement(( (new MarkAsHandledUndoRedoElement(
    ...
    setInputHandled(baseRange, inputNumber, handled, tx) {
        ...
        this.undoRedoService.pushElement({
            ...
            label: ( localize(11380, "Set Input Handled")),
            redo() {
...
class MarkAsHandledUndoRedoElement {
    constructor(resource, mergeEditorModelRef, stateRef, input1Handled, input2Handled) {
        ...
        this.label = ( localize(11381, 'Undo Mark As Handled'));
...
export { MergeEditorModel, MergeEditorModelState };

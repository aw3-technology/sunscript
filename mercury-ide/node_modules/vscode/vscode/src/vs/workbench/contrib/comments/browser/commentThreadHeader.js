...
const collapseIcon = registerIcon('review-comment-collapse', Codicon.chevronUp, ( localize(11504, 'Icon to collapse a review comment.')));
...
class CommentThreadHeader extends Disposable {
    ...
    _fillHead() {
        ...
        this._collapseAction = ( (new Action('review.expand', ( localize(11505, "Collapse")), COLLAPSE_ACTION_CLASS, true, () => this._delegate.collapse())));
    ...
    createThreadLabel() {
        ...
        if (label === undefined) {
            if (!(this._commentThread.comments && this._commentThread.comments.length)) {
                label = ( localize(11506, "Start discussion"));
            }
        }
        if (label) {

...
const SAVE_FILE_AS_LABEL = ( localize2(5378, "Save As..."));
const SAVE_FILE_COMMAND_ID = 'workbench.action.files.save';
const SAVE_FILE_LABEL = ( localize2(5379, "Save"));
const SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID = 'workbench.action.files.saveWithoutFormatting';
const SAVE_FILE_WITHOUT_FORMATTING_LABEL = ( localize2(5380, "Save without Formatting"));
const SAVE_ALL_COMMAND_ID = 'saveAll';
const SAVE_ALL_LABEL = ( localize2(5381, "Save All"));
...
const REMOVE_ROOT_FOLDER_LABEL = ( localize(5382, "Remove Folder from Workspace"));
...
const NEW_UNTITLED_FILE_LABEL = ( localize2(5383, "New Untitled Text File"));

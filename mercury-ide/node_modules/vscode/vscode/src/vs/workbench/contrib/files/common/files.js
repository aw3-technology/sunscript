...
const ExplorerViewletVisibleContext = ( (new RawContextKey(
    ...
    true,
    { type: 'boolean', description: ( localize(5364, "True when the EXPLORER viewlet is visible.")) }
)));
...
const ExplorerFolderContext = ( (new RawContextKey(
    ...
    false,
    { type: 'boolean', description: ( localize(5366, "True when the focused item in the EXPLORER is a folder.")) }
)));
const ExplorerResourceReadonlyContext = ( (new RawContextKey(
    'explorerResourceReadonly',
    false,
    { type: 'boolean', description: ( localize(5367, "True when the focused item in the EXPLORER is read-only.")) }
)));
...
const ExplorerRootContext = ( (new RawContextKey(
    ...
    false,
    { type: 'boolean', description: ( localize(5368, "True when the focused item in the EXPLORER is a root folder.")) }
)));
const ExplorerResourceCut = ( (new RawContextKey(
    'explorerResourceCut',
    false,
    { type: 'boolean', description: ( localize(5369, "True when an item in the EXPLORER has been cut for cut and paste.")) }
)));
const ExplorerResourceMoveableToTrash = ( (new RawContextKey(
    'explorerResourceMoveableToTrash',
    false,
    { type: 'boolean', description: ( localize(5370, "True when the focused item in the EXPLORER can be moved to trash.")) }
)));
const FilesExplorerFocusedContext = ( (new RawContextKey('filesExplorerFocus', true, { type: 'boolean', description: ( localize(5371, "True when the focus is inside the EXPLORER view.")) })));
const OpenEditorsFocusedContext = ( (new RawContextKey('openEditorsFocus', true, { type: 'boolean', description: ( localize(5372, "True when the focus is inside the OPEN EDITORS view.")) })));
const ExplorerFocusedContext = ( (new RawContextKey(
    'explorerViewletFocus',
    true,
    { type: 'boolean', description: ( localize(5373, "True when the focus is inside the EXPLORER viewlet.")) }
)));
const ExplorerCompressedFocusContext = ( (new RawContextKey(
    'explorerViewletCompressedFocus',
    true,
    { type: 'boolean', description: ( localize(5374, "True when the focused item in the EXPLORER view is a compact item.")) }
)));

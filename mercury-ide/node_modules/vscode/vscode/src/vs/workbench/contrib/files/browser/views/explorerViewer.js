...
import { addDisposableListener, addStandardDisposableListener, getWindow, isHTMLElement, EventType, isActiveElement, hasParentWithClass } from '../../../../../base/browser/dom.js';
import { parse } from '../../../../../base/common/glob.js';
import { ListDragOverEffectType, ListDragOverEffectPosition } from '../../../../../base/browser/ui/list/list.js';
import { ProgressLocation } from '../../../../../platform/progress/common/progress.js';
import { IProgressService } from '../../../../../platform/progress/common/progress.service.js';
import '../../../../../platform/notification/common/notification.js';
import { INotificationService } from '../../../../../platform/notification/common/notification.service.js';
import { FileKind, FileOperationResult, FileChangeType } from '../../../../../platform/files/common/files.js';
...
import { TreeDragOverBubble, TreeVisibility } from '../../../../../base/browser/ui/tree/tree.js';
...
import { UndoConfirmLevel } from '../../common/files.js';
...
import { compareFileNamesDefault, compareFileExtensionsDefault, compareFileNamesUnicode, compareFileExtensionsUnicode, compareFileNamesLower, compareFileExtensionsLower, compareFileNamesUpper, compareFileExtensionsUpper } from '../../../../../base/common/comparers.js';
import { containsDragType, CodeDataTransfers } from '../../../../../platform/dnd/browser/dnd.js';
import { fillEditorsDragData } from '../../../../browser/dnd.js';
import { IInstantiationService } from '../../../../../platform/instantiation/common/instantiation.js';
import { DataTransfers } from '../../../../../base/browser/dnd.js';
import { Schemas } from '../../../../../base/common/network.js';
import { ExternalElementsDragAndDropData, NativeDragAndDropData, ListViewTargetSector } from '../../../../../base/browser/ui/list/listView.js';
...
import { EventMultiplexer, Event, Emitter } from '../../../../../base/common/event.js';
...
let FilesRenderer = class FilesRenderer {
    ...
    getWidgetAriaLabel() {
        return ( localize(11260, "Files Explorer"));
    }
    get templateId() {
    ...
    renderInputBox(container, stat, editableData) {
        ...
        const inputBox = ( (new InputBox(label.element, this.contextViewService, {
            ...
            ariaLabel: ( localize(11261, "Type file name. Press Enter to confirm or Escape to cancel.")),
            ...
            if (inputBox.isInputValid()) {
                ...
                if (message) {
                    inputBox.showMessage({
                        content: message.content,
                        formatContent: true,
                        type: message.severity === Severity$1.Info ? MessageType.INFO : message.severity === Severity$1.Warning ? MessageType.WARNING : MessageType.ERROR
                    });
                }
                else {
        ...
        const toDispose = [
            ...
            addDisposableListener(inputBox.inputElement, EventType.BLUR, async () => {
                while (true) {
                    ...
                    else if (isHTMLElement(ownerDocument.activeElement) && hasParentWithClass(ownerDocument.activeElement, 'context-view')) {
...
let FilesFilter = class FilesFilter {
    ...
    isVisible(stat, parentVisibility) {
        ...
        const globMatch = cached?.parsed(relative(stat.root.resource.path, stat.resource.path), stat.name, name => !!(stat.parent && stat.parent.getChild(name)));
...
let FileDragAndDrop = class FileDragAndDrop {
    ...
    async handleExplorerDrop(data, target, targetIndex, targetSector, originalEvent) {
        ...
        if (confirmDragAndDrop) {
            ...
            const confirmation = await this.dialogService.confirm({
                ...
                detail,
                checkbox: {
                    label: ( localize(11266, "Do not ask me again"))
                },
                primaryButton: ( localize(11267, "&&Move"))
            });
    ...
    async doHandleExplorerDropOnCopy(sources, target) {
        ...
        await this.explorerService.applyBulkEdit(resourceFileEdits, {
            ...
            undoLabel: ( localize(11268, "Copy {0}", labelSuffix)),
            progressLabel: ( localize(11269, "Copying {0}", labelSuffix)),
        });
    ...
    async doHandleExplorerDropOnMove(sources, target) {
        const resourceFileEdits = ( (sources.filter(source => !source.isReadonly).map(
            source => ( (new ResourceFileEdit(source.resource, joinPath(target.resource, source.name))))
        )));
        const labelSuffix = getFileOrFolderLabelSuffix(sources);
        const options = {
            confirmBeforeUndo: this.configurationService.getValue().explorer.confirmUndo === UndoConfirmLevel.Verbose,
            undoLabel: ( localize(11270, "Move {0}", labelSuffix)),
            progressLabel: ( localize(11271, "Moving {0}", labelSuffix))
        };
        try {
            ...
            if (error.fileOperationResult === FileOperationResult.FILE_MOVE_CONFLICT) {
                ...
                if (confirmed) {
                    await this.explorerService.applyBulkEdit(( (resourceFileEdits.map(
                        re => ( (new ResourceFileEdit(re.oldResource, re.newResource, { overwrite: true })))
                    ))), options);
                }
            }
            else {
    ...
    static getCompressedStatFromDragEvent(stat, dragEvent) {
        const target = getWindow(dragEvent).document.elementFromPoint(dragEvent.clientX, dragEvent.clientY);
...
function getFileOrFolderLabelSuffix(items) {
    ...
    if (items.every(i => i.isDirectory)) {
        return ( localize(11272, "{0} folders", items.length));
    }
    if (items.every(i => !i.isDirectory)) {
        return ( localize(11273, "{0} files", items.length));
    }

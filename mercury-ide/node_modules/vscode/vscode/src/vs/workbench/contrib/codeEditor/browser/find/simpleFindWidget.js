...
import { trackFocus, addDisposableListener, getComputedStyle } from '../../../../../base/browser/dom.js';
import { Widget } from '../../../../../base/browser/ui/widget.js';
import { Delayer } from '../../../../../base/common/async.js';
import { KeyCode } from '../../../../../base/common/keyCodes.js';
import { FindReplaceState } from '../../../../../editor/contrib/find/browser/findState.js';
import { SimpleButton, findPreviousMatchIcon, findNextMatchIcon, NLS_MATCHES_LOCATION, NLS_NO_RESULTS } from '../../../../../editor/contrib/find/browser/findWidget.js';
...
const NLS_FIND_INPUT_LABEL = ( localize(11449, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(11450, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(11451, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(11452, "Next Match"));
const NLS_CLOSE_BTN_LABEL = ( localize(11453, "Close"));
...
class SimpleFindWidget extends Widget {
    constructor(options, contextViewService, contextKeyService, hoverService, _keybindingService) {
        ...
        if (options?.enableSash) {
            ...
            this._register(resizeSash.onDidStart(() => {
                originalWidth = parseFloat(getComputedStyle(this._domNode).width);
            }));
            ...
            this._register(resizeSash.onDidReset(e => {
                const currentWidth = parseFloat(getComputedStyle(this._domNode).width);
    ...
    _announceSearchResults(label, searchString) {
        if (!searchString) {
            return ( localize(11454, "Enter search input"));
        }
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? ( localize(11455, "{0} found", label))
                : ( localize(11456, "{0} found for '{1}'", label, searchString));
        }
        return ( localize(11457, "{0} found for '{1}'", label, searchString));
    }
}
const simpleFindWidgetSashBorder = registerColor('simpleFindWidget.sashBorder', { dark: '#454545', light: '#C8C8C8', hcDark: '#6FC3DF', hcLight: '#0F4A85' }, ( localize(11458, 'Border color of the sash border.')));

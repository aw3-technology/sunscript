...
const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: ( localize(8944, 'Contributes terminal functionality.')),
        type: 'object',
        properties: {
            profiles: {
                type: 'array',
                description: ( localize(8945, "Defines additional terminal profiles that the user can create.")),
                items: {
                    type: 'object',
                    required: ['id', 'title'],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: ( localize(8946, "The ID of the terminal profile provider.")),
                            type: 'string',
                        },
                        title: {
                            description: ( localize(8947, "Title for this terminal profile.")),
                            type: 'string',
                        },
                        icon: {
                            ...
                            anyOf: [{
                                ...
                                },
                                {
                                    ...
                                    properties: {
                                        light: {
                                            description: ( localize(8949, 'Icon path when a light theme is used')),
                                            type: 'string'
                                        },
                                        dark: {
                                            description: ( localize(8950, 'Icon path when a dark theme is used')),
                                            type: 'string'
                                        }
                                    }
                                }]
...
export { DEFAULT_BOLD_FONT_WEIGHT, DEFAULT_COMMANDS_TO_SKIP_SHELL, DEFAULT_FONT_WEIGHT, DEFAULT_LETTER_SPACING, DEFAULT_LINE_HEIGHT, MAXIMUM_FONT_WEIGHT, MINIMUM_FONT_WEIGHT, MINIMUM_LETTER_SPACING, ProcessState, SUGGESTIONS_FONT_WEIGHT, TERMINAL_CONFIG_SECTION, TERMINAL_CREATION_COMMANDS, TERMINAL_VIEW_ID, TerminalCommandId, isTerminalProcessManager, terminalContributionsDescriptor };

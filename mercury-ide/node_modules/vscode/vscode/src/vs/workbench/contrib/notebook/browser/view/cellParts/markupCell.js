...
import { show, hide, append, $, safeInnerHtml, clearNode, reset } from '../../../../../../base/browser/dom.js';
...
let MarkupCell = class MarkupCell extends Disposable {
    ...
    viewUpdateCollapsed() {
        ...
        if (keybinding) {
            element.title = ( localize(11394, "Double-click to expand cell input ({0})", keybinding.getLabel()));
            expandIcon.title = ( localize(11395, "Expand Cell Input ({0})", keybinding.getLabel()));
        }
    ...
    viewUpdatePreview() {
        ...
        if (this.viewCell.renderedHtml) {
            if (this.accessibilityService.isScreenReaderOptimized()) {
                safeInnerHtml(this.markdownAccessibilityContainer, this.viewCell.renderedHtml);
            }
            else {

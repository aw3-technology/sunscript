...
import { editorSelectionBackground, editorFindMatch, editorFindMatchHighlight, overviewRulerFindMatchForeground, editorHoverHighlight } from '../../../../platform/theme/common/colors/editorColors.js';
...
import { PANEL_BORDER, EDITOR_DRAG_AND_DROP_BACKGROUND, TAB_ACTIVE_BORDER } from '../../../common/theme.js';
...
const TERMINAL_FOREGROUND_COLOR = registerColor('terminal.foreground', {
    ...
    hcDark: '#FFFFFF',
    hcLight: '#292929'
}, ( localize(9047, 'The foreground color of the terminal.')));
const TERMINAL_CURSOR_FOREGROUND_COLOR = registerColor('terminalCursor.foreground', null, ( localize(9048, 'The foreground color of the terminal cursor.')));
...
const TERMINAL_SELECTION_BACKGROUND_COLOR = registerColor('terminal.selectionBackground', editorSelectionBackground, ( localize(9050, 'The selection background color of the terminal.')));
...
const TERMINAL_COMMAND_DECORATION_DEFAULT_BACKGROUND_COLOR = registerColor('terminalCommandDecoration.defaultBackground', {
    ...
    hcDark: '#ffffff80',
    hcLight: '#00000040',
}, ( localize(9053, 'The default terminal command decoration background color.')));
...
const TERMINAL_OVERVIEW_RULER_CURSOR_FOREGROUND_COLOR = registerColor('terminalOverviewRuler.cursorForeground', '#A0A0A0CC', ( localize(9056, 'The overview ruler cursor color.')));
...
const TERMINAL_OVERVIEW_RULER_BORDER_COLOR = registerColor('terminalOverviewRuler.border', editorOverviewRulerBorder, ( localize(9058, 'The overview ruler left-side border color.')));
...
registerColor('terminal.hoverHighlightBackground', ( (transparent(editorHoverHighlight, 0.5))), ( localize(9060, 'Border color of the other search matches in the terminal.')));
const TERMINAL_FIND_MATCH_BORDER_COLOR = registerColor('terminal.findMatchBorder', {
    dark: null,
    light: null,
    hcDark: '#f38518',
    hcLight: '#0F4A85'
}, ( localize(9061, 'Border color of the current search match in the terminal.')));
...
const TERMINAL_FIND_MATCH_HIGHLIGHT_BORDER_COLOR = registerColor('terminal.findMatchHighlightBorder', {
    ...
    hcDark: '#f38518',
    hcLight: '#0F4A85'
}, ( localize(9060, 'Border color of the other search matches in the terminal.')));
const TERMINAL_OVERVIEW_RULER_FIND_MATCH_FOREGROUND_COLOR = registerColor('terminalOverviewRuler.findMatchForeground', {
    ...
    hcDark: '#f38518',
    hcLight: '#0F4A85'
}, ( localize(9063, 'Overview ruler marker color for find matches in the terminal.')));
...
registerColor('terminal.initialHintForeground', {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(9066, 'Foreground color of the terminal initial hint.')));
const ansiColorMap = {
    'terminal.ansiBlack': {
        index: 0,
        defaults: {
...
function registerColors() {
    for (const id in ansiColorMap) {
        ...
        ansiColorIdentifiers[entry.index] = registerColor(id, entry.defaults, ( localize(9067, '\'{0}\' ANSI color in the terminal.', colorName)));
    }
}

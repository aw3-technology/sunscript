...
import './media/notebook.css.js';
import './media/notebookCellChat.css.js';
import './media/notebookCellEditorHint.css.js';
import './media/notebookCellInsertToolbar.css.js';
import './media/notebookCellStatusBar.css.js';
import './media/notebookCellTitleToolbar.css.js';
import './media/notebookFocusIndicator.css.js';
import './media/notebookToolbar.css.js';
import './media/notebookDnd.css.js';
import './media/notebookFolding.css.js';
import './media/notebookCellOutput.css.js';
import './media/notebookEditorStickyScroll.css.js';
import './media/notebookKernelActionViewItem.css.js';
import './media/notebookOutline.css.js';
import { getWindow, append, createStyleSheet, addStandardDisposableGenericMouseDownListener, addStandardDisposableGenericMouseUpListener, trackFocus, scheduleAtNextAnimationFrame, runWhenWindowIdle, size, isAncestorOfActiveElement, $ as $$1 } from '../../../../base/browser/dom.js';
import { mainWindow } from '../../../../base/browser/window.js';
import { SequencerByKey, DeferredPromise } from '../../../../base/common/async.js';
import { Color, RGBA } from '../../../../base/common/color.js';
import { onUnexpectedError } from '../../../../base/common/errors.js';
import { Emitter, Event } from '../../../../base/common/event.js';
import { Disposable, DisposableStore, combinedDisposable, dispose, toDisposable } from '../../../../base/common/lifecycle.js';
...
import { focusBorder, errorForeground, foreground, contrastBorder } from '../../../../platform/theme/common/colors/baseColors.js';
...
let NotebookEditorWidget = class NotebookEditorWidget extends Disposable {
    ...
    _registerNotebookStickyScroll() {
        ...
        this._register(this._notebookStickyScroll.onDidChangeNotebookStickyScroll((sizeDelta) => {
            const d = localDisposableStore.add(scheduleAtNextAnimationFrame(getWindow(this.getDomNode()), () => {
                if (this.isDisposed) {
                    return;
                }
                if (this._dimension && this._isVisible) {
    ...
    async layoutNotebookCell(cell, height, context) {
        ...
        if (this._list.inRenderingTransaction) {
            const layoutDisposable = scheduleAtNextAnimationFrame(getWindow(this.getDomNode()), doLayout);
    ...
    cellIsHidden(cell) {
        ...
        return (
             (foldedRanges.some(range => modelIndex >= range.start && modelIndex <= range.end))
        );
    }
...
}, ( localize(8025, "The border color for notebook cells.")));
registerColor('notebook.focusedEditorBorder', focusBorder, ( localize(8026, "The color of the notebook cell editor border.")));
const cellStatusIconSuccess = registerColor('notebookStatusSuccessIcon.foreground', debugIconStartForeground, ( localize(8027, "The error icon color of notebook cells in the cell status bar.")));
...
const cellStatusIconError = registerColor('notebookStatusErrorIcon.foreground', errorForeground, ( localize(8029, "The error icon color of notebook cells in the cell status bar.")));
registerColor('notebookStatusRunningIcon.foreground', foreground, ( localize(8030, "The running icon color of notebook cells in the cell status bar.")));
registerColor('notebook.outputContainerBorderColor', null, ( localize(8031, "The border color of the notebook output container.")));
registerColor('notebook.outputContainerBackgroundColor', null, ( localize(8032, "The color of the notebook output container background.")));
registerColor('notebook.cellToolbarSeparator', {
    dark: ( (( (Color.fromHex('#808080'))).transparent(0.35))),
    light: ( (( (Color.fromHex('#808080'))).transparent(0.35))),
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(8033, "The color of the separator in the cell bottom toolbar")));
const focusedCellBackground = registerColor('notebook.focusedCellBackground', null, ( localize(8034, "The background color of a cell when the cell is focused.")));
registerColor('notebook.selectedCellBackground', {
    dark: listInactiveSelectionBackground,
    light: listInactiveSelectionBackground,
    hcDark: null,
    hcLight: null
}, ( localize(8035, "The background color of a cell when the cell is selected.")));
registerColor('notebook.cellHoverBackground', {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(8036, "The background color of a cell when the cell is hovered.")));
...
registerColor('notebook.inactiveSelectedCellBorder', {
    ...
    hcDark: focusBorder,
    hcLight: focusBorder
}, ( localize(8038, "The color of the cell's borders when multiple cells are selected.")));
...
}, ( localize(8041, "The background color of notebook cell status bar items.")));
registerColor('notebook.cellInsertionIndicator', focusBorder, ( localize(8042, "The color of the notebook cell insertion indicator.")));
registerColor('notebookScrollbarSlider.background', scrollbarSliderBackground, ( localize(8043, "Notebook scrollbar slider background color.")));
registerColor('notebookScrollbarSlider.hoverBackground', scrollbarSliderHoverBackground, ( localize(8044, "Notebook scrollbar slider background color when hovering.")));
registerColor('notebookScrollbarSlider.activeBackground', scrollbarSliderActiveBackground, ( localize(8045, "Notebook scrollbar slider background color when clicked on.")));
registerColor('notebook.symbolHighlightBackground', {
    dark: ( (Color.fromHex('#ffffff0b'))),
    light: ( (Color.fromHex('#fdff0033'))),
    hcDark: null,
    hcLight: null
}, ( localize(8046, "Background color of highlighted cell")));
registerColor('notebook.cellEditorBackground', {
    light: SIDE_BAR_BACKGROUND,
    dark: SIDE_BAR_BACKGROUND,
    hcDark: null,
    hcLight: null
}, ( localize(8047, "Cell editor background color.")));
const notebookEditorBackground = registerColor('notebook.editorBackground', {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(8048, "Notebook background color.")));

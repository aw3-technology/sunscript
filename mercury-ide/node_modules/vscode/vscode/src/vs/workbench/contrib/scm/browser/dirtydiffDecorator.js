...
import { registerEditorAction, registerEditorContribution, EditorAction, EditorContributionInstantiation } from '../../../../editor/browser/editorExtensions.js';
...
import { MenuRegistry, MenuId, MenuItemAction } from '../../../../platform/actions/common/actions.js';
import { IMenuService } from '../../../../platform/actions/common/actions.service.js';
import { createAndFillInActionBarActions } from '../../../../platform/actions/browser/menuEntryActionViewItem.js';
import { ScrollType } from '../../../../editor/common/editorCommon.js';
import { shouldSynchronizeModel, OverviewRulerLane, MinimapPosition } from '../../../../editor/common/model.js';
import { sortedDiff, equals } from '../../../../base/common/arrays.js';
import { ICodeEditorService } from '../../../../editor/browser/services/codeEditorService.js';
import { createStyleSheet, prepend, $ } from '../../../../base/browser/dom.js';
...
let DirtyDiffWidget = class DirtyDiffWidget extends PeekViewWidget {
    ...
    renderTitle(label) {
        ...
        if (!this.shouldUseDropdown()) {
            ...
            detail = this.model.changes.length > 1
                ? ( localize(6335, "{0} of {1} changes", providerIndex + 1, providerChanges.length))
                : ( localize(6336, "{0} of {1} change", providerIndex + 1, providerChanges.length));
    ...
    updateActions() {
        ...
        this._actionbarWidget.push(( (new Action('peekview.close', ( localize(6337, "Close")), ThemeIcon.asClassName(Codicon.close), true, () => this.dispose()))), { label: false, icon: true });
    }
    _fillHead(container) {
...
class ShowPreviousChangeAction extends EditorAction {
    constructor(outerEditor) {
        super({
            ...
            label: ( localize(6338, "Show Previous Change")),
...
class ShowNextChangeAction extends EditorAction {
    constructor(outerEditor) {
        super({
            ...
            label: ( localize(6339, "Show Next Change")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: 'editor.action.dirtydiff.next',
        title: ( localize(6340, "Next &&Change"))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: 'editor.action.dirtydiff.previous',
        title: ( localize(6341, "Previous &&Change"))
    },
    order: 2
});
class GotoPreviousChangeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(6342, "Go to Previous Change")),
...
class GotoNextChangeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(6343, "Go to Next Change")),
...
let DirtyDiffController = class DirtyDiffController extends Disposable {
    ...
    getChanges() {
        ...
        return (
             (model.changes.map(change => change.change))
        );
    }
    dispose() {
...
const editorGutterModifiedBackground = registerColor('editorGutter.modifiedBackground', {
    ...
    hcDark: '#1B81A8',
    hcLight: '#2090D3'
}, ( localize(6344, "Editor gutter background color for lines that are modified.")));
const editorGutterAddedBackground = registerColor('editorGutter.addedBackground', {
    dark: '#487E02',
    light: '#48985D',
    hcDark: '#487E02',
    hcLight: '#48985D'
}, ( localize(6345, "Editor gutter background color for lines that are added.")));
const editorGutterDeletedBackground = registerColor('editorGutter.deletedBackground', editorErrorForeground, ( localize(6346, "Editor gutter background color for lines that are deleted.")));
const minimapGutterModifiedBackground = registerColor('minimapGutter.modifiedBackground', editorGutterModifiedBackground, ( localize(6347, "Minimap gutter background color for lines that are modified.")));
const minimapGutterAddedBackground = registerColor('minimapGutter.addedBackground', editorGutterAddedBackground, ( localize(6348, "Minimap gutter background color for lines that are added.")));
const minimapGutterDeletedBackground = registerColor('minimapGutter.deletedBackground', editorGutterDeletedBackground, ( localize(6349, "Minimap gutter background color for lines that are deleted.")));
const overviewRulerModifiedForeground = registerColor('editorOverviewRuler.modifiedForeground', ( (transparent(editorGutterModifiedBackground, 0.6))), ( localize(6350, 'Overview ruler marker color for modified content.')));
const overviewRulerAddedForeground = registerColor('editorOverviewRuler.addedForeground', ( (transparent(editorGutterAddedBackground, 0.6))), ( localize(6351, 'Overview ruler marker color for added content.')));
const overviewRulerDeletedForeground = registerColor('editorOverviewRuler.deletedForeground', ( (transparent(editorGutterDeletedBackground, 0.6))), ( localize(6352, 'Overview ruler marker color for deleted content.')));
let DirtyDiffDecorator = DirtyDiffDecorator_1 = class DirtyDiffDecorator extends Disposable {
    ...
    constructor(editorModel, codeEditor, model, configurationService) {
        ...
        const diffAdded = ( localize(6353, 'Added lines'));
        ...
        const diffModified = ( localize(6354, 'Changed lines'));
        ...
        this.deletedOptions = DirtyDiffDecorator_1.createDecoration('dirty-diff-deleted', ( localize(6355, 'Removed lines')), {
            gutter,
...
export { DirtyDiffController, DirtyDiffModel, DirtyDiffWorkbenchController, GotoNextChangeAction, GotoPreviousChangeAction, ShowNextChangeAction, ShowPreviousChangeAction, getOriginalResource, isDirtyDiffVisible };

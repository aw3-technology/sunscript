...
import { SimpleButton, findPreviousMatchIcon, findNextMatchIcon, findSelectionIcon, findReplaceIcon, findReplaceAllIcon } from '../../../../../../editor/contrib/find/browser/findWidget.js';
...
const NLS_FIND_INPUT_LABEL = ( localize(11274, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(11275, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(11276, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(11277, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(11278, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(11279, "Close"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(11280, "Toggle Replace"));
const NLS_REPLACE_INPUT_LABEL = ( localize(11281, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(11282, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(11283, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(11284, "Replace All"));
registerIcon('find-filter', Codicon.filter, ( localize(11285, 'Icon for Find Filter in find widget.')));
const NOTEBOOK_FIND_FILTERS = ( localize(11286, "Find Filters"));
const NOTEBOOK_FIND_IN_MARKUP_INPUT = ( localize(11287, "Markdown Source"));
const NOTEBOOK_FIND_IN_MARKUP_PREVIEW = ( localize(11288, "Rendered Markdown"));
const NOTEBOOK_FIND_IN_CODE_INPUT = ( localize(11289, "Code Cell Source"));
const NOTEBOOK_FIND_IN_CODE_OUTPUT = ( localize(11290, "Code Cell Output"));

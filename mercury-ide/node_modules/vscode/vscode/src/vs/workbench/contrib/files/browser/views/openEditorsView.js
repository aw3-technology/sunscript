...
import { GroupsOrder, GroupOrientation } from '../../../../services/editor/common/editorGroupsService.js';
import { IEditorGroupsService } from '../../../../services/editor/common/editorGroupsService.service.js';
import { IConfigurationService } from '../../../../../platform/configuration/common/configuration.service.js';
import { IKeybindingService } from '../../../../../platform/keybinding/common/keybinding.service.js';
import { preventEditorClose, EditorResourceAccessor, SideBySideEditor, Verbosity, GroupModelChangeKind, EditorCloseMethod } from '../../../../common/editor.js';
...
import { OpenEditorsGroupContext, OpenEditorsDirtyEditorContext, OpenEditorsReadonlyEditorContext, OpenEditorsSelectedFileOrUntitledContext, SAVE_ALL_LABEL, SAVE_ALL_COMMAND_ID, NEW_UNTITLED_FILE_COMMAND_ID } from '../fileConstants.js';
...
import { NativeDragAndDropData, ElementsDragAndDropData, ListViewTargetSector } from '../../../../../base/browser/ui/list/listView.js';
...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static { this.NAME = ( localize2(5403, "Open Editors")); }
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = ( localize(5404, "{0} unsaved", dirty));
...
class OpenEditorsAccessibilityProvider {
    getWidgetAriaLabel() {
        return ( localize(5403, "Open Editors"));
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(5405, "Toggle Vertical/Horizontal Editor Layout")),
            f1: true,
            keybinding: {
                primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.Digit0,
                mac: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Digit0 },
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...( localize2(5406, "Flip Layout")),
            mnemonicTitle: ( localize(5407, "Flip &&Layout"))
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(5408, "New Untitled Text File")),
            f1: false,

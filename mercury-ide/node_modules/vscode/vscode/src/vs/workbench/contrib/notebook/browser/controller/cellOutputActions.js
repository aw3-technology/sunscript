...
import { NOTEBOOK_CELL_HAS_OUTPUTS, NOTEBOOK_CELL_HAS_HIDDEN_OUTPUTS } from '../../common/notebookContextKeys.js';
...
registerAction2(class ShowAllOutputsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(8164, "Show empty outputs")),
            menu: {
...
registerAction2(class CopyCellOutputAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(8165, "Copy Cell Output")),
            menu: {
                id: MenuId.NotebookOutputToolbar,
...
registerAction2(class OpenCellOutputInEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(8166, "Open Cell Output in Text Editor")),
            f1: false,
            category: NOTEBOOK_ACTIONS_CATEGORY,
            icon: copyIcon,
        });
...
export { COPY_OUTPUT_COMMAND_ID, OPEN_OUTPUT_COMMAND_ID };

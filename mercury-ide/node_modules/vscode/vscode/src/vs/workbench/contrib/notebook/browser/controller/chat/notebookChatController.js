...
import { disposableTimeout, createCancelablePromise, Queue, DeferredPromise } from '../../../../../../base/common/async.js';
...
import { CTX_NOTEBOOK_CHAT_HAS_ACTIVE_REQUEST, CTX_NOTEBOOK_CELL_CHAT_FOCUSED, CTX_NOTEBOOK_CHAT_USER_DID_EDIT, CTX_NOTEBOOK_CHAT_OUTER_FOCUS_POSITION, MENU_CELL_CHAT_WIDGET_STATUS } from './notebookChatContext.js';
...
let NotebookChatController = class NotebookChatController extends Disposable {
    ...
    constructor(_notebookEditor, _instantiationService, _contextKeyService, _editorWorkerService, _modelService, _languageService, _executionStateService, _storageService, _chatService) {
        ...
        NotebookChatController_1._promptHistory = JSON.parse(this._storageService.get(NotebookChatController_1._storageKey, StorageScope.PROFILE, '[]'));
        this._historyUpdate = (prompt) => {
            ...
            this._historyOffset = -1;
            this._historyCandidate = '';
            this._storageService.store(NotebookChatController_1._storageKey, JSON.stringify(NotebookChatController_1._promptHistory), StorageScope.PROFILE, StorageTarget.USER);
        };
    }
    ...
    _createWidget(index, input, autoSend, initEditingCell) {
        ...
        inlineChatWidget.placeholder = ( localize(10725, "Ask a question"));
        inlineChatWidget.updateInfo(( localize(10726, "AI-generated code may be incorrect")));

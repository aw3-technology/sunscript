...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    renderHeader(container) {
        ...
        const setHeader = () => {
            ...
            this.ariaHeaderLabel = ( localize(10057, "Explorer Section: {0}", this.name));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(10059, "New Folder...")),
            f1: false,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10060, "Refresh Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(10061, "Forces a refresh of the Explorer."))
            }
        });
    }
    async run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10062, "Collapse Folders in Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(10063, "Folds all folders in the Explorer."))
            }
        });
    }
    run(accessor) {

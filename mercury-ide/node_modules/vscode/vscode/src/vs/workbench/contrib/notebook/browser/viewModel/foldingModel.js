...
class FoldingModel {
    ...
    recompute() {
        ...
        this._foldingRangeDecorationIds = ( cellRanges.map(
            region => viewModel.setTrackedRange(null, region, TrackedRangeStickiness.GrowsOnlyWhenTypingAfter)
        )).filter(str => str !== null);
...
function* getMarkdownHeadersInCell(cellContent) {
    for (const token of marked_1.lexer(cellContent, { gfm: true })) {
...
export { FoldingModel, getMarkdownHeadersInCell };

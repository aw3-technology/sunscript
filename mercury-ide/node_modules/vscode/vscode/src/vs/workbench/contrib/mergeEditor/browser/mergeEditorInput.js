...
import { DEFAULT_EDITOR_ASSOCIATION, isResourceMergeEditorInput, EditorInputCapabilities } from '../../../common/editor.js';
...
let MergeEditorInput = class MergeEditorInput extends AbstractTextResourceEditorInput {
    ...
    getName() {
        return ( localize(7873, "Merging: {0}", super.getName()));
    }
    async resolve() {
        if (!this._inputModel) {

...
class ToggleMultiCursorModifierAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(730, 'Toggle Multi-Cursor Modifier')),
            f1: true
        });
    }
    run(accessor) {
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
    ...
    command: {
        id: ToggleMultiCursorModifierAction.ID,
        title: ( localize(731, "Switch to Alt+Click for Multi-Cursor"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
    ...
    command: {
        id: ToggleMultiCursorModifierAction.ID,
        title: (isMacintosh
            ? ( localize(732, "Switch to Cmd+Click for Multi-Cursor"))
            : ( localize(733, "Switch to Ctrl+Click for Multi-Cursor")))
    },

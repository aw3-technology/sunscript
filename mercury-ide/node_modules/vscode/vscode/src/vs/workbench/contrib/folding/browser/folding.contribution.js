...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(( localize(743, 'All')));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(( localize(744, "All active folding range providers")));
...
( (Registry.as(Extensions$1.Workbench))).registerWorkbenchContribution(DefaultFoldingRangeProvider, LifecyclePhase.Restored);

...
import { writeTransientState, readTransientState } from '../../../codeEditor/browser/toggleWordWrap.js';
import { InlineChatController } from '../../../inlineChat/browser/inlineChatController.js';
import { CellEditState, CellFocusMode, CursorAtLineBoundary, CursorAtBoundary } from '../notebookBrowser.js';
class BaseCellViewModel extends Disposable {
    ...
    revealRangeInCenter(range) {
        this._textEditor?.revealRangeInCenter(range, ScrollType.Immediate);
    }
    setSelection(range) {
    ...
    cellStartFind(value, options) {
        ...
        if (this.assertTextModelAttached()) {
            ...
            findRange.forEach(range => {
                cellMatches.push(...this.textBuffer.findMatchesLineByLine(( new Range(
                    range.startLineNumber,
                    range.startColumn,
                    range.endLineNumber,
                    range.endColumn
                )), searchData, options.regex || false, 1000));
            });
        }
        return cellMatches;
    }

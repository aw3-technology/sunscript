...
import { DataBreakpointSetType, CONTEXT_BREAKPOINT_ITEM_TYPE, CONTEXT_BREAKPOINT_ITEM_IS_DATA_BYTES, CONTEXT_BREAKPOINT_HAS_MODES, CONTEXT_BREAKPOINT_SUPPORTS_CONDITION, CONTEXT_BREAKPOINT_INPUT_FOCUSED, CONTEXT_BREAKPOINTS_FOCUSED, State, DEBUG_SCHEME, DebuggerString, BREAKPOINTS_VIEW_ID, CONTEXT_DEBUGGERS_AVAILABLE, CONTEXT_SET_DATA_BREAKPOINT_BYTES_SUPPORTED, CONTEXT_BREAKPOINTS_EXIST, CONTEXT_IN_DEBUG_MODE, BREAKPOINT_EDITOR_CONTRIBUTION_ID } from '../common/debug.js';
...
class ExceptionBreakpointsRenderer {
    ...
    renderElement(exceptionBreakpoint, index, data) {
        ...
        const exceptionBreakpointtitle = exceptionBreakpoint.verified ? (exceptionBreakpoint.description || data.name.textContent) : exceptionBreakpoint.message || ( localize(5855, "Unverified Exception Breakpoint"));
        ...
        data.toDispose.push(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.condition, ( localize(5856, "Expression condition: {0}", exceptionBreakpoint.condition))));
...
let FunctionBreakpointsRenderer = class FunctionBreakpointsRenderer {
    ...
    renderElement(functionBreakpoint, _index, data) {
        ...
        if (session && !session.capabilities.supportsFunctionBreakpoints) {
            data.toDispose.push(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.breakpoint, ( localize(5858, "Function breakpoints are not supported by this debug type"))));
        }
        const primary = [];
        this.breakpointSupportsCondition.set(!session || !!session.capabilities.supportsConditionalBreakpoints);
...
let DataBreakpointsRenderer = class DataBreakpointsRenderer {
    ...
    renderElement(dataBreakpoint, _index, data) {
        ...
        if (session && !session.capabilities.supportsDataBreakpoints) {
            data.toDispose.push(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.breakpoint, ( localize(5859, "Data breakpoints are not supported by this debug type"))));
        }
        if (dataBreakpoint.accessType) {
            const accessType = dataBreakpoint.accessType === 'read' ? ( localize(5860, "Read")) : dataBreakpoint.accessType === 'write' ? ( localize(5861, "Write")) : ( localize(5862, "Access"));
...
class FunctionBreakpointInputRenderer {
    ...
    renderElement(functionBreakpoint, _index, data) {
        ...
        let placeholder = ( localize(5863, "Function to break on"));
        let ariaLabel = ( localize(5864, "Type function breakpoint."));
        if (data.type === 'condition') {
            data.inputBox.value = functionBreakpoint.condition || '';
            placeholder = ( localize(5865, "Break when expression evaluates to true"));
            ariaLabel = ( localize(
                5866,
            ...
            placeholder = ( localize(5867, "Break when hit count is met"));
            ariaLabel = ( localize(
                5868,
...
class DataBreakpointInputRenderer {
    ...
    renderElement(dataBreakpoint, _index, data) {
        ...
        if (data.type === 'condition') {
            ...
            placeholder = ( localize(5869, "Break when expression evaluates to true"));
            ariaLabel = ( localize(
                5870,
            ...
            placeholder = ( localize(5871, "Break when hit count is met"));
            ariaLabel = ( localize(5872, "Type hit count. Data breakpoint will break when hit count is met."));
        }
        data.inputBox.setAriaLabel(ariaLabel);
        data.inputBox.setPlaceHolder(placeholder);
        setTimeout(() => {
...
class ExceptionBreakpointInputRenderer {
    ...
    renderTemplate(container) {
        ...
        const inputBox = ( (new InputBox(inputBoxContainer, this.contextViewService, {
            ariaLabel: ( localize(5873, "Type exception breakpoint condition")),
            inputBoxStyles: defaultInputBoxStyles
        })));
        const wrapUp = (success) => {
            this.view.breakpointInputFocused.set(false);
    ...
    renderElement(exceptionBreakpoint, _index, data) {
        const placeHolder = exceptionBreakpoint.conditionDescription || ( localize(5874, "Break when expression evaluates to true"));
        data.inputBox.setPlaceHolder(placeHolder);
...
class BreakpointsAccessibilityProvider {
    ...
    getWidgetAriaLabel() {
        return ( localize(5875, "Breakpoints"));
    }
    getRole() {
        return 'checkbox';
    }
...
function getBreakpointMessageAndIcon(state, breakpointsActivated, breakpoint$1, labelService, debugModel) {
    ...
    if (!breakpoint$1.enabled || !breakpointsActivated) {
        return {
            ...
            message: breakpoint$1.logMessage ? ( localize(5876, "Disabled Logpoint")) : ( localize(5877, "Disabled Breakpoint")),
        };
    }
    ...
    if (debugActive && !breakpoint$1.verified) {
        return {
            ...
            message: ('message' in breakpoint$1 && breakpoint$1.message) ? breakpoint$1.message : (breakpoint$1.logMessage ? ( localize(5878, "Unverified Logpoint")) : ( localize(5879, "Unverified Breakpoint"))),
    ...
    if (breakpoint$1 instanceof DataBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(5880, "Data breakpoints not supported by this debug type")),
            };
        }
        return {
            icon: breakpointIcon.regular,
            message: breakpoint$1.message || ( localize(5881, "Data Breakpoint"))
        };
    }
    if (breakpoint$1 instanceof FunctionBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(5882, "Function breakpoints not supported by this debug type")),
            };
        }
        const messages = [];
        messages.push(breakpoint$1.message || ( localize(5883, "Function Breakpoint")));
        if (breakpoint$1.condition) {
            messages.push(( localize(5884, "Condition: {0}", breakpoint$1.condition)));
        }
        if (breakpoint$1.hitCondition) {
            messages.push(( localize(5885, "Hit Count: {0}", breakpoint$1.hitCondition)));
        }
        return {
            icon: breakpointIcon.regular,
    ...
    if (breakpoint$1 instanceof InstructionBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(5886, "Instruction breakpoints not supported by this debug type")),
            };
        }
        const messages = [];
        if (breakpoint$1.message) {
            ...
            messages.push(( localize(5888, "Instruction breakpoint")));
        }
        if (breakpoint$1.hitCondition) {
            messages.push(( localize(5885, "Hit Count: {0}", breakpoint$1.hitCondition)));
        }
    ...
    if (breakpoint$1.logMessage || breakpoint$1.condition || breakpoint$1.hitCondition || triggeringBreakpoint) {
        ...
        if (!breakpoint$1.supported) {
            ...
            messages.push(( localize(5889, "Breakpoints of this type are not supported by the debugger")));
        }
        if (breakpoint$1.logMessage) {
            messages.push(( localize(5890, "Log Message: {0}", breakpoint$1.logMessage)));
        }
        if (breakpoint$1.condition) {
            messages.push(( localize(5884, "Condition: {0}", breakpoint$1.condition)));
        }
    ...
    const message = ('message' in breakpoint$1 && breakpoint$1.message) ? breakpoint$1.message : breakpoint$1 instanceof Breakpoint && labelService ? labelService.getUriLabel(breakpoint$1.uri) : ( localize(5892, "Breakpoint"));
    return {
        icon: breakpointIcon.regular,
        message
    };
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(5893, "Add Function Breakpoint")),
                mnemonicTitle: ( localize(5894, "&&Function Breakpoint...")),
            },
            f1: true,
...
class MemoryBreakpointAction extends Action2 {
    async run(accessor, existingBreakpoint) {
        ...
        if (info.accessTypes && info.accessTypes?.length > 1) {
            ...
            const selectedAccessType = await quickInput.pick(accessTypes, { placeHolder: ( localize(5896, "Select the access type to monitor")) });
    ...
    getRange(quickInput, defaultValue) {
        return (
             (new Promise(resolve => {
                ...
                input.prompt = ( localize(5897, "Enter a memory range in which to break"));
...
registerAction2(class extends MemoryBreakpointAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(5901, "Add Data Breakpoint at Address")),
                mnemonicTitle: ( localize(5902, "&&Data Breakpoint...")),
            },
            f1: true,
...
registerAction2(class extends MemoryBreakpointAction {
    constructor() {
        super({
            ...
            title: ( localize2(5903, "Edit Address...")),
            menu: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(5904, 'Toggle Activate Breakpoints')),
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(5905, "Remove Breakpoint")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(5906, "Remove All Breakpoints")),
                mnemonicTitle: ( localize(5907, "Remove &&All Breakpoints")),
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(5908, "Enable All Breakpoints")),
                mnemonicTitle: ( localize(5909, "&&Enable All Breakpoints")),
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(5910, "Disable All Breakpoints")),
                mnemonicTitle: ( localize(5911, "Disable A&&ll Breakpoints")),
            },
            f1: true,
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menu: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(5912, 'Reapply All Breakpoints')),
            f1: true,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(5913, "Edit Condition...")),
            icon: Codicon.edit,
    ...
    async runInView(accessor, view, breakpoint) {
        ...
        if (breakpoint instanceof Breakpoint) {
            ...
            const actions = [( (new Action('breakpoint.editCondition', ( localize(5913, "Edit Condition...")), undefined, true, async () => view.renderInputBox({ breakpoint, type: 'condition' })))),
                ( (new Action('breakpoint.editCondition', ( localize(5914, "Edit Hit Count...")), undefined, true, async () => view.renderInputBox({ breakpoint, type: 'hitCount' }))))];
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: BREAKPOINTS_VIEW_ID,
            title: ( localize(5915, "Edit Function Condition...")),
            menu: [{
                    id: MenuId.DebugBreakpointsContext,
                    group: 'navigation',
                    order: 10,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: BREAKPOINTS_VIEW_ID,
            title: ( localize(5914, "Edit Hit Count...")),
            precondition: CONTEXT_BREAKPOINT_SUPPORTS_CONDITION,
            menu: [{
                    id: MenuId.DebugBreakpointsContext,
                    group: 'navigation',
...
registerAction2(class extends ViewAction {
    ...
    async runInView(accessor, view, breakpoint) {
        ...
        ))), { placeHolder: ( localize(5917, "Select Breakpoint Mode")) });
        if (!picked) {
            return;
        }
        if (kind === 'source') {

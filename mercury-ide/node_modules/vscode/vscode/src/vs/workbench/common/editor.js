...
const DEFAULT_EDITOR_ASSOCIATION = {
    id: 'default',
    displayName: ( localize(449, "Text Editor")),
    providerDisplayName: ( localize(450, "Built-in"))
};
...
function createTooLargeFileError(group, input, options, message, preferencesService) {
    return createEditorOpenError(message, [
        toAction({
            id: 'workbench.action.openLargeFile', label: ( localize(451, "Open Anyway")), run: () => {
        ...
        toAction({
            id: 'workbench.action.configureEditorLargeFileConfirmation', label: ( localize(452, "Configure Limit")), run: () => {

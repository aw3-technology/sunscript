            ...
            'properties': {
                'security.allowedUNCHosts': {
                    ...
                    'items': {
                        'type': 'string',
                        'pattern': '^[^\\\\]+$',
                        'patternErrorMessage': ( localize(4511, 'UNC host names must not contain backslashes.'))
                    },
                    'default': [],
        ...
        const configurationNode = {
            ...
            'properties': {
                [CONFIG_NEW_WINDOW_PROFILE]: {
                    ...
                    'enumItemLabels': [...( (this.userDataProfilesService.profiles.map(p => ''))), ( localize(4514, "Active Window"))],

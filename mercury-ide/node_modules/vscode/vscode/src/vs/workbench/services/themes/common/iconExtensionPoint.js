...
const iconConfigurationExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(705, 'Contributes extension defined themable icons')),
        type: 'object',
        propertyNames: {
            pattern: iconIdPattern,
            description: ( localize(706, 'The identifier of the themable icon')),
        ...
        additionalProperties: {
            ...
            properties: {
                description: {
                    type: 'string',
                    description: ( localize(708, 'The description of the themable icon')),
                },
                default: {
                    anyOf: [
                        iconReferenceSchema,
                        {
                            ...
                            properties: {
                                fontPath: {
                                    description: ( localize(709, 'The path of the icon font that defines the icon.')),
                                    type: 'string'
                                },
                                fontCharacter: {
                                    description: ( localize(710, 'The character for the icon in the icon font.')),
                                    type: 'string'
                                }
                            },

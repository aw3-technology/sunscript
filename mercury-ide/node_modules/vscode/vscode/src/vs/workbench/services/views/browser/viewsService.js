...
import { IPaneCompositePartService } from '../../panecomposite/browser/panecomposite.service.js';
import { IEditorService } from '../../editor/common/editorService.service.js';
import { IViewsService } from '../common/viewsService.service.js';
let ViewsService = class ViewsService extends Disposable {
    ...
    getFocusedViewName() {
        ...
        const textEditorFocused = this.editorService.activeTextEditorControl?.hasTextFocus() ? ( localize(4146, "Text Editor")) : undefined;
                    ...
                    super({
                        ...
                        get title() {
                            ...
                            if (viewContainerLocation === ViewContainerLocation.Sidebar) {
                                return { value: ( localize(4147, "Show {0}", localizedTitle)), original: `Show ${originalTitle}` };
                            }
                            else {
                                return { value: ( localize(4148, "Toggle {0}", localizedTitle)), original: `Toggle ${originalTitle}` };
                            }
                        },
    ...
    registerFocusViewAction(viewDescriptor, category) {
        return registerAction2(class FocusViewAction extends Action2 {
            constructor() {
                const title = ( localize2(4149, "Focus on {0} View", viewDescriptor.name.value));
                super({

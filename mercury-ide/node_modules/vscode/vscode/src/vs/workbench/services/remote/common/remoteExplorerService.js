...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: ( localize(3557, 'The ID of a Get Started walkthrough to open.')),
            type: 'string'
        },
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(3558, 'Contributes help information for Remote')),
        type: 'object',
        properties: {
            'getStarted': {
            ...
            'feedback': {
                ...
                type: 'string',
                markdownDeprecationMessage: ( localize(3562, "Use {0} instead", '`reportIssue`'))
            },
            'reportIssue': {
                description: ( localize(
                    3563,

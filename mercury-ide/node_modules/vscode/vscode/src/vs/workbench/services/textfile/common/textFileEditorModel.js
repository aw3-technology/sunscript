...
import { TextFileResolveReason, TextFileEditorModelState, EncodingMode } from './textfiles.js';
import { ITextFileService } from './textfiles.service.js';
import { SaveSourceRegistry, SaveReason } from '../../../common/editor.js';
import { BaseTextEditorModel } from '../../../common/editor/textEditorModel.js';
import { IWorkingCopyBackupService } from '../../workingCopy/common/workingCopyBackup.service.js';
import { FileChangeType, FileOperationResult, ETAG_DISABLED, NotModifiedSinceFileOperationError } from '../../../../platform/files/common/files.js';
...
import { IWorkingCopyService } from '../../workingCopy/common/workingCopyService.service.js';
import { NO_TYPE_ID, WorkingCopyCapabilities } from '../../workingCopy/common/workingCopy.js';
...
import { ILanguageDetectionService } from '../../languageDetection/common/languageDetectionWorkerService.service.js';
...
let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel {
    ...
    static { this.TEXTFILE_SAVE_ENCODING_SOURCE = SaveSourceRegistry.registerSource('textFileEncoding.source', ( localize(5735, "File Encoding Changed"))); }
    ...
    async doSave(options) {
        ...
        return this.progressService.withProgress({
            title: ( localize(5736, "Saving '{0}'", this.name)),
    ...
    doSaveSequential(versionId, options, progress, saveCancellation) {
        return this.saveSequentializer.run(versionId, (async () => {
            ...
            this.inErrorMode = false;
            progress.report({ message: ( localize(5737, "Writing into file...")) });

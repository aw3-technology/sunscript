...
class EditorProgressIndicator extends Disposable {
    ...
    registerListeners() {
        this._register(this.group.onDidModelChange(e => {
            if (e.kind === GroupModelChangeKind.EDITOR_ACTIVE ||
...
( (function(ProgressIndicatorState) {
    ...
    ProgressIndicatorState.None = { type: Type.None };
    ProgressIndicatorState.Done = { type: Type.Done };
    ProgressIndicatorState.Infinite = { type: Type.Infinite };
    class While {

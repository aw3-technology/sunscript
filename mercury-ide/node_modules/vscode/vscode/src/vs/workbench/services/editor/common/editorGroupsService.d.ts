...
import { CloseDirection, IEditorPane, IActiveEditorChangeEvent, IEditorCloseEvent, IEditorWillMoveEvent, GroupIdentifier, IVisibleEditorPane, EditorsOrder, IFindEditorOptions, EditorInputWithOptions, IUntypedEditorInput, IMatchEditorOptions, IEditorPartOptions, IToolbarActions } from '../../../common/editor.js';
 ...
 */
interface IEditorPart extends IEditorGroupsContainer {
    /**
...
interface IAuxiliaryEditorPart extends IEditorPart {
    /**
...
interface IAuxiliaryEditorPartCreateEvent {
    readonly part: IAuxiliaryEditorPart;
    readonly instantiationService: IInstantiationService;
    readonly disposables: DisposableStore;
}
interface IEditorWorkingSet {
    readonly id: string;
    readonly name: string;
}
interface IEditorWorkingSetOptions {
    readonly preserveFocus?: boolean;
}
interface IEditorGroupContextKeyProvider<T extends ContextKeyValue> {
    /**
...
interface IActiveEditorActions {
...
export { type EditorGroupLayout, GroupDirection, type GroupLayoutArgument, GroupLocation, GroupOrientation, GroupsArrangement, GroupsOrder, type IActiveEditorActions, type IAuxiliaryEditorPart, type IAuxiliaryEditorPartCreateEvent, type ICloseAllEditorsOptions, type ICloseEditorOptions, type ICloseEditorsFilter, type IEditorDropTargetDelegate, type IEditorGroup, type IEditorGroupContextKeyProvider, type IEditorGroupsContainer, type IEditorPart, type IEditorReplacement, type IEditorSideGroup, type IEditorWorkingSet, type IEditorWorkingSetOptions, type IFindGroupScope, type IMergeGroupOptions, MergeGroupMode };

...
import { QueryType, resolvePatternsForProvider, DEFAULT_MAX_SEARCH_RESULTS, QueryGlobTester, hasSiblingPromiseFn } from './search.js';
    ...
    async searchInFolder(folderQuery, onResult, token) {
        ...
        const progress = {
            report: (result) => {
                ...
                if (relativePath$1) {
                    const included = queryTester.includedInQuery(relativePath$1, basename(relativePath$1), hasSibling);

...
declare enum WillShutdownJoinerOrder {
    /**
...
interface IWillShutdownEventDefaultJoiner extends IWillShutdownEventJoiner {
    readonly order?: WillShutdownJoinerOrder.Default;
}
interface IWillShutdownEventLastJoiner extends IWillShutdownEventJoiner {
...
export { type BeforeShutdownErrorEvent, type BeforeShutdownEvent, type IWillShutdownEventDefaultJoiner, type IWillShutdownEventJoiner, type IWillShutdownEventLastJoiner, LifecyclePhase, ShutdownReason, StartupKind, type WillShutdownEvent, WillShutdownJoinerOrder };

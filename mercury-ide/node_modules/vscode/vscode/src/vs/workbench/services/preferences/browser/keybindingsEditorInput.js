...
const KeybindingsEditorIcon = registerIcon('keybindings-editor-label-icon', Codicon.keyboard, ( localize(6229, 'Icon of the keybindings editor label.')));
let KeybindingsEditorInput = class KeybindingsEditorInput extends EditorInput {
    ...
    getName() {
        return ( localize(6230, "Keyboard Shortcuts"));
    }
    getIcon() {

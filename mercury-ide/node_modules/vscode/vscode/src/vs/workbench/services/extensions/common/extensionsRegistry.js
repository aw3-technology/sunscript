...
const schema = {
    properties: {
        engines: {
            type: 'object',
            description: ( localize(4417, "Engine compatibility.")),
            properties: {
                'vscode': {
                    type: 'string',
        ...
        publisher: {
            description: ( localize(4419, 'The publisher of the VS Code extension.')),
            type: 'string'
        },
        displayName: {
            description: ( localize(4420, 'The display name for the extension used in the VS Code gallery.')),
            type: 'string'
        },
        categories: {
            description: ( localize(
            ...
            items: {
                oneOf: [{
                    ...
                    },
                    {
                        type: 'string',
                        const: 'Languages',
                        deprecationMessage: ( localize(4422, 'Use \'Programming  Languages\' instead')),
                    }]
            }
        },
        galleryBanner: {
            type: 'object',
            description: ( localize(4423, 'Banner used in the VS Code marketplace.')),
            properties: {
                color: {
                    description: ( localize(4424, 'The banner color on the VS Code marketplace page header.')),
                    type: 'string'
                },
                theme: {
                    description: ( localize(4425, 'The color theme for the font used in the banner.')),
                    type: 'string',
                    enum: ['dark', 'light']
                }
            }
        ...
        preview: {
            type: 'boolean',
            description: ( localize(4427, 'Sets the extension to be flagged as a Preview in the Marketplace.')),
        },
        enableProposedApi: {
            type: 'boolean',
            deprecationMessage: ( localize(4428, 'Use `enabledApiProposals` instead.')),
        },
        enabledApiProposals: {
        ...
        activationEvents: {
            description: ( localize(4432, 'Activation events for the VS Code extension.')),
            type: 'array',
            items: {
                type: 'string',
                defaultSnippets: [
                    ...
                    },
                    {
                        ...
                        description: ( localize(4457, 'An activation event emitted when the issue reporter is opened.')),
                    },
                    {
        ...
        badges: {
            ...
            items: {
                ...
                properties: {
                    url: {
                        type: 'string',
                        description: ( localize(4462, 'Badge image URL.'))
                    },
                    href: {
                        type: 'string',
                        description: ( localize(4463, 'Badge link.'))
                    },
                    description: {
                        type: 'string',
                        description: ( localize(4464, 'Badge description.'))
                    }
                }
            }
        },
        ...
        capabilities: {
            description: ( localize(4475, "Declare the set of supported capabilities by the extension.")),
            type: 'object',
            properties: {
                virtualWorkspaces: {
                    description: ( localize(
                    ...
                    properties: {
                        supported: {
                            ...
                            enumDescriptions: [
                                ...
                                ( localize(4480, "The extension will not be enabled in virtual workspaces.")),
                            ]
                        },
                        description: {
                            type: 'string',
                    ...
                    properties: {
                        supported: {
                            ...
                            enumDescriptions: [
                                ...
                                ( localize(4486, "The extension will not be enabled in untrusted workspaces.")),
                            ]
                        },
        ...
        sponsor: {
            description: ( localize(4489, "Specify the location from where users can sponsor your extension.")),
            type: 'object',
            defaultSnippets: [
                { body: { url: '${1:https:}' } },
            ],
        ...
        icon: {
            type: 'string',
            description: ( localize(4493, 'The path to a 128x128 pixel icon.'))
        },
        l10n: {
            type: 'string',
            description: ( localize(
...
schemaRegistry.registerSchema(productSchemaId, {
    properties: {
        extensionEnabledApiProposals: {
            description: ( localize(4496, "API proposals that the respective extensions can freely use.")),
            type: 'object',
            properties: {},

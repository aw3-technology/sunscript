 ...
 */
declare const enum MinimapPosition {
    Inline = 1,
    Gutter = 2
}
/**
 ...
 */
declare const enum MinimapSectionHeaderStyle {
    Normal = 1,
    Underlined = 2
}

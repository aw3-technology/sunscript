...
import { EditOperationType, CursorState, EditOperationResult } from '../cursorCommon.js';
...
import { ModelInjectedTextChangedEvent, RawContentChangedType } from '../textModelEvents.js';
...
class CursorsController extends Disposable {
    ...
    _pushAutoClosedAction(autoClosedCharactersRanges, autoClosedEnclosingRanges) {
        ...
        this._autoClosedActions.push(( new AutoClosedAction(
            this._model,
    ...
    _executeEdit(callback, eventsCollector, source, cursorChangeReason = CursorChangeReason.NotSet) {
        ...
        if (this._emitStateChangedIfNecessary(eventsCollector, source, cursorChangeReason, oldState, false)) {
            this.revealAll(eventsCollector, source, false, VerticalRevealType.Simple, true, ScrollType.Smooth);
        }
    }

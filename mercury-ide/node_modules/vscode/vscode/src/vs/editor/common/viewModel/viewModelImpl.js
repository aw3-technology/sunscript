...
import { EditorOption, filterValidationDecorations, EDITOR_FONT_DEFAULTS } from '../config/editorOptions.js';
...
import { ViewModelEventDispatcher, ScrollChangedEvent, FocusChangedEvent, ModelContentChangedEvent, ModelTokensChangedEvent, ModelLanguageConfigurationChangedEvent, ModelLanguageChangedEvent, ModelOptionsChangedEvent, ModelDecorationsChangedEvent, HiddenAreasChangedEvent, ReadOnlyEditAttemptEvent, ViewZonesChangedEvent as ViewZonesChangedEvent$1 } from '../viewModelEventDispatcher.js';
...
class ViewModel extends Disposable {
    ...
    _registerModelEvents() {
            ...
            try {
                ...
                for (const change of changes) {
                    switch (change.changeType) {
                        case RawContentChangedType.LinesInserted: {
                        ...
                        case RawContentChangedType.LineChanged: {
                ...
                for (const change of changes) {
                    switch (change.changeType) {
                        case RawContentChangedType.Flush: {
                        ...
                        case RawContentChangedType.LinesDeleted: {
                        ...
                        case RawContentChangedType.EOLChanged: {
                            break;
                        }
                    }
                }
        ...
        this._register(this.model.onDidChangeTokens((e) => {
            ...
            for (let j = 0, lenJ = e.ranges.length; j < lenJ; j++) {
                ...
                const viewEndLineNumber = this.coordinatesConverter.convertModelPositionToViewPosition(( new Position(
    ...
    revealAllCursors(source, revealHorizontal, minimalReveal = false) {
        this._withViewEventsCollector(eventsCollector => this._cursor.revealAll(eventsCollector, source, minimalReveal, VerticalRevealType.Simple, revealHorizontal, ScrollType.Smooth));
    }
    revealPrimaryCursor(source, revealHorizontal, minimalReveal = false) {
        this._withViewEventsCollector(eventsCollector => this._cursor.revealPrimary(eventsCollector, source, minimalReveal, VerticalRevealType.Simple, revealHorizontal, ScrollType.Smooth));
    }
    revealTopMostCursor(source) {
        ...
        this._withViewEventsCollector(eventsCollector => eventsCollector.emitViewEvent(new ViewRevealRangeRequestEvent(source, false, viewRange, null, VerticalRevealType.Simple, true, ScrollType.Smooth)));
    }

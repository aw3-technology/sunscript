...
import { IndentGuide, IndentGuideHorizontalLine, HorizontalGuidesState } from '../textModelGuides.js';
...
class GuidesTextModelPart extends TextModelPart {
    ...
    getLinesBracketGuides(startLineNumber, endLineNumber, activePosition, options) {
        ...
        const bracketPairs = this.textModel.bracketPairs.getBracketPairsInRangeWithMinIndentation(( new Range(
            startLineNumber,
            1,
            endLineNumber,
        ...
        for (const pair of bracketPairs) {
            ...
            if (pair.range.startLineNumber === pair.range.endLineNumber) {
                if (horizontalGuides) {
                    result[pair.range.startLineNumber - startLineNumber].push(( new IndentGuide(
                        -1,
            ...
            for (let l = visibleGuideStartLineNumber; l < visibleGuideEndLineNumber + offset; l++) {
                result[l - startLineNumber].push(( new IndentGuide(
                    guideVisibleColumn,
                    -1,
                    className,
                    null,

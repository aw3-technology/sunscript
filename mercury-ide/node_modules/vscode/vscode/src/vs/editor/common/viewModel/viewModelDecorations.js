...
import { ViewModelDecoration, InlineDecoration, InlineDecorationType } from '../viewModel.js';
    ...
    _getOrCreateViewModelDecoration(modelDecoration) {
        ...
        if (!r) {
            ...
            if (options.isWholeLine) {
                ...
                const end = this._coordinatesConverter.convertModelPositionToViewPosition(( new Position(
        ...
        for (let i = 0, len = modelDecorations.length; i < len; i++) {
            ...
            if (decorationOptions.beforeContentClassName) {
                if (startLineNumber <= viewRange.startLineNumber && viewRange.startLineNumber <= endLineNumber) {
                    const inlineDecoration = ( new InlineDecoration(( new Range(
                        viewRange.startLineNumber,
                        viewRange.startColumn,
                        viewRange.startLineNumber,
                        viewRange.startColumn
                    )), decorationOptions.beforeContentClassName, InlineDecorationType.Before));
            ...
            if (decorationOptions.afterContentClassName) {
                if (startLineNumber <= viewRange.endLineNumber && viewRange.endLineNumber <= endLineNumber) {
                    const inlineDecoration = ( new InlineDecoration(( new Range(
                        ...
                        viewRange.endLineNumber,
                        viewRange.endColumn
                    )), decorationOptions.afterContentClassName, InlineDecorationType.After));
...
export { ViewModelDecorations, isModelDecorationInComment, isModelDecorationInString, isModelDecorationVisible };

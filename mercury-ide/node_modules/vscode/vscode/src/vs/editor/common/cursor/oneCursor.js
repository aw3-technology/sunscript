import { SingleCursorState, SelectionStartKind, CursorState } from '../cursorCommon.js';
import { Position } from '../core/position.js';
import { Range } from '../core/range.js';
import { Selection } from '../core/selection.js';
import { TrackedRangeStickiness, PositionAffinity } from '../model.js';
class Cursor {
    constructor(context) {
        this._selTrackedRange = null;
        this._trackSelection = true;
        this._setState(context, ( new SingleCursorState(( new Range(1, 1, 1, 1)), SelectionStartKind.Simple, 0, ( new Position(1, 1)), 0)), ( new SingleCursorState(( new Range(1, 1, 1, 1)), SelectionStartKind.Simple, 0, ( new Position(1, 1)), 0)));
    }
    dispose(context) {
    ...
    _setState(context, modelState, viewState) {
        ...
        if (!viewState) {
            const viewSelectionStart1 = context.coordinatesConverter.convertModelPositionToViewPosition(( new Position(
                modelState.selectionStart.startLineNumber,
                modelState.selectionStart.startColumn
            )));
            const viewSelectionStart2 = context.coordinatesConverter.convertModelPositionToViewPosition(( new Position(

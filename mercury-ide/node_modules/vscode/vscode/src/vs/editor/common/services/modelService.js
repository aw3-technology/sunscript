...
import { OS, OperatingSystem, isLinux, isMacintosh } from '../../../base/common/platform.js';
...
const DEFAULT_EOL = (isLinux || isMacintosh) ? DefaultEndOfLine.LF : DefaultEndOfLine.CRLF;
    ...
    _schemaShouldMaintainUndoRedoElements(resource) {
        return (
            (resource.scheme === Schemas.file
                ...
                || resource.scheme === Schemas.vscodeNotebookCell || resource.scheme === 'fake-fs')
        );
    }
...
class DefaultModelSHA1Computer {
    static { this.MAX_MODEL_SIZE = 10 * 1024 * 1024; }

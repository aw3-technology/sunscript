...
import { writeUInt32BE, writeUInt8, readUInt32BE, readUInt8 } from '../../../base/common/buffer.js';
...
class SingleModelEditStackData {
    ...
    serialize() {
        let necessarySize = ((+4
            ...
            + SingleModelEditStackData._writeSelectionsSize(this.afterCursorState) + 4)
        );
...
class MultiModelEditStackElement {
    get resources() {
        return (
             (this._editStackElementsArr.map(editStackElement => editStackElement.resource))
        );
    }
    ...
    matchesResource(resource) {
        ...
        return (
             (this._editStackElementsMap.has(key))
        );
    }
    setModel(model) {
...
class EditStack {
    ...
    _getOrCreateEditStackElement(beforeCursorState, group) {
        ...
        const newElement = ( (new SingleModelEditStackElement(( localize(4960, "Typing")), 'undoredo.textBufferEdit', this._model, beforeCursorState)));

...
import { MetadataConsts, StandardTokenType, FontStyle, ColorId } from '../../encodedTokenAttributes.js';
    ...
    match(languageId, token) {
        ...
        if (typeof result === 'undefined') {
            ...
            result = (rule.metadata
                | (standardToken << MetadataConsts.TOKEN_TYPE_OFFSET)) >>> 0;
...
class ThemeTrieElementRule {
    constructor(fontStyle, foreground, background) {
        ...
        this.metadata = ((this._fontStyle << MetadataConsts.FONT_STYLE_OFFSET)
            | (this._foreground << MetadataConsts.FOREGROUND_OFFSET)
            | (this._background << MetadataConsts.BACKGROUND_OFFSET)) >>> 0;
    }
    clone() {
...
export { ColorMap, ExternalThemeTrieElement, ParsedTokenThemeRule, ThemeTrieElement, ThemeTrieElementRule, TokenTheme, generateTokensCSSForColorMap, parseTokenTheme, strcmp, toStandardTokenType };

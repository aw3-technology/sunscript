...
import { getWindow, addDisposableListener, isHTMLElement, prepend, append, $ as $$1, getDomNodeZoomLevel } from '../../../../base/browser/dom.js';
import { IKeybindingService } from '../../../../platform/keybinding/common/keybinding.service.js';
import { KeyCode } from '../../../../base/common/keyCodes.js';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.service.js';
import { EDITOR_FONT_DEFAULTS } from '../../../common/config/editorOptions.js';
import { HoverPosition, HoverWidget as HoverWidget$1, getHoverAccessibleViewHint } from '../../../../base/browser/ui/hover/hoverWidget.js';
import { Widget } from '../../../../base/browser/ui/widget.js';
import { AnchorPosition } from '../../../../base/browser/ui/contextview/contextview.js';
import { IOpenerService } from '../../../../platform/opener/common/opener.service.js';
import { IInstantiationService } from '../../../../platform/instantiation/common/instantiation.js';
import { openLinkFromMarkdown, MarkdownRenderer } from '../../widget/markdownRenderer/browser/markdownRenderer.js';
...
let HoverWidget = class HoverWidget extends Widget {
    ...
    get anchor() { return this._hoverPosition === HoverPosition.BELOW ? AnchorPosition.BELOW : AnchorPosition.ABOVE; }
    ...
    constructor(options, _keybindingService, _configurationService, _openerService, _instantiationService, _accessibilityService) {
        ...
        if (hideOnHover && options.appearance?.showHoverHint) {
            ...
            infoElement.textContent = ( localize(4885, 'Hold {0} key to mouse over', isMacintosh ? 'Option' : 'Alt'));

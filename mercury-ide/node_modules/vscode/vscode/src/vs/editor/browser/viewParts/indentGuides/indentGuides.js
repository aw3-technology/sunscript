import './indentGuides.css.js';
import { DynamicViewOverlay } from '../../view/dynamicViewOverlay.js';
import { editorBracketHighlightingForeground1, editorBracketPairGuideBackground1, editorBracketPairGuideActiveBackground1, editorBracketHighlightingForeground2, editorBracketPairGuideBackground2, editorBracketPairGuideActiveBackground2, editorBracketHighlightingForeground3, editorBracketPairGuideBackground3, editorBracketPairGuideActiveBackground3, editorBracketHighlightingForeground4, editorBracketPairGuideBackground4, editorBracketPairGuideActiveBackground4, editorBracketHighlightingForeground5, editorBracketPairGuideBackground5, editorBracketPairGuideActiveBackground5, editorBracketHighlightingForeground6, editorBracketPairGuideBackground6, editorBracketPairGuideActiveBackground6, editorIndentGuide1, editorActiveIndentGuide1, editorIndentGuide2, editorActiveIndentGuide2, editorIndentGuide3, editorActiveIndentGuide3, editorIndentGuide4, editorActiveIndentGuide4, editorIndentGuide5, editorActiveIndentGuide5, editorIndentGuide6, editorActiveIndentGuide6 } from '../../../common/core/editorColorRegistry.js';
        ...
        for (let lineNumber = visibleStartLineNumber; lineNumber <= visibleEndLineNumber; lineNumber++) {
            ...
            for (let indentLvl = 1; indentLvl <= indentGuidesInLine; indentLvl++) {
                ...
                if (!peeked || peeked.visibleColumn !== indentGuide || peeked.horizontalLine) {
                    lineGuides.push(( new IndentGuide(
                        indentGuide,
                        -1,

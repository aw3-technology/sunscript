...
const UndoCommand = registerCommand(( (new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_do',
            title: ( localize(550, "&&Undo")),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localize(551, "Undo")),
            order: 1
        }]
}))));
...
const RedoCommand = registerCommand(( (new MultiCommand({
    ...
    menuOpts: [{
            menuId: MenuId.MenubarEditMenu,
            group: '1_do',
            title: ( localize(552, "&&Redo")),
            order: 2
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localize(553, "Redo")),
            order: 1
        }]
}))));
...
const SelectAllCommand = registerCommand(( (new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_basic',
            title: ( localize(554, "&&Select All")),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localize(555, "Select All")),
            order: 1
        }]
}))));

...
import { PartFingerprints, PartFingerprint } from '../view/viewPart.js';
...
class UnknownHitTestResult {
    constructor(hitTarget = null) {
        ...
        this.type = HitTestResultType.Unknown;
    }
}
class ContentHitTestResult {
    ...
    constructor(position, spanNode, injectedText) {
        ...
        this.type = HitTestResultType.Content;
    }
}
var HitTestResult;
        ...
        if (viewZoneWhitespace) {
            ...
            if (viewZoneWhitespace.afterLineNumber > 0) {
                positionBefore = ( new Position(
                    ...
                    context.viewModel.getLineMaxColumn(viewZoneWhitespace.afterLineNumber)
                ));
            }

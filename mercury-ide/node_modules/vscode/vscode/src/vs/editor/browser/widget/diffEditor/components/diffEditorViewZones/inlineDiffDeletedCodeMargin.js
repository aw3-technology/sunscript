                ...
                getActions: () => {
                    ...
                    actions.push(( (new Action('diff.clipboard.copyDeletedContent', isDeletion
                        ? (_diff.original.length > 1
                            ? ( localize(9956, "Copy deleted lines"))
                            : ( localize(9957, "Copy deleted line")))
                        : (_diff.original.length > 1
                            ? ( localize(9958, "Copy changed lines"))
                            : ( localize(9959, "Copy changed line"))), undefined, true, async () => {
                    ...
                    if (!readOnly) {
                        actions.push(( (new Action('diff.inline.revertChange', ( localize(9962, "Revert this change")), undefined, true, async () => {

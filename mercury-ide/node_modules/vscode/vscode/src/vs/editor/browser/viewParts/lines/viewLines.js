...
import { ViewLineOptions, ViewLine } from './viewLine.js';
...
class ViewLines extends ViewPart {
    ...
    _computeScrollTopToRevealRange(viewport, source, minimalReveal, range, selections, verticalType) {
        ...
        else if (verticalType === VerticalRevealType.NearTop || verticalType === VerticalRevealType.NearTopIfOutsideViewport) {
            if (verticalType === VerticalRevealType.NearTopIfOutsideViewport && viewportStartY <= boxStartY && boxEndY <= viewportEndY) {
        ...
        else if (verticalType === VerticalRevealType.Center || verticalType === VerticalRevealType.CenterIfOutsideViewport) {

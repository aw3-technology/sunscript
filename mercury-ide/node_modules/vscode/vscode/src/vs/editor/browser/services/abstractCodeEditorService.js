...
import { createStyleSheet, isInShadowDOM, createCSSRule, removeCSSRulesContainingSelector, asCSSUrl } from '../../../base/browser/dom.js';
...
let AbstractCodeEditorService = class AbstractCodeEditorService extends Disposable {
    ...
    _createGlobalStyleSheet() {
        return ( new GlobalStyleSheet(createStyleSheet()));
    }
...
class RefCountedStyleSheet {
    ...
    insertRule(selector, rule) {
        createCSSRule(selector, rule, this._styleSheet);
    }
...
export { AbstractCodeEditorService, GlobalStyleSheet, ModelTransientSettingWatcher, _CSS_MAP };

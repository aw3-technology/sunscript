...
import { DragAndDropObserver, getWindow, scheduleAtNextAnimationFrame, trackFocus } from '../../../../base/browser/dom.js';
...
import { EditorType, ScrollType, Handler } from '../../../common/editorCommon.js';
...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        this._configuration = this._register(this._createConfiguration(codeEditorWidgetOptions.isSimpleWidget || false, codeEditorWidgetOptions.contextMenuId ?? (codeEditorWidgetOptions.isSimpleWidget ? MenuId.SimpleEditorContext : MenuId.EditorContext), codeEditorWidgetOptions.isStandaloneEditor || false, options, accessibilityService));
    ...
    _createConfiguration(isSimpleWidget, contextMenuId, isStandaloneEditor, options, accessibilityService) {
        return (
    ...
    revealPosition(position, scrollType = ScrollType.Smooth) {
        this._revealPosition(position, VerticalRevealType.Simple, true, scrollType);
    }
    revealPositionInCenter(position, scrollType = ScrollType.Smooth) {
        this._revealPosition(position, VerticalRevealType.Center, true, scrollType);
    }
    revealPositionInCenterIfOutsideViewport(position, scrollType = ScrollType.Smooth) {
        this._revealPosition(position, VerticalRevealType.CenterIfOutsideViewport, true, scrollType);
    }
    revealPositionNearTop(position, scrollType = ScrollType.Smooth) {
        this._revealPosition(position, VerticalRevealType.NearTop, true, scrollType);
    }
    ...
    revealLines(startLineNumber, endLineNumber, scrollType = ScrollType.Smooth) {
        this._revealLines(startLineNumber, endLineNumber, VerticalRevealType.Simple, scrollType);
    }
    revealLinesInCenter(startLineNumber, endLineNumber, scrollType = ScrollType.Smooth) {
        this._revealLines(startLineNumber, endLineNumber, VerticalRevealType.Center, scrollType);
    }
    revealLinesInCenterIfOutsideViewport(startLineNumber, endLineNumber, scrollType = ScrollType.Smooth) {
        this._revealLines(startLineNumber, endLineNumber, VerticalRevealType.CenterIfOutsideViewport, scrollType);
    }
    revealLinesNearTop(startLineNumber, endLineNumber, scrollType = ScrollType.Smooth) {
        this._revealLines(startLineNumber, endLineNumber, VerticalRevealType.NearTop, scrollType);
    }
    ...
    revealRange(range, scrollType = ScrollType.Smooth, revealVerticalInCenter = false, revealHorizontal = true) {
        this._revealRange(range, revealVerticalInCenter ? VerticalRevealType.Center : VerticalRevealType.Simple, revealHorizontal, scrollType);
    }
    ...
    revealRangeInCenterIfOutsideViewport(range, scrollType = ScrollType.Smooth) {
        this._revealRange(range, VerticalRevealType.CenterIfOutsideViewport, true, scrollType);
    }
    ...
    revealRangeNearTopIfOutsideViewport(range, scrollType = ScrollType.Smooth) {
        this._revealRange(range, VerticalRevealType.NearTopIfOutsideViewport, true, scrollType);
    }
    ...
    setScrollLeft(newScrollLeft, scrollType = ScrollType.Immediate) {
        if (!this._modelData) {
            return;
        }
    ...
    setScrollTop(newScrollTop, scrollType = ScrollType.Immediate) {
        if (!this._modelData) {
            return;
        }
    ...
    setScrollPosition(position, scrollType = ScrollType.Immediate) {
        if (!this._modelData) {
            return;
        }
    ...
    _attachModel(model) {
        ...
        const viewModel = ( (new ViewModel(
            ...
            this._configuration,
            model,
            DOMLineBreaksComputerFactory.create(getWindow(this._domElement)),
            MonospaceLineBreaksComputerFactory.create(this._configuration.options),
            (callback) => scheduleAtNextAnimationFrame(getWindow(this._domElement), callback),
                ...
                case OutgoingViewModelEventKind.CursorStateChanged: {
                    if (e.reachedMaxCursorCount) {
                        ...
                        this._notificationService.prompt(Severity$1.Warning, message, [
                            ...
                            {
                                label: ( localize(1336, 'Increase Multi Cursor Limit')),
                                run: () => {
        ...
        if (this.isSimpleWidget) {
            ...
            commandDelegate = {
                paste: (text, pasteOnNewLine, multicursorText, mode) => {
                    ...
                    this._commandService.executeCommand(Handler.Paste, payload);
                },
                type: (text) => {
                    const payload = { text };
                    this._commandService.executeCommand(Handler.Type, payload);
                },
                compositionType: (text, replacePrevCharCnt, replaceNextCharCnt, positionDelta) => {
                    if (replaceNextCharCnt || positionDelta) {
                        const payload = { text, replacePrevCharCnt, replaceNextCharCnt, positionDelta };
                        this._commandService.executeCommand(Handler.CompositionType, payload);
                    }
                    else {
                        const payload = { text, replaceCharCnt: replacePrevCharCnt };
                        this._commandService.executeCommand(Handler.ReplacePreviousChar, payload);
                    }
                },
                startComposition: () => {
                    this._commandService.executeCommand(Handler.CompositionStart, {});
                },
                endComposition: () => {
                    this._commandService.executeCommand(Handler.CompositionEnd, {});
                },
                cut: () => {
                    this._commandService.executeCommand(Handler.Cut, {});
                }
            };
        }
    ...
    showDropIndicatorAt(position) {
        ...
        this.revealPosition(position, ScrollType.Immediate);
    }
    removeDropIndicator() {

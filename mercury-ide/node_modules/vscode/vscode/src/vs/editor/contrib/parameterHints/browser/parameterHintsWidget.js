...
const $ = $$1;
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, ( localize(5198, 'Icon for show next parameter hint.')));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, ( localize(5199, 'Icon for show previous parameter hint.')));
let ParameterHintsWidget = class ParameterHintsWidget extends Disposable {
    ...
    createParameterHintDOMNodes() {
        ...
        updateFont();
        this._register(Event.chain(this.editor.onDidChangeConfiguration.bind(this.editor), $ => $.filter(e => e.hasChanged(EditorOption.fontInfo)))(updateFont));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                alert(( localize(5200, "{0}, hint", labelToAnnounce)));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, ( localize(5201, 'Foreground color of the active item in the parameter hint.')));

...
class ToggleTabFocusModeAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1570, 'Toggle Tab Key Moves Focus')),
    ...
    run() {
        ...
        if (newValue) {
            alert(( localize(1572, "Pressing Tab will now move focus to the next focusable element")));
        }
        else {
            alert(( localize(1573, "Pressing Tab will now insert the tab character")));
        }
    }
}

...
import { $, addDisposableListener, getDomNodePagePosition, EventType } from '../../../../base/browser/dom.js';
...
let PostEditWidget = class PostEditWidget extends Disposable {
    ...
    showSelector() {
        this._contextMenuService.showContextMenu({
            ...
            getActions: () => {
                return (
                     (this.edits.allEdits.map((edit, i) => toAction({
                        id: '',
                        label: edit.title,
...
let PostEditWidgetManager = class PostEditWidgetManager extends Disposable {
    ...
    async applyEditAndShowIfNeeded(ranges, edits, canShowWidget, resolve, token) {
        ...
        try {
            ...
            return handleError(e, ( localize(9845, "Error resolving edit '{0}':\n{1}", edit.title, toErrorMessage(e))));
        }
        ...
        try {
            ...
            return handleError(e, ( localize(9846, "Error applying edit '{0}':\n{1}", edit.title, toErrorMessage(e))));
        }
        finally {

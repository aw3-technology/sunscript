...
const uncategorizedCodeActionGroup = ( (Object.freeze({ kind: HierarchicalKind.Empty, title: ( localize(9847, 'More Actions...')) })));
const codeActionGroups = ( (Object.freeze([
    { kind: CodeActionKind.QuickFix, title: ( localize(9848, 'Quick Fix')) },
    { kind: CodeActionKind.RefactorExtract, title: ( localize(9849, 'Extract')), icon: Codicon.wrench },
    { kind: CodeActionKind.RefactorInline, title: ( localize(9850, 'Inline')), icon: Codicon.wrench },
    { kind: CodeActionKind.RefactorRewrite, title: ( localize(9851, 'Rewrite')), icon: Codicon.wrench },
    { kind: CodeActionKind.RefactorMove, title: ( localize(9852, 'Move')), icon: Codicon.wrench },
    { kind: CodeActionKind.SurroundWith, title: ( localize(9853, 'Surround With')), icon: Codicon.surroundWith },
    { kind: CodeActionKind.Source, title: ( localize(9854, 'Source Action')), icon: Codicon.symbolFile },

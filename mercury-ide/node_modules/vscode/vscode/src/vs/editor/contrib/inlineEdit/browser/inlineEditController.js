...
import { observableFromEvent, observableSignalFromEvent, constObservable } from '../../../../base/common/observableInternal/utils.js';
...
let InlineEditController = class InlineEditController extends Disposable {
    ...
    constructor(editor, instantiationService, contextKeyService, languageFeaturesService, _commandService, _configurationService, _diffProviderFactoryService, _modelService) {
        ...
        this._enabled = observableFromEvent(this, this.editor.onDidChangeConfiguration, () => this.editor.getOption(EditorOption.inlineEdit).enabled);
        this._fontFamily = observableFromEvent(this, this.editor.onDidChangeConfiguration, () => this.editor.getOption(EditorOption.inlineEdit).fontFamily);
...
.monaco-editor .inline-edit {
	font-family: ${fontFamily};
        ...
        this._register(( new InlineEditSideBySideWidget(
            this.editor,
            this._currentEdit,

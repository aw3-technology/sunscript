...
import './inlineCompletionsHintsWidget.css.js';
...
const inlineSuggestionHintsNextIcon = registerIcon('inline-suggestion-hints-next', Codicon.chevronRight, ( localize(9866, 'Icon for show next parameter hint.')));
const inlineSuggestionHintsPreviousIcon = registerIcon('inline-suggestion-hints-previous', Codicon.chevronLeft, ( localize(9867, 'Icon for show previous parameter hint.')));
let InlineSuggestionHintsContentWidget = class InlineSuggestionHintsContentWidget extends Disposable {
    ...
    createCommandAction(commandId, label, iconClassName) {
        ...
        let tooltip = label;
        if (kb) {
            tooltip = ( localize(9868, '{0} ({1})', label, kb.getLabel()));
        }
    ...
    constructor(editor, withBorder, _position, _currentSuggestionIdx, _suggestionCount, _extraCommands, _commandService, instantiationService, keybindingService, _contextKeyService, _menuService) {
        ...
        this.previousAction = this.createCommandAction(showPreviousInlineSuggestionActionId, ( localize(9869, 'Previous')), ThemeIcon.asClassName(inlineSuggestionHintsPreviousIcon));
        this.availableSuggestionCountAction = ( (new Action('inlineSuggestionHints.availableSuggestionCount', '', undefined, false)));
        this.nextAction = this.createCommandAction(showNextInlineSuggestionActionId, ( localize(9870, 'Next')), ThemeIcon.asClassName(inlineSuggestionHintsNextIcon));

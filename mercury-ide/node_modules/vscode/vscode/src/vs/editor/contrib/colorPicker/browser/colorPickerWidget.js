...
import { getWindow, $ as $$1, append, addDisposableListener, EventType, getDomNodePagePosition } from '../../../../base/browser/dom.js';
...
class ColorPickerHeader extends Disposable {
    constructor(container, model, themeService, showingStandaloneColorPicker = false) {
        ...
        const tooltip = ( localize(9862, "Click to toggle color options (rgb/hsl/hex)"));
...
class CloseButton extends Disposable {
    constructor(container) {
        ...
        const closeButton = append(innerDiv, $('.button' + ThemeIcon.asCSSSelector(registerIcon('color-picker-close', Codicon.close, ( localize(9863, 'Icon to close the color picker'))))));
...
export { ColorPickerBody, ColorPickerHeader, ColorPickerWidget, InsertButton };

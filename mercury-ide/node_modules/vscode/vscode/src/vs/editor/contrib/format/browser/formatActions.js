...
import { getOnTypeFormattingEdits, formatDocumentRangesWithSelectedProvider, FormattingMode, formatDocumentWithSelectedProvider } from './format.js';
...
class FormatDocumentAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1407, "Format Document")),
    ...
    async run(accessor, editor) {
        if (editor.hasModel()) {
            ...
            await progressService.showWhile(instaService.invokeFunction(formatDocumentWithSelectedProvider, editor, FormattingMode.Explicit, Progress.None, CancellationToken.None, true), 250);
        }
    }
}
class FormatSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1408, "Format Selection")),
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyF),
                weight: KeybindingWeight.EditorContrib
            },
            contextMenuOpts: {
    ...
    async run(accessor, editor) {
        ...
        const progressService = accessor.get(IEditorProgressService);
        await progressService.showWhile(instaService.invokeFunction(formatDocumentRangesWithSelectedProvider, editor, ranges, FormattingMode.Explicit, Progress.None, CancellationToken.None, true), 250);
    }
}

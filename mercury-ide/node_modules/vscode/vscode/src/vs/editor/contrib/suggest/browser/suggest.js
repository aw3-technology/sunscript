...
import { CompletionTriggerKind, CompletionItemKind, CompletionItemTag, CompletionItemInsertTextRule } from '../../../common/languages.js';
...
const Context = {
    ...
    HasFocusedSuggestion: ( (new RawContextKey('suggestWidgetHasFocusedSuggestion', false, ( localize(5209, "Whether any suggestion is focused"))))),
    DetailsVisible: ( (new RawContextKey('suggestWidgetDetailsVisible', false, ( localize(5210, "Whether suggestion details are visible"))))),
    MultipleSuggestions: ( (new RawContextKey('suggestWidgetMultipleSuggestions', false, ( localize(5211, "Whether there are multiple suggestions to pick from"))))),
    ...
    AcceptSuggestionsOnEnter: ( (new RawContextKey('acceptSuggestionOnEnter', true, ( localize(5213, "Whether suggestions are inserted when pressing Enter"))))),
    HasInsertAndReplaceRange: ( (new RawContextKey('suggestionHasInsertAndReplaceRange', false, ( localize(5214, "Whether the current suggestion has insert and replace behaviour"))))),
    InsertMode: ( (new RawContextKey(
        'suggestionInsertMode',
        undefined,
        { type: 'string', description: ( localize(5215, "Whether the default behaviour is to insert or replace")) }
    ))),
    CanResolve: ( (new RawContextKey('suggestionCanResolve', false, ( localize(5216, "Whether the current suggestion supports to resolve further details"))))),
};

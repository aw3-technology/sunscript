...
import { EditorAction, registerEditorContribution, registerEditorAction, EditorContributionInstantiation } from '../../../browser/editorExtensions.js';
import { ShiftCommand } from '../../../common/commands/shiftCommand.js';
import { EditorOption, EditorAutoIndentStrategy } from '../../../common/config/editorOptions.js';
...
import { getSpaceCnt, generateIndent } from '../common/indentUtils.js';
...
class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1453, "Convert Indentation to Spaces")),
            alias: 'Convert Indentation to Spaces',
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1454, "Convert the tab indentation to spaces.")),
            }
        });
    }
    run(accessor, editor) {
...
class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1455, "Convert Indentation to Tabs")),
            alias: 'Convert Indentation to Tabs',
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1456, "Convert the spaces indentation to tabs.")),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = ( ([1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? ( localize(1457, "Configured Tab Size"))
                : n === creationOpts.tabSize
                    ? ( localize(1458, "Default Tab Size"))
                    : n === modelOpts.tabSize
                        ? ( localize(1459, "Current Tab Size"))
                        : undefined)
        }))));
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: ( localize(1460, "Select Tab Size for Current File")), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: ( localize(1461, "Indent Using Tabs")),
            alias: 'Indent Using Tabs',
            precondition: undefined,
            metadata: {
                description: ( localize2(1462, "Use indentation with tabs.")),
            }
        });
    }
}
class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: ( localize(1463, "Indent Using Spaces")),
            alias: 'Indent Using Spaces',
            precondition: undefined,
            metadata: {
                description: ( localize2(1464, "Use indentation with spaces.")),
            }
        });
    }
}
class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: ( localize(1465, "Change Tab Display Size")),
            alias: 'Change Tab Display Size',
            precondition: undefined,
            metadata: {
                description: ( localize2(1466, "Change the space size equivalent of the tab.")),
            }
        });
    }
}
class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1467, "Detect Indentation from Content")),
            alias: 'Detect Indentation from Content',
            precondition: undefined,
            metadata: {
                description: ( localize2(1468, "Detect the indentation from content.")),
            }
        });
    }
    run(accessor, editor) {
...
class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1469, "Reindent Lines")),
            alias: 'Reindent Lines',
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1470, "Reindent the lines of the editor.")),
            }
        });
    }
    run(accessor, editor) {
...
class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1471, "Reindent Selected Lines")),
            alias: 'Reindent Selected Lines',
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1472, "Reindent the selected lines of the editor.")),
            }
        });
    }
    run(accessor, editor) {
...
export { AutoIndentOnPaste, AutoIndentOnPasteCommand, ChangeIndentationSizeAction, ChangeTabDisplaySize, DetectIndentation, IndentUsingSpaces, IndentUsingTabs, IndentationToSpacesAction, IndentationToSpacesCommand, IndentationToTabsAction, IndentationToTabsCommand, ReindentLinesAction, ReindentSelectedLinesAction };

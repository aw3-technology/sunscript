...
var SuggestWidget_1;
registerColor('editorSuggestWidget.background', editorWidgetBackground, ( localize(5228, 'Background color of the suggest widget.')));
registerColor('editorSuggestWidget.border', editorWidgetBorder, ( localize(5229, 'Border color of the suggest widget.')));
const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, ( localize(5230, 'Foreground color of the suggest widget.')));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, ( localize(5231, 'Foreground color of the selected entry in the suggest widget.')));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, ( localize(5232, 'Icon foreground color of the selected entry in the suggest widget.')));
const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, ( localize(5233, 'Background color of the selected entry in the suggest widget.')));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, ( localize(5234, 'Color of the match highlights in the suggest widget.')));
...
registerColor('editorSuggestWidgetStatus.foreground', ( (transparent(editorSuggestWidgetForeground, .5))), ( localize(5236, 'Foreground color of the suggest widget status.')));
var State;
( ((function(State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = ( localize(5237, "Loading...")); }
    static { this.NO_SUGGESTIONS_MESSAGE = ( localize(5238, "No suggestions.")); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = ( (new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                getRole: () => 'option',
                getWidgetAriaLabel: () => ( localize(5239, "Suggest")),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = ( localize(5240, '{0} {1}, {2}', label, detail, description));
                        }
                        else if (detail) {
                            label = ( localize(5241, '{0} {1}', label, detail));
                        }
                        else if (description) {
                            label = ( localize(5242, '{0}, {1}', label, description));
                        }
                    }
                    ...
                    return ( localize(5243, "{0}, docs: {1}", label, docs));
                },
            }
        })));

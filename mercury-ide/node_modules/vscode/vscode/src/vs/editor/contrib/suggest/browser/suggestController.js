...
import { EditorAction, registerEditorContribution, registerEditorAction, registerEditorCommand, EditorContributionInstantiation, EditorCommand } from '../../../browser/editorExtensions.js';
...
import { Context, suggestWidgetStatusbarMenu } from './suggest.js';
import { SuggestAlternatives } from './suggestAlternatives.js';
import { CommitCharacterController } from './suggestCommitCharacters.js';
import { SuggestModel, State } from './suggestModel.js';
    ...
    constructor(editor, _memoryService, _commandService, _contextKeyService, _instantiationService, _logService, _telemetryService) {
        ...
        this.widget = this._toDispose.add(( (new WindowIdleValue(getWindow(editor.getDomNode()), () => {
            ...
            const commitCharacterController = ( (new CommitCharacterController(
                ...
                widget,
                this.model,
                item => this._insertSuggestion(item, InsertFlags.NoAfterUndoStop)
            )));
            ...
            this._toDispose.add(widget.onDidFocus(({ item }) => {
                ...
                let value = true;
                if (this.editor.getOption(EditorOption.acceptSuggestionOnEnter) === 'smart'
            ...
            this._toDispose.add(widget.onDetailsKeyDown(e => {
                if (e.toKeyCodeChord().equals(( (new KeyCodeChord(true, false, false, false, KeyCode.KeyC)))) ||
                    (isMacintosh && e.toKeyCodeChord().equals(( (new KeyCodeChord(false, false, false, true, KeyCode.KeyC)))))) {
                    e.stopPropagation();
                    return;
                }
        ...
        if (flags & InsertFlags.KeepAlternativeSuggestions) {
            this._alternatives.value.set(event, next => {
                ...
                while (model.canUndo()) {
                    ...
                    this._insertSuggestion(next, InsertFlags.NoBeforeUndoStop | InsertFlags.NoAfterUndoStop | (flags & InsertFlags.AlternativeOverwriteConfig ? InsertFlags.AlternativeOverwriteConfig : 0));
                    break;
                }
            });
        }
...
class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1563, "Trigger Suggest")),
            ...
            kbOpts: {
                ...
                secondary: [KeyMod$1.CtrlCmd | KeyCode.KeyI],
                mac: { primary: KeyMod$1.WinCtrl | KeyCode.Space, secondary: [KeyMod$1.Alt | KeyCode.Escape, KeyMod$1.CtrlCmd | KeyCode.KeyI] },
...
registerEditorCommand(( (new SuggestCommand({
    ...
    kbOpts: [{
            ...
            kbExpr: ( (ContextKeyExpr.and(
                ...
                Context.AcceptSuggestionsOnEnter,
    ...
    menuOpts: [{
            ...
            when: ( (ContextKeyExpr.and(
                Context.HasInsertAndReplaceRange,
                 (Context.InsertMode.isEqualTo('insert'))
            )))
        }, {
            menuId: suggestWidgetStatusbarMenu,
            title: ( localize(1565, "Replace")),
            group: 'left',
            order: 1,
            when: ( (ContextKeyExpr.and(
                Context.HasInsertAndReplaceRange,
                 (Context.InsertMode.isEqualTo('replace'))
            )))
        }]
}))));
registerEditorCommand(( (new SuggestCommand({
    ...
    precondition: ( (ContextKeyExpr.and(
        Context.Visible,
        EditorContextKeys.textInputFocus,
        Context.HasFocusedSuggestion
    ))),
    kbOpts: {
        weight: weight,
        kbExpr: EditorContextKeys.textInputFocus,
        primary: KeyMod$1.Shift | KeyCode.Enter,
        secondary: [KeyMod$1.Shift | KeyCode.Tab],
    },
    handler(x) {
...
registerEditorCommand(( (new SuggestCommand({
    ...
    precondition: ( (ContextKeyExpr.and(Context.Visible,  (ContextKeyExpr.or(
        Context.MultipleSuggestions,
         (Context.HasFocusedSuggestion.negate())
    ))))),
...
registerEditorCommand(( (new SuggestCommand({
    ...
    kbOpts: {
        ...
        secondary: [KeyMod$1.CtrlCmd | KeyCode.PageDown]
    }
}))));
registerEditorCommand(( (new SuggestCommand({
...
registerEditorCommand(( (new SuggestCommand({
    ...
    kbOpts: {
        ...
        secondary: [KeyMod$1.CtrlCmd | KeyCode.PageUp]
    }
}))));
registerEditorCommand(( (new SuggestCommand({
...
registerEditorCommand(( (new SuggestCommand({
    ...
    kbOpts: {
        ...
        primary: KeyMod$1.CtrlCmd | KeyCode.Space,
        secondary: [KeyMod$1.CtrlCmd | KeyCode.KeyI],
        mac: { primary: KeyMod$1.WinCtrl | KeyCode.Space, secondary: [KeyMod$1.CtrlCmd | KeyCode.KeyI] }
    },
}))));
registerEditorCommand(( (new SuggestCommand({
...
registerEditorCommand(( (new SuggestCommand({
    ...
    kbOpts: {
        weight: weight,
        kbExpr: EditorContextKeys.textInputFocus,
        primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Space,
        mac: { primary: KeyMod$1.WinCtrl | KeyMod$1.Alt | KeyCode.Space }
    }
}))));
registerEditorCommand(( (new SuggestCommand({
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1568, "Reset Suggest Widget Size")),
...
export { SuggestController, TriggerSuggestAction };

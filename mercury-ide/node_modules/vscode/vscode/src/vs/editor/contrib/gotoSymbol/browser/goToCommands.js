...
import { KeyCode, KeyMod as KeyMod$1, KeyChord } from '../../../../base/common/keyCodes.js';
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (
             (new ReferencesModel(
                ...
                ( localize(1410, 'Definitions'))
            ))
        );
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1411, "No definition found for '{0}'", info.word))
            : ( localize(1412, "No definition found"));
    }
...
registerAction2(class GoToDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1413, "Go to Definition")),
                mnemonicTitle: ( localize(1414, "Go to &&Definition")),
            },
            ...
            keybinding: [{
                    ...
                    primary: KeyMod$1.CtrlCmd | KeyCode.F12,
                    weight: KeybindingWeight.EditorContrib
                }],
            menu: [{
...
registerAction2(class OpenDefinitionToSideAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1415, "Open Definition to the Side")),
            ...
            keybinding: [{
                    when: EditorContextKeys.editorTextFocus,
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.F12),
                    weight: KeybindingWeight.EditorContrib
                }, {
                    when: ( (ContextKeyExpr.and(EditorContextKeys.editorTextFocus, IsWebContext))),
                    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.F12),
                    weight: KeybindingWeight.EditorContrib
                }]
        });
...
registerAction2(class PeekDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1416, "Peek Definition")),
            precondition: ( (ContextKeyExpr.and(
                EditorContextKeys.hasDefinitionProvider,
            ...
            keybinding: {
                when: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Alt | KeyCode.F12,
                linux: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.F10 },
                weight: KeybindingWeight.EditorContrib
            },
            menu: {
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (
             (new ReferencesModel(
                ...
                ( localize(1417, 'Declarations'))
            ))
        );
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1418, "No declaration found for '{0}'", info.word))
            : ( localize(1419, "No declaration found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1420, "Go to Declaration")),
                mnemonicTitle: ( localize(1421, "Go to &&Declaration")),
            },
            precondition: ( (ContextKeyExpr.and(
...
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: ( localize2(1422, "Peek Declaration")),
            precondition: ( (ContextKeyExpr.and(
                EditorContextKeys.hasDeclarationProvider,
                PeekContext.notInPeekEditor,
                 (EditorContextKeys.isInEmbeddedEditor.toNegated())
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (
             (new ReferencesModel(
                ...
                ( localize(1423, 'Type Definitions'))
            ))
        );
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1424, "No type definition found for '{0}'", info.word))
            : ( localize(1425, "No type definition found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1426, "Go to Type Definition")),
                mnemonicTitle: ( localize(1427, "Go to &&Type Definition")),
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1428, "Peek Type Definition")),
            precondition: ( (ContextKeyExpr.and(
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (
             (new ReferencesModel(
                ...
                ( localize(1429, 'Implementations'))
            ))
        );
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1430, "No implementation found for '{0}'", info.word))
            : ( localize(1431, "No implementation found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1432, "Go to Implementations")),
                mnemonicTitle: ( localize(1433, "Go to &&Implementations")),
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1434, "Peek Implementations")),
            precondition: ( (ContextKeyExpr.and(
            ...
            keybinding: {
                when: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.F12,
                weight: KeybindingWeight.EditorContrib
            },
            menu: {
                id: MenuId.EditorContextPeek,
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info
            ? ( localize(1435, "No references found for '{0}'", info.word))
            : ( localize(1436, "No references found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1437, "Go to References")),
                mnemonicTitle: ( localize(1438, "Go to &&References")),
            },
            precondition: ( (ContextKeyExpr.and(
            ...
            keybinding: {
                when: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Shift | KeyCode.F12,
                weight: KeybindingWeight.EditorContrib
            },
            menu: [{
                    id: MenuId.EditorContext,
...
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: ( localize2(1440, "Peek References")),
            precondition: ( (ContextKeyExpr.and(
                EditorContextKeys.hasReferenceProvider,
                PeekContext.notInPeekEditor,
                 (EditorContextKeys.isInEmbeddedEditor.toNegated())
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: ( localize2(1441, "Go to Any Symbol")),
            precondition: ( (ContextKeyExpr.and(
                PeekContext.notInPeekEditor,
                 (EditorContextKeys.isInEmbeddedEditor.toNegated())
            ))),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return (
             (new ReferencesModel(this._references, ( localize(1442, 'Locations'))))
        );
    }
    _getNoResultFoundMessage(info) {
        return info && ( localize(1443, "No results for '{0}'", info.word)) || '';
    }
    _getGoToPreference(editor) {
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(languageFeaturesService.referenceProvider, control.getModel(), Position.lift(position), false, false, token).then(references => ( (new ReferencesModel(references, ( localize(1439, 'References')))))));

...
import './folding.css.js';
import { StableEditorScrollState } from '../../../browser/stableEditorScroll.js';
import { MouseTargetType } from '../../../browser/editorBrowser.js';
import { registerEditorContribution, registerEditorAction, registerInstantiatedEditorAction, EditorAction, EditorContributionInstantiation } from '../../../browser/editorExtensions.js';
...
class UnfoldAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.unfold',
            label: ( localize(453, "Unfold")),
            alias: 'Unfold',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.BracketRight,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.BracketRight
                },
...
class UnFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(454, "Unfold Recursively")),
            alias: 'Unfold Recursively',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.BracketRight),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class FoldAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.fold',
            label: ( localize(455, "Fold")),
            alias: 'Fold',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.BracketLeft,
                mac: {
                    primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.BracketLeft
                },
                weight: KeybindingWeight.EditorContrib
            },
            metadata: {
...
class ToggleFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(456, "Toggle Fold")),
            alias: 'Toggle Fold',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyL),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class FoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(457, "Fold Recursively")),
            alias: 'Fold Recursively',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.BracketLeft),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class ToggleFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(458, "Toggle Fold Recursively")),
            alias: 'Toggle Fold Recursively',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyL),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class FoldAllBlockCommentsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(459, "Fold All Block Comments")),
            alias: 'Fold All Block Comments',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Slash),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class FoldAllRegionsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(460, "Fold All Regions")),
            alias: 'Fold All Regions',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Digit8),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class UnfoldAllRegionsAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(461, "Unfold All Regions")),
            alias: 'Unfold All Regions',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Digit9),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class FoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(462, "Fold All Except Selected")),
            alias: 'Fold All Except Selected',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Minus),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class UnfoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(463, "Unfold All Except Selected")),
            alias: 'Unfold All Except Selected',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Equal),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class FoldAllAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.foldAll',
            label: ( localize(464, "Fold All")),
            alias: 'Fold All',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Digit0),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class UnfoldAllAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.unfoldAll',
            label: ( localize(465, "Unfold All")),
            alias: 'Unfold All',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyJ),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class GotoParentFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(466, "Go to Parent Fold")),
...
class GotoPreviousFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(467, "Go to Previous Folding Range")),
...
class GotoNextFoldAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(468, "Go to Next Folding Range")),
...
class FoldRangeFromSelectionAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(469, "Create Folding Range from Selection")),
            alias: 'Create Folding Range from Selection',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Comma),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class RemoveFoldRangeFromSelectionAction extends FoldingAction {
    constructor() {
        super({
            ...
            label: ( localize(470, "Remove Manual Folding Ranges")),
            alias: 'Remove Manual Folding Ranges',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Period),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
for (let i = 1; i <= 7; i++) {
    registerInstantiatedEditorAction(( (new FoldLevelAction({
        ...
        label: ( localize(471, "Fold Level {0}", i)),
        alias: `Fold Level ${i}`,
        precondition: CONTEXT_FOLDING_ENABLED,
        kbOpts: {
            kbExpr: EditorContextKeys.editorTextFocus,
            primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | (KeyCode.Digit0 + i)),
            weight: KeybindingWeight.EditorContrib
        }
    }))));
}
...
export { FoldingController, RangesLimitReporter };

...
import { ReplaceCommandThatPreservesSelection, ReplaceCommand } from '../../../common/commands/replaceCommand.js';
...
const ToggleCaseSensitiveKeybinding = {
    primary: KeyMod$1.Alt | KeyCode.KeyC,
    mac: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyC }
};
const ToggleWholeWordKeybinding = {
    primary: KeyMod$1.Alt | KeyCode.KeyW,
    mac: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyW }
};
const ToggleRegexKeybinding = {
    primary: KeyMod$1.Alt | KeyCode.KeyR,
    mac: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyR }
};
const ToggleSearchScopeKeybinding = {
    primary: KeyMod$1.Alt | KeyCode.KeyL,
    mac: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyL }
};
const TogglePreserveCaseKeybinding = {
    primary: KeyMod$1.Alt | KeyCode.KeyP,
    mac: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.KeyP }
};
const FIND_IDS = {
...
class FindModelBoundToEditorModel {
    ...
    selectAllMatches() {
        ...
        let selections = ( matches.map(m => ( new Selection(
...
export { CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_FIND_WIDGET_NOT_VISIBLE, CONTEXT_FIND_WIDGET_VISIBLE, CONTEXT_REPLACE_INPUT_FOCUSED, FIND_IDS, FindModelBoundToEditorModel, MATCHES_LIMIT, ToggleCaseSensitiveKeybinding, TogglePreserveCaseKeybinding, ToggleRegexKeybinding, ToggleSearchScopeKeybinding, ToggleWholeWordKeybinding };

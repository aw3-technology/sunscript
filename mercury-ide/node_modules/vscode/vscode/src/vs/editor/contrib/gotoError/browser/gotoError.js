...
import { registerEditorContribution, registerEditorAction, registerEditorCommand, EditorAction, EditorContributionInstantiation, EditorCommand } from '../../../browser/editorExtensions.js';
...
class NextMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = ( localize(1445, "Go to Next Problem (Error, Warning, Info)")); }
    constructor() {
        super(true, false, {
            ...
            kbOpts: {
                ...
                primary: KeyMod$1.Alt | KeyCode.F8,
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MarkerNavigationWidget.TitleMenu,
                title: NextMarkerAction.LABEL,
                icon: registerIcon('marker-navigation-next', Codicon.arrowDown, ( localize(1446, 'Icon for goto next marker.'))),
                group: 'navigation',
                order: 1
            }
        });
...
class PrevMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = ( localize(1447, "Go to Previous Problem (Error, Warning, Info)")); }
    constructor() {
        super(false, false, {
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.F8,
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MarkerNavigationWidget.TitleMenu,
                title: PrevMarkerAction.LABEL,
                icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, ( localize(1448, 'Icon for goto previous marker.'))),
                group: 'navigation',
                order: 2
            }
        });
...
class NextMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(true, true, {
            ...
            label: ( localize(1449, "Go to Next Problem in Files (Error, Warning, Info)")),
            ...
            menuOpts: {
                ...
                title: ( localize(1450, "Next &&Problem")),
                group: '6_problem_nav',
                order: 1
            }
        });
...
class PrevMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(false, true, {
            ...
            label: ( localize(1451, "Go to Previous Problem in Files (Error, Warning, Info)")),
            alias: 'Go to Previous Problem in Files (Error, Warning, Info)',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary: KeyMod$1.Shift | KeyCode.F8,
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarGoMenu,
                title: ( localize(1452, "Previous &&Problem")),
                group: '6_problem_nav',
                order: 2
            }
        });

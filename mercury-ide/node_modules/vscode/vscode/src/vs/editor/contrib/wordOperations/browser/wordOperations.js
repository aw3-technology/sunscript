...
import { EditorOptions, EditorOption } from '../../../common/config/editorOptions.js';
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: { primary: KeyMod$1.Alt | KeyCode.LeftArrow },
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.LeftArrow,
                mac: { primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.LeftArrow },
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: { primary: KeyMod$1.Alt | KeyCode.RightArrow },
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.RightArrow,
                mac: { primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.RightArrow },
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                mac: { primary: KeyMod$1.Alt | KeyCode.Backspace },
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class DeleteWordRight extends DeleteWordRightCommand {
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: KeyMod$1.CtrlCmd | KeyCode.Delete,
                mac: { primary: KeyMod$1.Alt | KeyCode.Delete },
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class DeleteInsideWord extends EditorAction {
    constructor() {
        super({
            id: 'deleteInsideWord',
            precondition: EditorContextKeys.writable,
            label: ( localize(1608, "Delete Word")),
            alias: 'Delete Word'
        });
    }

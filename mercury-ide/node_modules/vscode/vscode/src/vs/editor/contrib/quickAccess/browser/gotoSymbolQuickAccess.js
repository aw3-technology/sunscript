...
import { pieceToQuery, scoreFuzzy2, prepareQuery } from '../../../../base/common/fuzzyScorer.js';
...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, ( localize(4648, "The active text editor does not provide symbol information.")));
        (async () => {
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, ( localize(4649, "No matching editor symbols")));
                    }
                    else {
                        this.provideLabelPick(picker, ( localize(4650, "No editor symbols")));
                    }
                }
            }
            finally {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                    ...
                    tooltip: openSideBySideDirection === 'right' ? ( localize(4651, "Open to the Side")) : ( localize(4652, "Open to the Bottom"))
                }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [
                { label: ( localize(4653, "symbols ({0})", filteredSymbolPicks.length)), type: 'separator' },
...
const FALLBACK_NLS_SYMBOL_KIND = ( localize(4654, "properties ({0})"));
const NLS_SYMBOL_KIND_CACHE = {
    [SymbolKind.Method]: ( localize(4655, "methods ({0})")),
    [SymbolKind.Function]: ( localize(4656, "functions ({0})")),
    [SymbolKind.Constructor]: ( localize(4657, "constructors ({0})")),
    [SymbolKind.Variable]: ( localize(4658, "variables ({0})")),
    [SymbolKind.Class]: ( localize(4659, "classes ({0})")),
    [SymbolKind.Struct]: ( localize(4660, "structs ({0})")),
    [SymbolKind.Event]: ( localize(4661, "events ({0})")),
    [SymbolKind.Operator]: ( localize(4662, "operators ({0})")),
    [SymbolKind.Interface]: ( localize(4663, "interfaces ({0})")),
    [SymbolKind.Namespace]: ( localize(4664, "namespaces ({0})")),
    [SymbolKind.Package]: ( localize(4665, "packages ({0})")),
    [SymbolKind.TypeParameter]: ( localize(4666, "type parameters ({0})")),
    [SymbolKind.Module]: ( localize(4667, "modules ({0})")),
    [SymbolKind.Property]: ( localize(4654, "properties ({0})")),
    [SymbolKind.Enum]: ( localize(4668, "enumerations ({0})")),
    [SymbolKind.EnumMember]: ( localize(4669, "enumeration members ({0})")),
    [SymbolKind.String]: ( localize(4670, "strings ({0})")),
    [SymbolKind.File]: ( localize(4671, "files ({0})")),
    [SymbolKind.Array]: ( localize(4672, "arrays ({0})")),
    [SymbolKind.Number]: ( localize(4673, "numbers ({0})")),
    [SymbolKind.Boolean]: ( localize(4674, "booleans ({0})")),
    [SymbolKind.Object]: ( localize(4675, "objects ({0})")),
    [SymbolKind.Key]: ( localize(4676, "keys ({0})")),
    [SymbolKind.Field]: ( localize(4677, "fields ({0})")),
    [SymbolKind.Constant]: ( localize(4678, "constants ({0})"))
};

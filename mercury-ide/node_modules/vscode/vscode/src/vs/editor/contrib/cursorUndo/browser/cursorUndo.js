...
class CursorUndoRedoController extends Disposable {
    ...
    cursorUndo() {
        ...
        this._redoStack.push(( (new StackElement(
    ...
    cursorRedo() {
        ...
        this._undoStack.push(( (new StackElement(
             (new CursorState(this._editor.getSelections())),
            this._editor.getScrollTop(),
            this._editor.getScrollLeft()
        ))));
...
class CursorUndo extends EditorAction {
    constructor() {
        super({
            id: 'cursorUndo',
            label: ( localize(1383, "Cursor Undo")),
            alias: 'Cursor Undo',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: KeyMod$1.CtrlCmd | KeyCode.KeyU,
...
class CursorRedo extends EditorAction {
    constructor() {
        super({
            id: 'cursorRedo',
            label: ( localize(1384, "Cursor Redo")),
            alias: 'Cursor Redo',
            precondition: undefined
        });
    }

...
import { isWindows, isNative, isLinux, isMacintosh } from '../../../../base/common/platform.js';
import { format } from '../../../../base/common/strings.js';
import './findWidget.css.js';
import { OverlayWidgetPositionPreference } from '../../../browser/editorBrowser.js';
import { EditorOption } from '../../../common/config/editorOptions.js';
import { Range } from '../../../common/core/range.js';
import { CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_REPLACE_INPUT_FOCUSED, MATCHES_LIMIT, FIND_IDS } from './findModel.js';
...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, ( localize(5053, 'Icon to indicate that the editor find widget is collapsed.')));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, ( localize(5054, 'Icon to indicate that the editor find widget is expanded.')));
const findSelectionIcon = registerIcon('find-selection', Codicon.selection, ( localize(5055, 'Icon for \'Find in Selection\' in the editor find widget.')));
const findReplaceIcon = registerIcon('find-replace', Codicon.replace, ( localize(5056, 'Icon for \'Replace\' in the editor find widget.')));
const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, ( localize(5057, 'Icon for \'Replace All\' in the editor find widget.')));
const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, ( localize(5058, 'Icon for \'Find Previous\' in the editor find widget.')));
const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, ( localize(5059, 'Icon for \'Find Next\' in the editor find widget.')));
const NLS_FIND_DIALOG_LABEL = ( localize(5060, "Find / Replace"));
const NLS_FIND_INPUT_LABEL = ( localize(5061, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(5062, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(5063, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(5064, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(5065, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(5066, "Close"));
const NLS_REPLACE_INPUT_LABEL = ( localize(5067, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(5068, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(5069, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(5070, "Replace All"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(5071, "Toggle Replace"));
...
const NLS_MATCHES_LOCATION = ( localize(5073, "{0} of {1}"));
const NLS_NO_RESULTS = ( localize(5074, "No results"));
...
class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? ( localize(5075, "{0} found", label))
                : ( localize(5076, "{0} found for '{1}'", label, searchString));
        }
        if (currentMatch) {
        ...
        return ( localize(5078, "{0} found for '{1}'", label, searchString));
    }
    ...
    _onFindInputKeyDown(e) {
        ...
        if (e.equals(KeyMod$1.CtrlCmd | KeyCode.DownArrow)) {
            this._codeEditor.focus();
            e.preventDefault();
            return;
        }
    ...
    _onReplaceInputKeyDown(e) {
        ...
        if (e.equals(KeyMod$1.Shift | KeyCode.Tab)) {
            this._findInput.focus();
            e.preventDefault();
            return;
        }

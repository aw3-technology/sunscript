...
let ContextMenuController = class ContextMenuController {
    ...
    _doShowContextMenu(actions, event = null) {
        ...
        this._contextMenuService.showContextMenu({
            ...
            getActionViewItem: (action) => {
                ...
                return (
                     (new ActionViewItem(action, action, { icon: true, label: true, isMenu: true }))
                );
            },
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        const createSubmenuAction = (label, actions) => {
            return (
                 (new SubmenuAction(`menu-action-${++lastId}`, label, actions, undefined))
            );
        };
        ...
        actions.push(createAction({
            label: ( localize(1374, "Render Characters")),
        ...
        actions.push(createEnumAction(( localize(1375, "Vertical size")), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: ( localize(1376, "Proportional")),
                value: 'proportional'
            }, {
                label: ( localize(1377, "Fill")),
                value: 'fill'
            }, {
                label: ( localize(1378, "Fit")),
                value: 'fit'
            }]));
        actions.push(createEnumAction(( localize(1379, "Slider")), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: ( localize(1380, "Mouse Over")),
                value: 'mouseover'
            }, {
                label: ( localize(1381, "Always")),
                value: 'always'
            }]));
        const useShadowDOM = this._editor.getOption(EditorOption.useShadowDOM) && !isIOS;
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1382, "Show Editor Context Menu")),

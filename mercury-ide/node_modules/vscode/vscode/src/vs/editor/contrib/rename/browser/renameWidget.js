...
import { raceCancellation, DeferredPromise } from '../../../../base/common/async.js';
...
import { quickInputListFocusForeground, quickInputListFocusBackground } from '../../../../platform/theme/common/colors/quickpickColors.js';
import '../../../../platform/theme/common/colors/searchColors.js';
import { IThemeService } from '../../../../platform/theme/common/themeService.service.js';
const CONTEXT_RENAME_INPUT_VISIBLE = ( (new RawContextKey('renameInputVisible', false, ( localize(5202, "Whether the rename input widget is visible")))));
...
class RenameCandidateListView {
    ...
    setCandidates(candidates) {
        ...
        status(( localize(5205, "Received {0} rename suggestions", candidates.length)));
    }
    clearCandidates() {
    ...
    _pickListWidth(candidates) {
        ...
        const width = Math.max(this._minimumWidth, 4  + 16  + 5  + longestCandidateWidth + 10
        );
        return width;
    }
    static _createListWidget(container, candidateViewHeight, fontInfo) {
        ...
        const renderer = new (class {
            ...
            renderTemplate(container) {
                return (
                     (new RenameCandidateView(container, fontInfo))
                );
            }
        ...
        return (
             (new List('NewSymbolNameCandidates', container, virtualDelegate, [renderer], {
...
class InputWithButton {
    ...
    get domNode() {
        if (!this._domNode) {
            ...
            this._inputNode.setAttribute('aria-label', ( localize(5206, "Rename input. Type new name and press Enter to commit.")));
            this._domNode.appendChild(this._inputNode);
            this._buttonNode = document.createElement('div');
            this._buttonNode.className = 'rename-suggestions-button';
            this._buttonNode.setAttribute('tabindex', '0');
            this._buttonGenHoverText = ( localize(5207, "Generate new name suggestions"));
            this._buttonCancelHoverText = ( localize(5208, "Cancel"));

...
import { ReplaceCommandThatSelectsText, ReplaceCommand, ReplaceCommandThatPreservesSelection } from '../../../common/commands/replaceCommand.js';
...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize(1476, "Copy Line Up")),
            alias: 'Copy Line Up',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.UpArrow,
                linux: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.UpArrow },
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1477, "&&Copy Line Up")),
                order: 1
            }
        });
    }
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize(1478, "Copy Line Down")),
            alias: 'Copy Line Down',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.DownArrow,
                linux: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyMod$1.Shift | KeyCode.DownArrow },
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1479, "Co&&py Line Down")),
                order: 2
            }
        });
    }
...
class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1480, "Duplicate Selection")),
            alias: 'Duplicate Selection',
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1481, "&&Duplicate Selection")),
                order: 5
            }
        });
    }
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize(1482, "Move Line Up")),
            alias: 'Move Line Up',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Alt | KeyCode.UpArrow,
                linux: { primary: KeyMod$1.Alt | KeyCode.UpArrow },
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1483, "Mo&&ve Line Up")),
                order: 3
            }
        });
    }
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize(1484, "Move Line Down")),
            alias: 'Move Line Down',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Alt | KeyCode.DownArrow,
                linux: { primary: KeyMod$1.Alt | KeyCode.DownArrow },
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1485, "Move &&Line Down")),
                order: 4
            }
        });
    }
...
class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize(1486, "Sort Lines Ascending")),
...
class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize(1487, "Sort Lines Descending")),
...
class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1488, "Delete Duplicate Lines")),
...
class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1489, "Trim Trailing Whitespace")),
            alias: 'Trim Trailing Whitespace',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyX),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1490, "Delete Line")),
            alias: 'Delete Line',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyK,
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
    run(_accessor, editor) {
        ...
        for (let i = 0, len = ops.length; i < len; i++) {
            ...
            cursorState.push(( (new Selection(
...
class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1491, "Indent Line")),
            alias: 'Indent Line',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyCode.BracketRight,
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1492, "Outdent Line")),
            alias: 'Outdent Line',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyCode.BracketLeft,
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class InsertLineBeforeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1493, "Insert Line Above")),
...
class InsertLineAfterAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1494, "Insert Line Below")),
...
class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllLeft',
            label: ( localize(1495, "Delete All Left")),
        ...
        rangesToDelete = ( (rangesToDelete.map(selection => {
            if (selection.isEmpty()) {
                if (selection.startColumn === 1) {
                    ...
                    return (
                         (new Range(deleteFromLine, deleteFromColumn, selection.startLineNumber, 1))
                    );
                }
                else {
                    return (
                ...
                return (
                     (new Range(selection.startLineNumber, 1, selection.endLineNumber, selection.endColumn))
                );
            }
        })));
...
class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllRight',
            label: ( localize(1496, "Delete All Right")),
            alias: 'Delete All Right',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
                mac: { primary: KeyMod$1.WinCtrl | KeyCode.KeyK, secondary: [KeyMod$1.CtrlCmd | KeyCode.Delete] },
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
        ...
        const rangesToDelete = ( (selections.map((sel) => {
            if (sel.isEmpty()) {
                ...
                if (sel.startColumn === maxColumn) {
                    return (
                         (new Range(sel.startLineNumber, sel.startColumn, sel.startLineNumber + 1, 1))
                    );
                }
                else {
                    return (
                         (new Range(sel.startLineNumber, sel.startColumn, sel.startLineNumber, maxColumn))
                    );
                }
            }
            return sel;
...
class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1497, "Join Lines")),
            alias: 'Join Lines',
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
                mac: { primary: KeyMod$1.WinCtrl | KeyCode.KeyJ },
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1498, "Transpose Characters around the Cursor")),
    ...
    run(_accessor, editor) {
        ...
        for (let i = 0, len = selections.length; i < len; i++) {
            ...
            if (cursor.column >= maxColumn) {
                ...
                commands.push(( (new ReplaceCommand( (new Selection(
                    cursor.lineNumber,
                    Math.max(1, cursor.column - 1),
                    cursor.lineNumber + 1,
                    1
...
class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize(1499, "Transform to Uppercase")),
...
class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize(1500, "Transform to Lowercase")),
...
class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1501, "Transform to Title Case")),
...
class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1502, "Transform to Snake Case")),
...
class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1503, "Transform to Camel Case")),
...
class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1504, "Transform to Pascal Case")),
...
class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1505, 'Transform to Kebab Case')),
...
export { AbstractCaseAction, AbstractDeleteAllToBoundaryAction, AbstractSortLinesAction, CamelCaseAction, DeleteAllLeftAction, DeleteAllRightAction, DeleteDuplicateLinesAction, DeleteLinesAction, DuplicateSelectionAction, IndentLinesAction, InsertLineAfterAction, InsertLineBeforeAction, JoinLinesAction, KebabCaseAction, LowerCaseAction, PascalCaseAction, SnakeCaseAction, SortLinesAscendingAction, SortLinesDescendingAction, TitleCaseAction, TransposeAction, TrimTrailingWhitespaceAction, UpperCaseAction };

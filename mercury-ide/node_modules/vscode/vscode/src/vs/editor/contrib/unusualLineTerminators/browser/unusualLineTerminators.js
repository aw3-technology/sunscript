    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: ( localize(1598, "Unusual Line Terminators")),
                message: ( localize(1599, "Detected unusual line terminators")),
                detail: ( localize(
                    1600,
                ...
                primaryButton: ( localize(1601, "&&Remove Unusual Line Terminators")),
                cancelButton: ( localize(1602, "Ignore"))
            });
        }
        finally {
            this._isPresentingDialog = false;

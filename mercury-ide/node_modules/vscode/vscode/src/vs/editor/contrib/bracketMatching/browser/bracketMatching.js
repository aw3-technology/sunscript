...
const overviewRulerBracketMatchForeground = registerColor('editorOverviewRuler.bracketMatchForeground', '#A0A0A0', ( localize(1337, 'Overview ruler marker color for matching brackets.')));
class JumpToBracketAction extends EditorAction {
    constructor() {
        super({
            id: 'editor.action.jumpToBracket',
            label: ( localize(1338, "Go to Bracket")),
            alias: 'Go to Bracket',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Backslash,
...
class SelectToBracketAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1339, "Select to Bracket")),
            alias: 'Select to Bracket',
            precondition: undefined,
            metadata: {
                description: ( localize2(1340, "Select the text inside and including the brackets or curly braces")),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
...
class RemoveBracketsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1341, "Remove Brackets")),
            alias: 'Remove Brackets',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Backspace,
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: 'editor.action.jumpToBracket',
        title: ( localize(1342, "Go to &&Bracket"))
    },
    order: 2
});

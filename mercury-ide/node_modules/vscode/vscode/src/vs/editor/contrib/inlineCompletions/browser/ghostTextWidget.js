...
let GhostTextWidget = class GhostTextWidget extends Disposable {
    constructor(editor, model, languageService) {
        ...
        this.currentTextModel = observableFromEvent(this, this.editor.onDidChangeModel, () =>  this.editor.getModel());
...
export { AdditionalLinesWidget, GHOST_TEXT_DESCRIPTION, GhostTextWidget, ttPolicy };

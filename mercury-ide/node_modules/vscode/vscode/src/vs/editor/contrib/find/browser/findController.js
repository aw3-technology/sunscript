...
import { registerMultiEditorAction, registerEditorContribution, registerEditorAction, registerEditorCommand, MultiEditorAction, EditorContributionInstantiation, EditorCommand, EditorAction } from '../../../browser/editorExtensions.js';
    ...
    replaceAll() {
        if (this._model) {
            if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
                this._notificationService.warn(( localize(1392, "The file is too large to perform a replace all operation.")));
                return false;
            }
...
class StartFindWithArgsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1395, "Find With Arguments")),
...
class StartFindWithSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1396, "Find With Selection")),
...
class PreviousMatchFindAction extends MatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize(1398, "Find Previous")),
            alias: 'Find Previous',
            precondition: undefined,
            kbOpts: [{
                    kbExpr: EditorContextKeys.focus,
...
class MoveToMatchFindAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1399, "Go to Match...")),
            alias: 'Go to Match...',
    ...
    run(accessor, editor, args) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: ( localize(1400, "No matches. Try searching for something else."))
            });
            return;
        }
...
class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize(1403, "Find Next Selection")),
...
class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize(1404, "Find Previous Selection")),

...
import { HoverParticipantRegistry, HoverAnchorType } from '../../hover/browser/hoverTypes.js';
...
const warningIcon = registerIcon('extensions-warning-message', Codicon.warning, ( localize(1574, 'Icon shown with a warning message in the extensions editor.')));
        ...
        this._updateState = (state) => {
            if (state && state.hasMore) {
                ...
                if (state.nonBasicAsciiCharacterCount >= max) {
                    data = {
                        message: ( localize(1575, 'This document contains many non-basic ASCII unicode characters')),
                        command: ( (new DisableHighlightingOfNonBasicAsciiCharactersAction())),
                    };
                }
                else if (state.ambiguousCharacterCount >= max) {
                    data = {
                        message: ( localize(1576, 'This document contains many ambiguous unicode characters')),
                        command: ( (new DisableHighlightingOfAmbiguousCharactersAction())),
                    };
                }
                else if (state.invisibleCharacterCount >= max) {
                    data = {
                        message: ( localize(1577, 'This document contains many invisible unicode characters')),
...
const configureUnicodeHighlightOptionsStr = ( localize(1578, 'Configure Unicode Highlight Options'));
        ...
        for (const d of lineDecorations) {
            ...
            switch (highlightInfo.reason.kind) {
                ...
                case UnicodeHighlighterReasonKind.Invisible:
                    reason = ( localize(1581, 'The character {0} is invisible.', codePointStr));
                    break;
                case UnicodeHighlighterReasonKind.NonBasicAscii:
                    reason = ( localize(1582, 'The character {0} is not a basic ASCII character.', codePointStr));
                    break;
            }
            ...
            const adjustSettings = ( localize(1583, 'Adjust settings'));
...
class DisableHighlightingInCommentsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1584, 'Disable highlighting of characters in comments')),
            alias: 'Disable highlighting of characters in comments',
            precondition: undefined
        });
        this.shortLabel = ( localize(1585, 'Disable Highlight In Comments'));
    }
...
class DisableHighlightingInStringsAction extends EditorAction {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: ( localize(1586, 'Disable highlighting of characters in strings')),
            alias: 'Disable highlighting of characters in strings',
            precondition: undefined
        });
        this.shortLabel = ( localize(1587, 'Disable Highlight In Strings'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfAmbiguousCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: ( localize(1588, 'Disable highlighting of ambiguous characters')),
            alias: 'Disable highlighting of ambiguous characters',
            precondition: undefined
        });
        this.shortLabel = ( localize(1589, 'Disable Ambiguous Highlight'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfInvisibleCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1590, 'Disable highlighting of invisible characters')),
            alias: 'Disable highlighting of invisible characters',
            precondition: undefined
        });
        this.shortLabel = ( localize(1591, 'Disable Invisible Highlight'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfNonBasicAsciiCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1592, 'Disable highlighting of non basic ASCII characters')),
            alias: 'Disable highlighting of non basic ASCII characters',
            precondition: undefined
        });
        this.shortLabel = ( localize(1593, 'Disable Non ASCII Highlight'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class ShowExcludeOptions extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize(1594, "Show Exclude Options")),

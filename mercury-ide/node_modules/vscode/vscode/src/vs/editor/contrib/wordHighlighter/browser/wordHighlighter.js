...
import { first, timeout, createCancelablePromise } from '../../../../base/common/async.js';
...
import { registerModelAndPositionCommand, registerEditorContribution, registerEditorAction, EditorContributionInstantiation, EditorAction } from '../../../browser/editorExtensions.js';
...
function computeOccurencesAtPosition(registry, model, selection, word, wordSeparators) {
    if (( (registry.has(model)))) {
        return (
             (new SemanticOccurenceAtPositionRequest(model, selection, wordSeparators, registry))
        );
    }
    return (
         (new TextualOccurenceRequest(model, selection, word, wordSeparators, []))
    );
}
function computeOccurencesMultiModel(registry, model, selection, word, wordSeparators, otherModels) {
    if (( (registry.has(model)))) {
        return (
             (new MultiModelOccurenceRequest(model, selection, wordSeparators, registry, otherModels))
        );
    }
    return (
         (new TextualOccurenceRequest(model, selection, word, wordSeparators, otherModels))
    );
}
...
class NextWordHighlightAction extends WordHighlightNavigationAction {
    constructor() {
        super(true, {
            ...
            label: ( localize(1603, "Go to Next Symbol Highlight")),
...
class PrevWordHighlightAction extends WordHighlightNavigationAction {
    constructor() {
        super(false, {
            ...
            label: ( localize(1604, "Go to Previous Symbol Highlight")),
...
class TriggerWordHighlightAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1605, "Trigger Symbol Highlight")),

...
const suggestMoreInfoIcon = registerIcon('suggest-more-info', Codicon.chevronRight, ( localize(9954, 'Icon for more information in the suggest widget.')));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = ( localize(9955, "Read More"));
        const configureFont = () => {

...
class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5137, "Show or Focus Hover")),
            metadata: {
                        ...
                        schema: {
                            ...
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        ( localize(5139, 'The hover will not automatically take focus.')),
                                        ( localize(5140, 'The hover will take focus only if it is already visible.')),
                                        ( localize(5141, 'The hover will automatically take focus when it appears.')),
                                    ],
...
class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5142, "Show Definition Preview Hover")),
            alias: 'Show Definition Preview Hover',
            precondition: undefined,
            metadata: {
                description: ( localize2(5143, 'Show the definition preview hover in the editor.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5144, "Scroll Up Hover")),
            ...
            metadata: {
                description: ( localize2(5145, 'Scroll up the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5146, "Scroll Down Hover")),
            ...
            metadata: {
                description: ( localize2(5147, 'Scroll down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5148, "Scroll Left Hover")),
            ...
            metadata: {
                description: ( localize2(5149, 'Scroll left the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5150, "Scroll Right Hover")),
            ...
            metadata: {
                description: ( localize2(5151, 'Scroll right the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5152, "Page Up Hover")),
            alias: 'Page Up Hover',
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(5153, 'Page up the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5154, "Page Down Hover")),
            ...
            metadata: {
                description: ( localize2(5155, 'Page down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5156, "Go To Top Hover")),
            ...
            metadata: {
                description: ( localize2(5157, 'Go to the top of the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(5158, "Go To Bottom Hover")),
            alias: 'Go To Bottom Hover',
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(5159, 'Go to the bottom of the editor hover.'))
            },
        });
    }
    run(accessor, editor) {

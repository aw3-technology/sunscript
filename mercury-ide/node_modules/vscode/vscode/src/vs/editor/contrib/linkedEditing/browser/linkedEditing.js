...
import { registerEditorCommand, registerModelAndPositionCommand, registerEditorContribution, registerEditorAction, EditorCommand, EditorContributionInstantiation, EditorAction } from '../../../browser/editorExtensions.js';
    ...
    async updateRanges(force = false) {
        ...
        try {
            ...
            const decorations = ( (ranges.map(
                range => ({ range: range, options: LinkedEditingContribution_1.DECORATION })
            )));
...
class LinkedEditingAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1506, "Start Linked Editing")),
            alias: 'Start Linked Editing',
            precondition: ( (ContextKeyExpr.and(EditorContextKeys.writable, EditorContextKeys.hasRenameProvider))),
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.F2,
...
registerColor('editor.linkedEditingBackground', { dark: ( (( (Color.fromHex('#f00'))).transparent(0.3))), light: ( (( (Color.fromHex('#f00'))).transparent(0.3))), hcDark: ( (( (Color.fromHex('#f00'))).transparent(0.3))), hcLight: Color.white }, ( localize(1507, 'Background color when the editor auto renames on type.')));

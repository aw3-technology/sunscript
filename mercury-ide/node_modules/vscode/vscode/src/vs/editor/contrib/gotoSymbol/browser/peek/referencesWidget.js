...
let ReferenceWidget = class ReferenceWidget extends PeekViewWidget {
    ...
    _fillBody(containerElement) {
        ...
        this._previewNotAvailableMessage = ( (new TextModel(( localize(9796, "no preview available")), PLAINTEXT_LANGUAGE_ID, TextModel.DEFAULT_CREATION_OPTIONS, null, this._undoRedoService, this._languageService, this._languageConfigurationService)));
    ...
    _onNewModel() {
        ...
        if (this._model.isEmpty) {
            this.setTitle('');
            this._messageContainer.innerText = ( localize(9797, "No results"));
    ...
    async _revealReference(reference, revealParent) {
        ...
        if (reference.uri.scheme !== Schemas.inMemory) {
            ...
            this.setTitle(( localize(9798, "References")));
        }

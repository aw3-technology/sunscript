...
let ReferencesController = class ReferencesController {
    ...
    toggleWidget(range, modelPromise, peekMode) {
        ...
        this._widget.setTitle(( localize(4504, "Loading...")));
            ...
            return this._widget.setModel(this._model).then(() => {
                if (this._widget && this._model && this._editor.hasModel()) {
                    if (!this._model.isEmpty) {
                        this._widget.setMetaTitle(( localize(4505, "{0} ({1})", this._model.title, this._model.references.length)));
                    }
                    else {
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyCode.F2),
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    weight: KeybindingWeight.EditorContrib - 10,
    primary: KeyMod$1.Shift | KeyCode.F4,
    secondary: [KeyMod$1.Shift | KeyCode.F12],
    when: ( (ContextKeyExpr.or(ctxReferenceSearchVisible, PeekContext.inPeekEditor))),
    handler(accessor) {
        withController(accessor, controller => {
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    mac: {
        primary: KeyMod$1.WinCtrl | KeyCode.Enter
    },
    when: ( (ContextKeyExpr.and(
        ctxReferenceSearchVisible,
        WorkbenchListFocusContextKey,

...
import { registerEditorContribution, registerEditorAction, registerEditorCommand, EditorContributionInstantiation, EditorCommand, EditorAction } from '../../../browser/editorExtensions.js';
...
class TriggerParameterHintsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1541, "Trigger Parameter Hints")),

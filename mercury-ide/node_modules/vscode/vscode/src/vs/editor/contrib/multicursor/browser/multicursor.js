...
import { registerEditorContribution, registerEditorAction, EditorContributionInstantiation, EditorAction } from '../../../browser/editorExtensions.js';
...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? ( localize(1518, "Cursor added: {0}", cursorPositions)) : ( localize(1519, "Cursors added: {0}", cursorPositions));
        status(msg);
    }
}
class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1520, "Add Cursor Above")),
            ...
            kbOpts: {
                ...
                linux: {
                    primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.UpArrow,
            ...
            menuOpts: {
                ...
                group: '3_multi',
                title: ( localize(1521, "&&Add Cursor Above")),
                order: 2
            }
        });
    }
    run(accessor, editor, args) {
        ...
        viewModel.setCursorStates(args.source, CursorChangeReason.Explicit, CursorMoveCommands.addCursorUp(viewModel, previousCursorState, useLogicalLine));
...
class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1522, "Add Cursor Below")),
            ...
            kbOpts: {
                ...
                linux: {
                    primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.DownArrow,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1523, "A&&dd Cursor Below")),
                order: 3
            }
        });
    }
    run(accessor, editor, args) {
        ...
        viewModel.model.pushStackElement();
        const previousCursorState = viewModel.getCursorStates();
        viewModel.setCursorStates(args.source, CursorChangeReason.Explicit, CursorMoveCommands.addCursorDown(viewModel, previousCursorState, useLogicalLine));
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1524, "Add Cursors to Line Ends")),
            alias: 'Add Cursors to Line Ends',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.KeyI,
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1525, "Add C&&ursors to Line Ends")),
                order: 4
            }
        });
    }
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1526, "Add Cursors To Bottom")),
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1527, "Add Cursors To Top")),
...
class MultiCursorSession {
    ...
    addSelectionToNextFindMatch() {
        ...
        return (
             (new MultiCursorSessionResult(allSelections.concat(nextMatch), nextMatch, ScrollType.Smooth))
        );
    }
    ...
    addSelectionToPreviousFindMatch() {
        ...
        const allSelections = this._editor.getSelections();
        return (
             (new MultiCursorSessionResult(allSelections.concat(previousMatch), previousMatch, ScrollType.Smooth))
        );
    }
...
class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize(1528, "Add Selection To Next Find Match")),
            alias: 'Add Selection To Next Find Match',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary: KeyMod$1.CtrlCmd | KeyCode.KeyD,
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1529, "Add &&Next Occurrence")),
                order: 5
            }
        });
    }
...
class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize(1530, "Add Selection To Previous Find Match")),
            alias: 'Add Selection To Previous Find Match',
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1531, "Add P&&revious Occurrence")),
                order: 6
            }
        });
    }
...
class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize(1532, "Move Last Selection To Next Find Match")),
            alias: 'Move Last Selection To Next Find Match',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.KeyD),
                weight: KeybindingWeight.EditorContrib
            }
        });
    }
...
class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize(1533, "Move Last Selection To Previous Find Match")),
...
class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize(1534, "Select All Occurrences of Find Match")),
            alias: 'Select All Occurrences of Find Match',
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyL,
                weight: KeybindingWeight.EditorContrib
            },
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1535, "Select All &&Occurrences")),
                order: 7
            }
        });
    }
...
class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize(1536, "Change All Occurrences")),
            alias: 'Change All Occurrences',
            precondition: ( (ContextKeyExpr.and(EditorContextKeys.writable, EditorContextKeys.editorTextFocus))),
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyMod$1.CtrlCmd | KeyCode.F2,
                weight: KeybindingWeight.EditorContrib
            },
            contextMenuOpts: {
...
class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1537, "Focus Next Cursor")),
            metadata: {
                description: ( localize(1538, "Focuses the next cursor")),
                args: [],
            },
...
class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1539, "Focus Previous Cursor")),
            metadata: {
                description: ( localize(1540, "Focuses the previous cursor")),
                args: [],
            },

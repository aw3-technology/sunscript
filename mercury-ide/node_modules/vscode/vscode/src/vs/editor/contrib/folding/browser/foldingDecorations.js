...
import { TrackedRangeStickiness, MinimapPosition } from '../../../common/model.js';
...
registerColor('editorGutter.foldingControlForeground', iconForeground, ( localize(1687, 'Color of the folding control in the editor gutter.')));
const foldingExpandedIcon = registerIcon('folding-expanded', Codicon.chevronDown, ( localize(1688, 'Icon for expanded ranges in the editor glyph margin.')));
const foldingCollapsedIcon = registerIcon('folding-collapsed', Codicon.chevronRight, ( localize(1689, 'Icon for collapsed ranges in the editor glyph margin.')));
const foldingManualCollapsedIcon = registerIcon('folding-manual-collapsed', foldingCollapsedIcon, ( localize(1690, 'Icon for manually collapsed ranges in the editor glyph margin.')));
const foldingManualExpandedIcon = registerIcon('folding-manual-expanded', foldingExpandedIcon, ( localize(1691, 'Icon for manually expanded ranges in the editor glyph margin.')));
const foldedBackgroundMinimap = { color: themeColorFromId(foldBackground), position: MinimapPosition.Inline };
const collapsed = ( localize(1692, "Click to expand the range."));
const expanded = ( localize(1693, "Click to collapse the range."));

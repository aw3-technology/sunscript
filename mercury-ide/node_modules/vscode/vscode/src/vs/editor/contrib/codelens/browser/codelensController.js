            ...
            this._editor.changeViewZones(viewZoneAccessor => {
                ...
                while (groupsIndex < groups.length && codeLensIndex < this._lenses.length) {
                    ...
                    if (codeLensLineNumber < symbolsLineNumber) {
                        ...
                        this._lenses.splice(codeLensIndex, 0, ( (new CodeLensWidget(
                            groups[groupsIndex],
                            this._editor,
                            helper,
                            viewZoneAccessor,
                ...
                while (groupsIndex < groups.length) {
                    this._lenses.push(( (new CodeLensWidget(
                        groups[groupsIndex],
                        this._editor,
                        helper,
                        viewZoneAccessor,
...
registerEditorAction(class ShowLensesInCurrentLine extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1358, "Show CodeLens Commands For Current Line")),
    ...
    async run(accessor, editor) {
        ...
        const item = await quickInputService.pick(items, {
            canPickMany: false,
            placeHolder: ( localize(1359, "Select a command"))
        });
        if (!item) {
            return;
        }

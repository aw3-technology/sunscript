...
import { IObservable } from './observableInternal/base.js';
...
interface IDynamicListEventMultiplexer<TEventType> extends IDisposable {
    readonly event: Event<TEventType>;
}
declare class DynamicListEventMultiplexer<TItem, TEventType> implements IDynamicListEventMultiplexer<TEventType> {
...
export { DynamicListEventMultiplexer, Emitter, type EmitterOptions, Event, type EventDeliveryQueue, type IDynamicListEventMultiplexer, type IValueWithChangeEvent, type IWaitUntil };

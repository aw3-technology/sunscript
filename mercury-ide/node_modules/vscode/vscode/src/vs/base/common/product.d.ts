...
interface IProductWalkthrough {
    id: string;
    steps: IProductWalkthroughStep[];
}
interface IProductWalkthroughStep {
    id: string;
    title: string;
    when: string;
    description: string;
...
interface IExtensionRecommendations {
    readonly onFileOpen: IFileOpenCondition[];
    readonly onSettingsEditorOpen?: ISettingsEditorOpenCondition;
}
interface ISettingsEditorOpenCondition {
    readonly prerelease?: boolean | string;
    readonly descriptionOverride?: string;
}
interface IExtensionRecommendationCondition {
    readonly important?: boolean;
    readonly whenInstalled?: string[];
    readonly whenNotInstalled?: string[];
}
type IFileOpenCondition = IFileLanguageCondition | IFilePathCondition | IFileContentCondition;
interface IFileLanguageCondition extends IExtensionRecommendationCondition {
    readonly languages: string[];
}
interface IFilePathCondition extends IExtensionRecommendationCondition {
    readonly pathGlob: string;
}
type IFileContentCondition = (IFileLanguageCondition | IFilePathCondition) & {
...
interface IAiGeneratedWorkspaceTrust {
    readonly title: string;
...
export type { ConfigurationSyncStore, ExtensionUntrustedWorkspaceSupport, ExtensionVirtualWorkspaceSupport, IAiGeneratedWorkspaceTrust, IAppCenterConfiguration, IBuiltInExtension, IConfigBasedExtensionTip, IExeBasedExtensionTip, IExtensionRecommendationCondition, IExtensionRecommendations, IFeaturedExtension, IFileContentCondition, IFileLanguageCondition, IFileOpenCondition, IFilePathCondition, IGitHubEntitlement, IProductConfiguration, IProductWalkthrough, IProductWalkthroughStep, IRemoteExtensionTip, ISettingsEditorOpenCondition, ISurveyData, ITunnelApplicationConfig, IVirtualWorkspaceExtensionTip };

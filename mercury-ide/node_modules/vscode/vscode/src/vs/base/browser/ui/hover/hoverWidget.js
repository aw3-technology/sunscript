import { append, addDisposableListener, EventType, $ as $$1 } from '../../dom.js';
...
class HoverAction extends Disposable {
    static render(parent, actionOptions, keybindingLabel) {
        return (
             (new HoverAction(parent, actionOptions, keybindingLabel))
        );
    }
...
function getHoverAccessibleViewHint(shouldHaveHint, keybinding) {
    return shouldHaveHint && keybinding ? ( localize(6985, "Inspect this in the accessible view with {0}.", keybinding)) : shouldHaveHint ? ( localize(
        6986,

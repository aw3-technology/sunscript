...
class SelectBoxList extends Disposable {
    ...
    createSelectList(parent) {
        ...
        this.selectList = this._register(( (new List(
            'SelectBoxCustom',
            ...
            [this.listRenderer],
            {
                ...
                accessibilityProvider: {
                    ...
                    getWidgetAriaLabel: () => ( localize(10917, "Select Box")),
        ...
        this._register(Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === KeyCode.Tab))(this.onEnter, this));

...
import { assertType, isUndefinedOrNull } from '../../../common/types.js';
...
class BaseActionViewItem extends Disposable {
    ...
    render(container) {
        ...
        this._register(addDisposableListener(element, EventType$1.Tap, e => this.onClick(e, true)));
    ...
    getTooltip() {
        ...
        if (this.action.tooltip) {
            ...
            if (this.options.keybinding) {
                title = ( localize(5041, "{0} ({1})", title, this.options.keybinding));
            }
        }

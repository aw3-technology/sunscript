import './iconlabel.css.js';
import { append, $, isHTMLElement, asCSSUrl, after } from '../../dom.js';
...
class IconLabel extends Disposable {
    ...
    getOrCreateDescriptionNode() {
        if (!this.descriptionNode) {
            const descriptionContainer = this._register(( new FastLabelNode(
                append(this.labelContainer, $('span.monaco-icon-description-container'))
            )));
            if (this.creationOptions?.supportDescriptionHighlights) {
                this.descriptionNode = this._register(( new HighlightedLabel(
                    append(descriptionContainer.element, $('span.label-description')),
    ...
    setLabel(label, options) {
        ...
        if (typeof label === 'string') {
            if (!this.singleLabel) {
                this.container.innerText = '';
                this.container.classList.remove('multiple');
                this.singleLabel = this._register(( new HighlightedLabel(
                    append(this.container, $('a.label-name', { id: options?.domId })),

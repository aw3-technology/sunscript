...
class Checkbox extends Widget {
    ...
    constructor(title, isChecked, styles) {
        ...
        this.checkbox = this._register(( new Toggle(
            { title: this.title, isChecked: this.isChecked, icon: Codicon.check, actionClassName: Checkbox.CLASS_NAME, ...unthemedToggleStyles }
        )));
...
export { Checkbox, CheckboxActionViewItem, Toggle, ToggleActionViewItem, unthemedToggleStyles };

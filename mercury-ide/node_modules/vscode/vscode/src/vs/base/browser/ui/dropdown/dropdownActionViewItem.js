...
import { h, append, addDisposableListener, EventType, $ } from '../../dom.js';
...
class ActionWithDropdownActionViewItem extends ActionViewItem {
    ...
    render(container) {
        ...
        if (this.element) {
            ...
            this.dropdownMenuActionViewItem = this._register(( (new DropdownMenuActionViewItem(this._register(( (new Action('dropdownAction', ( localize(7355, "More Actions...")))))), menuActionsProvider, this.contextMenuProvider, { classNames: ['dropdown', ...ThemeIcon.asClassNameArray(Codicon.dropDownButton), ...menuActionClassNames], hoverDelegate: this.options.hoverDelegate }))));
...
export { ActionWithDropdownActionViewItem, DropdownMenuActionViewItem };

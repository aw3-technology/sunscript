...
interface IHoverPositionOptions {
    /**
...
interface IHoverPersistenceOptions {
    /**
...
interface IHoverAppearanceOptions {
    /**
 ...
 */
interface IHoverTarget extends IDisposable {
    /**
...
type IManagedHoverContent = string | IManagedHoverTooltipMarkdownString | HTMLElement | undefined;
type IManagedHoverContentOrFactory = IManagedHoverContent | (() => IManagedHoverContent);
interface IManagedHoverOptions extends Pick<IHoverOptions, 'actions' | 'linkHandler' | 'trapFocus'> {
}
interface IManagedHover extends IDisposable {
    /**
...
export type { IHoverAction, IHoverAppearanceOptions, IHoverDelegate2, IHoverOptions, IHoverPersistenceOptions, IHoverPositionOptions, IHoverTarget, IHoverWidget, IManagedHover, IManagedHoverContent, IManagedHoverContentOrFactory, IManagedHoverOptions, IManagedHoverTooltipMarkdownString };

import { TreeVisibility, TreeError } from './tree.js';
...
class IndexTreeModel {
    ...
    spliceSimple(location, deleteCount, toInsert = Iterable.empty(), { onDidCreateNode, onDidDeleteNode, diffIdentityProvider }) {
        ...
        const nodesToInsertIterator = ( Iterable.map(
            toInsert,
            el => this.createTreeNode(el, parentNode, parentNode.visible ? TreeVisibility.Visible : TreeVisibility.Hidden, revealed, treeListElementsToInsert, onDidCreateNode)
        ));

...
import { EventHelper, getWindow, createStyleSheet, isActiveElement, isHTMLElement, getActiveElement, asCssValueWithDefault, isMouseEvent } from '../../dom.js';
import { DomEmitter } from '../../event.js';
import { StandardKeyboardEvent } from '../../keyboardEvent.js';
import { Gesture } from '../../touch.js';
import { alert } from '../aria/aria.js';
import { CombinedSpliceable } from './splice.js';
import { firstOrDefault, binarySearch, range } from '../../../common/arrays.js';
import { timeout } from '../../../common/async.js';
import { Color } from '../../../common/color.js';
import { memoize } from '../../../common/decorators.js';
import { Event, EventBufferer, Emitter } from '../../../common/event.js';
...
class List {
    ...
    get onContextMenu() {
        ...
        const fromMouse = Event.chain(this.view.onContextMenu, $ => ( $.filter(_ => !didJustPressContextMenuKey)
            .map(
            ({ element, index, browserEvent }) => ({ element, index, anchor: ( new StandardMouseEvent(getWindow(this.view.domNode), browserEvent)), browserEvent })
        )));
...
export { DefaultKeyboardNavigationDelegate, DefaultStyleController, List, MouseController, TypeNavigationMode, isActionItem, isButton, isInputElement, isMonacoCustomToggle, isMonacoEditor, isSelectionRangeChangeEvent, isSelectionSingleChangeEvent, isStickyScrollContainer, isStickyScrollElement, unthemedListStyles };

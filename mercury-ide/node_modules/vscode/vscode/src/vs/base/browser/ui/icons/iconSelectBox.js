...
import { $, append, clearNode, addDisposableListener, EventType } from '../../dom.js';
import { alert } from '../aria/aria.js';
import { InputBox } from '../inputbox/inputBox.js';
import { DomScrollableElement } from '../scrollbar/scrollableElement.js';
import { Emitter } from '../../../common/event.js';
import { Disposable, MutableDisposable, DisposableStore } from '../../../common/lifecycle.js';
...
class IconSelectBox extends Disposable {
    ...
    create() {
        ...
        this.inputBox = disposables.add(( (new InputBox(iconSelectInputContainer, undefined, {
            placeholder: ( localize(10918, "Search icons")),
    ...
    renderIcons(icons, matches, container) {
        ...
        if (icons.length) {
            ...
            const noResults = ( localize(10919, "No results"));

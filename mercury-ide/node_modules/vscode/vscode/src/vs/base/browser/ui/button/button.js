...
class ButtonWithDropdown extends Disposable {
    constructor(container, options) {
        ...
        this._register(getBaseLayerHoverDelegate().setupManagedHover(getDefaultHoverDelegate('mouse'), this.dropdownButton.element, ( localize(8811, 'More Actions...'))));
...
export { Button, ButtonBar, ButtonWithDescription, ButtonWithDropdown, unthemedButtonStyles };

...
import { sanitize, addHook, removeHook } from './dompurify/dompurify.js';
import { KeyCode } from '../common/keyCodes.js';
import { Disposable, DisposableStore, toDisposable } from '../common/lifecycle.js';
import { RemoteAuthorities, FileAccess, Schemas } from '../common/network.js';
import { isIOS, isMacintosh, isLinux } from '../common/platform.js';
import { URI } from '../common/uri.js';
import { hash } from '../common/hash.js';
import { mainWindow, ensureCodeWindow } from './window.js';
...
function safeInnerHtml(node, value) {
    ...
    try {
        const html = sanitize(value, defaultDomPurifyConfig);
        node.innerHTML = html;
    }
    finally {
        hook.dispose();

import { IHoverWidget, IManagedHoverOptions } from './hover.js';
...
interface IHoverDelegateOptions extends IManagedHoverOptions {
    /**
...
export type { IHoverDelegate, IHoverDelegateOptions, IHoverDelegateTarget };

...
import { $, getWindow, append, EventType, addDisposableListener, EventHelper, trackFocus, isHTMLElement, clearNode } from '../../dom.js';
...
import { SplitView, Sizing } from './splitview.js';
class Pane extends Disposable {
    ...
    constructor(options) {
        ...
        this._ariaHeaderLabel = ( localize(9986, "{0} Section", options.title));
...
class PaneView extends Disposable {
    constructor(container, options = {}) {
        ...
        const onHeaderKeyDown = ( (Event.map(
            Event.filter(onKeyDown.event, e => isHTMLElement(e.target) && e.target.classList.contains('pane-header'), eventDisposables),
            e => ( (new StandardKeyboardEvent(e))),
            eventDisposables
        )));

...
import { CONTEXT_LOG_LEVEL, LogLevelToString, LogLevel } from '../../log/common/log.js';
...
class AbstractRequestService extends Disposable {
    constructor(loggerService) {
        ...
        this.logger = loggerService.createLogger('network', {
            name: ( localize(4590, "Network Requests")),
    ...
    proxyConfiguration = {
        ...
        properties: {
            ...
            'http.proxySupport': {
                ...
                enumDescriptions: [
                    ( localize(4597, "Disable proxy support for extensions.")),
                    ( localize(4598, "Enable proxy support for extensions.")),
                    ( localize(
                        4599,
                        "Enable proxy support for extensions, fall back to request options, when no proxy found."
                    )),
                    ( localize(4600, "Enable proxy support for extensions, override request options.")),
                ],
                default: 'override',
                description: ( localize(4601, "Use the proxy support for extensions.")),
                restricted: true
            },

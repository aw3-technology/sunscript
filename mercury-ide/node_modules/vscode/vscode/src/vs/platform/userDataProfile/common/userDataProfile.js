...
let UserDataProfilesService = class UserDataProfilesService extends Disposable {
    ...
    createDefaultProfile() {
        const defaultProfile = toUserDataProfile('__default__profile__', ( localize(567, "Default")), this.environmentService.userRoamingDataHome, this.profilesCacheHome);
...
export { ProfileResourceType, UserDataProfilesService, isUserDataProfile, reviveProfile, toUserDataProfile };

...
const errorEmptyString = ( localize(556, "Empty context key expression"));
...
const errorNoInAfterNot = ( localize(558, "'in' after 'not'."));
const errorClosingParenthesis = ( localize(559, "closing parenthesis ')'"));
const errorUnexpectedToken = ( localize(560, "Unexpected token"));
const hintUnexpectedToken = ( localize(561, "Did you forget to put && or || before the token?"));
const errorUnexpectedEOF = ( localize(562, "Unexpected end of expression"));
const hintUnexpectedEOF = ( localize(563, "Did you forget to put a context key?"));
class Parser {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = ( localize(564, "Expected: {0}\nReceived: '{1}'.", expected, Scanner.getLexeme(got)));
                ...
                return (
                     (parser.lexingErrors.map((se) => ({
                        errorMessage: se.additionalInfo ?
                            ( localize(565, "Unexpected token. Hint: {0}", se.additionalInfo)) :
                            ( localize(566, "Unexpected token.")),
                        offset: se.offset,

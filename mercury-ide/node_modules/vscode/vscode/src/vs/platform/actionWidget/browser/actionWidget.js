...
registerColor('actionBar.toggledBackground', inputActiveOptionBackground, ( localize(9855, 'Background color for toggled action items in action bar.')));
const ActionWidgetContextKeys = {
    Visible: ( (new RawContextKey('codeActionMenuVisible', false, ( localize(9856, "Whether the action widget list is visible")))))
};
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9857, "Hide action widget")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9858, "Select previous action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9859, "Select next action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9860, "Accept selected action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9861, "Preview selected action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,

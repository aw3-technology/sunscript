    ...
    renderElement(element, _index, data) {
        ...
        if (element.disabled) {
            ...
            if (this._supportsPreview && element.canPreview) {
                data.container.title = ( localize(11229, "{0} to Apply, {1} to Preview", actionTitle, previewTitle));
            }
            else {
                data.container.title = ( localize(11230, "{0} to Apply", actionTitle));
            }
        }
        else {
            ...
            accessibilityProvider: {
                getAriaLabel: element => {
                    if (element.kind === ActionListItemKind.Action) {
                        ...
                        if (element.disabled) {
                            label = ( localize(11231, "{0}, Disabled Reason: {1}", label, element.disabled));
                        }
                        return label;
                    }
                    return null;
                },
                getWidgetAriaLabel: () => ( localize(11232, "Action Widget")),

    ...
    constructor() {
        ...
        this.tokenStylingSchema = {
            ...
            definitions: {
                style: {
                    type: 'object',
                    description: ( localize(6187, 'Colors and styles for the token.')),
                    properties: {
                        foreground: {
                            type: 'string',
                            description: ( localize(6188, 'Foreground color for the token.')),
                            format: 'color-hex',
                            default: '#ff0000'
                        },
                        background: {
                            type: 'string',
                            deprecationMessage: ( localize(6189, 'Token background colors are currently not supported.'))
                        },
                        fontStyle: {
                            type: 'string',
                            ...
                            defaultSnippets: [
                                { label: ( localize(6192, 'None (clear inherited style)')), bodyText: '""' },
                                { body: 'italic' },
                                { body: 'bold' },
                                { body: 'underline' },
                                { body: 'strikethrough' },
...
function createDefaultTokenClassificationRegistry() {
    ...
    registerTokenType('comment', ( localize(6197, "Style for comments.")), [['comment']]);
    registerTokenType('string', ( localize(6198, "Style for strings.")), [['string']]);
    registerTokenType('keyword', ( localize(6199, "Style for keywords.")), [['keyword.control']]);
    registerTokenType('number', ( localize(6200, "Style for numbers.")), [['constant.numeric']]);
    registerTokenType('regexp', ( localize(6201, "Style for expressions.")), [['constant.regexp']]);
    registerTokenType('operator', ( localize(6202, "Style for operators.")), [['keyword.operator']]);
    registerTokenType('namespace', ( localize(6203, "Style for namespaces.")), [['entity.name.namespace']]);
    registerTokenType('type', ( localize(6204, "Style for types.")), [['entity.name.type'], ['support.type']]);
    registerTokenType('struct', ( localize(6205, "Style for structs.")), [['entity.name.type.struct']]);
    registerTokenType('class', ( localize(6206, "Style for classes.")), [['entity.name.type.class'], ['support.class']]);
    registerTokenType('interface', ( localize(6207, "Style for interfaces.")), [['entity.name.type.interface']]);
    registerTokenType('enum', ( localize(6208, "Style for enums.")), [['entity.name.type.enum']]);
    registerTokenType('typeParameter', ( localize(6209, "Style for type parameters.")), [['entity.name.type.parameter']]);
    registerTokenType('function', ( localize(6210, "Style for functions")), [['entity.name.function'], ['support.function']]);
    registerTokenType('member', ( localize(6211, "Style for member functions")), [], 'method', 'Deprecated use `method` instead');
    registerTokenType('method', ( localize(6212, "Style for method (member functions)")), [['entity.name.function.member'], ['support.function']]);
    registerTokenType('macro', ( localize(6213, "Style for macros.")), [['entity.name.function.preprocessor']]);
    registerTokenType('variable', ( localize(6214, "Style for variables.")), [['variable.other.readwrite'], ['entity.name.variable']]);
    registerTokenType('parameter', ( localize(6215, "Style for parameters.")), [['variable.parameter']]);
    registerTokenType('property', ( localize(6216, "Style for properties.")), [['variable.other.property']]);
    registerTokenType('enumMember', ( localize(6217, "Style for enum members.")), [['variable.other.enummember']]);
    registerTokenType('event', ( localize(6218, "Style for events.")), [['variable.other.event']]);
    registerTokenType('decorator', ( localize(6219, "Style for decorators & annotations.")), [['entity.name.decorator'], ['entity.name.function']]);
    registerTokenType('label', ( localize(6220, "Style for labels. ")), undefined);
    registry.registerTokenModifier('declaration', ( localize(6221, "Style for all symbol declarations.")), undefined);
    registry.registerTokenModifier('documentation', ( localize(6222, "Style to use for references in documentation.")), undefined);
    registry.registerTokenModifier('static', ( localize(6223, "Style to use for symbols that are static.")), undefined);
    registry.registerTokenModifier('abstract', ( localize(6224, "Style to use for symbols that are abstract.")), undefined);
    registry.registerTokenModifier('deprecated', ( localize(6225, "Style to use for symbols that are deprecated.")), undefined);
    registry.registerTokenModifier('modification', ( localize(6226, "Style to use for write accesses.")), undefined);
    registry.registerTokenModifier('async', ( localize(6227, "Style to use for symbols that are async.")), undefined);
    registry.registerTokenModifier('readonly', ( localize(6228, "Style to use for symbols that are read-only.")), undefined);

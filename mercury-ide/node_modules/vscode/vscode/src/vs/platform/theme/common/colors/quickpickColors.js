...
const pickerGroupForeground = registerColor('pickerGroup.foreground', { dark: '#3794FF', light: '#0066BF', hcDark: Color.white, hcLight: '#0F4A85' }, ( localize(1919, "Quick picker color for grouping labels.")));
const pickerGroupBorder = registerColor('pickerGroup.border', { dark: '#3F3F46', light: '#CCCEDB', hcDark: Color.white, hcLight: '#0F4A85' }, ( localize(1920, "Quick picker color for grouping borders.")));
const _deprecatedQuickInputListFocusBackground = registerColor('quickInput.list.focusBackground', null, '', undefined, ( localize(1921, "Please use quickInputList.focusBackground instead")));
const quickInputListFocusForeground = registerColor('quickInputList.focusForeground', listActiveSelectionForeground, ( localize(1922, "Quick picker foreground color for the focused item.")));
const quickInputListFocusIconForeground = registerColor('quickInputList.focusIconForeground', listActiveSelectionIconForeground, ( localize(1923, "Quick picker icon foreground color for the focused item.")));
const quickInputListFocusBackground = registerColor('quickInputList.focusBackground', { dark: oneOf(_deprecatedQuickInputListFocusBackground, listActiveSelectionBackground), light: oneOf(_deprecatedQuickInputListFocusBackground, listActiveSelectionBackground), hcDark: null, hcLight: null }, ( localize(1924, "Quick picker background color for the focused item.")));

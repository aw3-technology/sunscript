...
class ColorRegistry {
    ...
    registerColor(id, defaults, description, needsTransparency = false, deprecationMessage) {
        ...
        if (needsTransparency) {
            ...
            propertySchema.patternErrorMessage = ( localize(1694, 'This color must be transparent or it will obscure content'));
        }
        this.colorSchema.properties[id] = {
            oneOf: [
                propertySchema,
                { type: 'string', const: DEFAULT_COLOR_CONFIG_VALUE, description: ( localize(1695, 'Use the default color.')) }
            ]
        };

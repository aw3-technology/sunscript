import { ContextKeyExprType, expressionsAreEqualWithConstantSubstitution, implies } from '../../contextkey/common/contextkey.js';
var ResultKind;
( (function(ResultKind) {
...
const NoMatchingKb = { kind: ResultKind.NoMatchingKb };
const MoreChordsNeeded = { kind: ResultKind.MoreChordsNeeded };
...
export { KeybindingResolver, NoMatchingKb, ResultKind };

...
import { onDidRegisterWindow, onWillUnregisterWindow, getWindow, EventType, addDisposableListener, append, createStyleSheet, addStandardDisposableListener, reset, isAncestorOfActiveElement, $ as $$1, trackFocus, isAncestor, isHTMLElement, EventHelper } from '../../../base/browser/dom.js';
...
import { InQuickInputContextKey, QuickInputTypeContextKey, EndOfQuickInputBoxContextKey, backButton, QuickPick, InputBox, QuickWidget } from './quickInput.js';
...
let QuickInputController = class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        checkAll.setAttribute('aria-label', ( localize(5279, "Toggle all checkboxes")));
        ...
        const visibleCount = ( (new CountBadge(visibleCountContainer, { countFormat: ( localize(5280, "{0} Results")) }, this.styles.countBadge)));
        const countContainer = append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = ( (new CountBadge(countContainer, { countFormat: ( localize(5281, "{0} Selected")) }, this.styles.countBadge)));
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? ( localize(5284, "Back ({0})", backKeybindingLabel)) : ( localize(5285, "Back"));

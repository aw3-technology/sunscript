...
import { renderQuickInputDescription, quickInputButtonToAction } from './quickInputUtils.js';
...
const InQuickInputContextKey = ( (new RawContextKey(inQuickInputContextKeyValue, false, ( localize(5271, "Whether keyboard focus is inside the quick input control")))));
...
const QuickInputTypeContextKey = ( (new RawContextKey(quickInputTypeContextKeyValue, undefined, ( localize(5272, "The type of the currently visible quick input")))));
...
const backButton = {
    ...
    tooltip: ( localize(5274, "Back")),
    handle: -1
};
class QuickInput extends Disposable {
    static { this.noPromptMessage = ( localize(5275, "Press 'Enter' to confirm your input or 'Escape' to cancel")); }
    constructor(ui) {
        super();
        this.ui = ui;
    ...
    getSteps() {
        if (this.step && this.totalSteps) {
            return ( localize(5276, "{0}/{1}", this.step, this.totalSteps));
        }
        if (this.step) {
...
class QuickPick extends QuickInput {
    ...
    static { this.DEFAULT_ARIA_LABEL = ( localize(5277, "Type to narrow down results.")); }
    get quickNavigate() {
...
class InputBox extends QuickInput {
    ...
    set prompt(prompt) {
        ...
        this.noValidationMessage = prompt
            ? ( localize(5278, "{0} (Press 'Enter' to confirm or 'Escape' to cancel)", prompt))
...
export { EndOfQuickInputBoxContextKey, InQuickInputContextKey, InputBox, QuickInputHoverDelegate, QuickInputTypeContextKey, QuickPick, QuickWidget, backButton, endOfQuickInputBoxContext, endOfQuickInputBoxContextKeyValue, inQuickInputContext, inQuickInputContextKeyValue, quickInputTypeContextKeyValue };

...
import { SocketCloseEventType, Client, PersistentProtocol } from '../../../base/parts/ipc/common/ipc.net.js';
...
async function doConnectRemoteAgentExtensionHost(options, startArguments, timeoutCancellationToken) {
    const { protocol, firstMessage } = await connectToRemoteExtensionHostAgentAndReadOneMessage(options, ConnectionType.ExtensionHost, startArguments, timeoutCancellationToken);
...
class ConnectionLostEvent {
    constructor(reconnectionToken, millisSinceLastIncomingData) {
        ...
        this.type = PersistentConnectionEventType.ConnectionLost;
    }
}
class ReconnectionWaitEvent {
    constructor(reconnectionToken, millisSinceLastIncomingData, durationSeconds, cancellableTimer) {
        ...
        this.type = PersistentConnectionEventType.ReconnectionWait;
    }
    skipWait() {
...
class ReconnectionRunningEvent {
    constructor(reconnectionToken, millisSinceLastIncomingData, attempt) {
        ...
        this.type = PersistentConnectionEventType.ReconnectionRunning;
    }
}
class ConnectionGainEvent {
    constructor(reconnectionToken, millisSinceLastIncomingData, attempt) {
        ...
        this.millisSinceLastIncomingData = millisSinceLastIncomingData;
        this.attempt = attempt;
        this.type = PersistentConnectionEventType.ConnectionGain;
    }
}
class ReconnectionPermanentFailureEvent {
    constructor(reconnectionToken, millisSinceLastIncomingData, attempt, handled) {
        ...
        this.type = PersistentConnectionEventType.ReconnectionPermanentFailure;
    }
}
...
export { ConnectionGainEvent, ConnectionLostEvent, ConnectionType, ExtensionHostPersistentConnection, ManagementPersistentConnection, PersistentConnection, PersistentConnectionEventType, ReconnectionPermanentFailureEvent, ReconnectionRunningEvent, ReconnectionWaitEvent, connectRemoteAgentExtensionHost, connectRemoteAgentManagement };

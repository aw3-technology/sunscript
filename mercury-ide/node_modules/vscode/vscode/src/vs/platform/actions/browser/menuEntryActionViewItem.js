...
import { ModifierKeyEmitter, addDisposableListener, asCSSUrl, prepend, $, append, EventType } from '../../../base/browser/dom.js';
...
import { Separator, SubmenuAction, ActionRunner } from '../../../base/common/actions.js';
...
import './menuEntryActionViewItem.css.js';
...
import { IContextMenuService, IContextViewService } from '../../contextview/browser/contextView.service.js';
...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
    ...
    getTooltip() {
        ...
        let title = keybindingLabel
            ? ( localize(4886, "{0} ({1})", tooltip, keybindingLabel))
            : tooltip;
        if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
            ...
            const altTitleSection = altKeybindingLabel
                ? ( localize(4886, "{0} ({1})", altTooltip, altKeybindingLabel))
                : altTooltip;
            title = ( localize(
                4887,
                "{0}\n[{1}] {2}",
    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if (this._options?.conversational) {
                this.label.textContent = ( localize(4888, '{1} to {0}', this._action.label, kb2));
            }
            else {
                this.label.textContent = ( localize(4889, '{0} ({1})', this._action.label, kb2));
            }
        }
    }
...
export { DropdownWithDefaultActionViewItem, MenuEntryActionViewItem, SubmenuEntryActionViewItem, TextOnlyMenuEntryActionViewItem, createActionViewItem, createAndFillInActionBarActions, createAndFillInContextMenuActions };

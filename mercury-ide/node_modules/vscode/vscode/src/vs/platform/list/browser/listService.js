...
import { isKeyboardEvent, createStyleSheet, isActiveElement } from '../../../base/browser/dom.js';
import { PagedList } from '../../../base/browser/ui/list/listPaging.js';
import { List, TypeNavigationMode, DefaultStyleController, isSelectionSingleChangeEvent, isSelectionRangeChangeEvent } from '../../../base/browser/ui/list/listWidget.js';
...
import { IListService } from './listService.service.js';
class ListService {
    get lastFocusedList() {
    ...
    properties: {
        [multiSelectModifierSettingKey]: {
            ...
            markdownEnumDescriptions: [
                ( localize(1296, "Maps to `Control` on Windows and Linux and to `Command` on macOS.")),
                ( localize(1297, "Maps to `Alt` on Windows and Linux and to `Option` on macOS."))
            ],
            default: 'ctrlCmd',
        ...
        [scrollByPageKey]: {
            type: 'boolean',
            default: false,
            description: ( localize(1301, "Controls whether clicks in the scrollbar scroll page by page."))
        },
        [treeIndentKey]: {
            type: 'number',
            default: 8,
            minimum: 4,
            maximum: 40,
            description: ( localize(1302, "Controls tree indentation in pixels."))
        },
        [treeRenderIndentGuidesKey]: {
            type: 'string',
            enum: ['none', 'onHover', 'always'],
            default: 'onHover',
            description: ( localize(1303, "Controls whether the tree should render indent guides."))
        },
        [listSmoothScrolling]: {
            type: 'boolean',
            default: false,
            description: ( localize(1304, "Controls whether lists and trees have smooth scrolling.")),
        },
        ...
        [fastScrollSensitivityKey]: {
            type: 'number',
            default: 5,
            markdownDescription: ( localize(1306, "Scrolling speed multiplier when pressing `Alt`."))
        },
        [defaultFindModeSettingKey]: {
            ...
            enumDescriptions: [
                ...
                ( localize(1308, "Filter elements when searching."))
            ],
            default: 'highlight',
            description: ( localize(
                1309,
        ...
        [defaultFindMatchTypeSettingKey]: {
            ...
            enumDescriptions: [
                ( localize(1315, "Use fuzzy matching when searching.")),
                ( localize(1316, "Use contiguous matching when searching."))
            ],
            default: 'fuzzy',
            description: ( localize(
                1317,
        ...
        [treeStickyScroll]: {
            type: 'boolean',
            default: true,
            description: ( localize(1319, "Controls whether sticky scrolling is enabled in trees.")),
        },
...
export { ListService, RawWorkbenchListFocusContextKey, RawWorkbenchListScrollAtBoundaryContextKey, WorkbenchAsyncDataTree, WorkbenchCompressibleAsyncDataTree, WorkbenchCompressibleObjectTree, WorkbenchDataTree, WorkbenchList, WorkbenchListDoubleSelection, WorkbenchListFocusContextKey, WorkbenchListHasSelectionOrFocus, WorkbenchListMultiSelection, WorkbenchListScrollAtBottomContextKey, WorkbenchListScrollAtTopContextKey, WorkbenchListSelectionNavigation, WorkbenchListSupportsFind, WorkbenchListSupportsMultiSelectContextKey, WorkbenchObjectTree, WorkbenchPagedList, WorkbenchTable, WorkbenchTreeElementCanCollapse, WorkbenchTreeElementCanExpand, WorkbenchTreeElementHasChild, WorkbenchTreeElementHasParent, WorkbenchTreeFindOpen, WorkbenchTreeStickyScrollFocused, getSelectionKeyboardEvent };

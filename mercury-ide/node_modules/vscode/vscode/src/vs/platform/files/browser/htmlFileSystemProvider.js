...
import { FileSystemProviderCapabilities, FileSystemProviderErrorCode, FileType, FileSystemProviderError, createFileSystemProviderError } from '../common/files.js';
...
class HTMLFileSystemProvider {
    ...
    async rename(from, to, opts) {
        try {
            ...
            if (fileHandle) {
                ...
                throw this.createFileSystemProviderError(from, localize(607, "Rename is only supported for files."), FileSystemProviderErrorCode.Unavailable);
            }
        }
        catch (error) {
            throw this.toFileSystemProviderError(error);
    ...
    toFileSystemProviderError(error) {
        ...
        if (error.name === 'NotAllowedError') {
            error = ( (new Error(( localize(608, "Insufficient permissions. Please retry and allow the operation.")))));

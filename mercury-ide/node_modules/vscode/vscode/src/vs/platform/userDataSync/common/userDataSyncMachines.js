...
import { isSafari, isChrome, isEdge, isFirefox, isAndroid, PlatformToString, isWeb, Platform, platform } from '../../../base/common/platform.js';
...
import { IUserDataSyncStoreService, IUserDataSyncLogService } from './userDataSync.service.js';
...
let UserDataSyncMachinesService = class UserDataSyncMachinesService extends Disposable {
    ...
    async getMachines(manifest) {
        ...
        return ( machineData.machines.map(
            machine => ({ ...machine, ...{ isCurrent: machine.id === currentMachineId } })
        ));
    }
...
export { UserDataSyncMachinesService, isWebPlatform };

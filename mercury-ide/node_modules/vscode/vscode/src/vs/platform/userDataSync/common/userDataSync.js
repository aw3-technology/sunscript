...
import { Extensions, ConfigurationScope, parseScope, allSettings, getAllConfigurationProperties } from '../../configuration/common/configurationRegistry.js';
...
function registerConfiguration() {
    ...
    configurationRegistry.registerConfiguration({
        id: 'settingsSync',
        order: 30,
        title: ( localize(5682, "Settings Sync")),
        type: 'object',
        properties: {
            [CONFIG_SYNC_KEYBINDINGS_PER_PLATFORM]: {
                type: 'boolean',
                description: ( localize(5683, "Synchronize keybindings for each platform.")),
                default: true,
            ...
            'settingsSync.ignoredExtensions': {
                ...
                items: [{
                        ...
                        errorMessage: ( localize(5685, "Expected format '${publisher}.${name}'. Example: 'vscode.csharp'."))
                    }],
                'default': [],
                'scope': ConfigurationScope.APPLICATION,
                uniqueItems: true,
            ...
            'settingsSync.ignoredSettings': {
                'type': 'array',
                description: ( localize(5686, "Configure settings to be ignored while synchronizing.")),
                'default': [],
                'scope': ConfigurationScope.APPLICATION,
...
const ALL_SYNC_RESOURCES = [SyncResource.Settings, SyncResource.Keybindings, SyncResource.Snippets, SyncResource.Tasks, SyncResource.Extensions, SyncResource.GlobalState, SyncResource.Profiles];
...
( ((function(UserDataSyncError) {
    function toUserDataSyncError(error) {
        ...
        return (
             (new UserDataSyncError(error.message, UserDataSyncErrorCode.Unknown))
        );
    }

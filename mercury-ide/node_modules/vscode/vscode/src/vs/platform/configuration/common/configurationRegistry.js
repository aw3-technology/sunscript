...
class ConfigurationRegistry {
    constructor() {
        ...
        this.defaultLanguageConfigurationOverridesNode = {
            id: 'defaultOverrides',
            title: ( localize(472, "Default Language Configuration Overrides")),
            properties: {}
        };
    ...
    updateOverridePropertyPatternKey() {
        for (const overrideIdentifier of ( (this.overrideIdentifiers.values()))) {
            ...
            const resourceLanguagePropertiesSchema = {
                type: 'object',
                description: ( localize(474, "Configure editor settings to be overridden for a language.")),
                errorMessage: ( localize(475, "This setting does not support per-language configuration.")),
                $ref: resourceLanguageSettingsSchemaId,
            };
...
function validateProperty(property, schema) {
    if (!property.trim()) {
        return ( localize(476, "Cannot register an empty property"));
    }

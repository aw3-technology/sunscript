...
const ERR_FILE_NOT_FOUND = createFileSystemProviderError(( localize(609, "File does not exist")), FileSystemProviderErrorCode.FileNotFound);
const ERR_FILE_IS_DIR = createFileSystemProviderError(( localize(610, "File is Directory")), FileSystemProviderErrorCode.FileIsADirectory);
const ERR_FILE_NOT_DIR = createFileSystemProviderError(( localize(611, "File is not a directory")), FileSystemProviderErrorCode.FileNotADirectory);
const ERR_DIR_NOT_EMPTY = createFileSystemProviderError(( localize(612, "Directory is not empty")), FileSystemProviderErrorCode.Unknown);
const ERR_FILE_EXCEEDS_STORAGE_QUOTA = createFileSystemProviderError(( localize(613, "File exceeds available storage quota")), FileSystemProviderErrorCode.FileExceedsStorageQuota);

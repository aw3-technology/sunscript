...
import { IndentAction } from 'vscode/vscode/vs/editor/common/languages/languageConfiguration';
...
const schema = {
    ...
    definitions: {
        openBracket: {
            type: 'string',
            description: ( localize(2494, 'The opening bracket character or string sequence.'))
        },
        closeBracket: {
            type: 'string',
            description: ( localize(2495, 'The closing bracket character or string sequence.'))
        },
        bracketPair: {
            type: 'array',
            items: [{
    ...
    properties: {
        comments: {
            ...
            description: ( localize(2496, 'Defines the comment symbols')),
            type: 'object',
            properties: {
                blockComment: {
                    type: 'array',
                    description: ( localize(2497, 'Defines how block comments are marked.')),
                    items: [{
                            type: 'string',
                            description: ( localize(2498, 'The character sequence that starts a block comment.'))
                        }, {
                            type: 'string',
                            description: ( localize(2499, 'The character sequence that ends a block comment.'))
                        }]
                },
                lineComment: {
                    type: 'string',
                    description: ( localize(2500, 'The character sequence that starts a line comment.'))
                }
            }
        },
        brackets: {
            ...
            items: {
                oneOf: [{
                        ...
                        properties: {
                            ...
                            notIn: {
                                type: 'array',
                                description: ( localize(2504, 'Defines a list of scopes where the auto pairs are disabled.')),
                                items: {
                                    enum: ['string', 'comment']
                                }
                            }
        ...
        wordPattern: {
            ...
            properties: {
                pattern: {
                    type: 'string',
                    description: ( localize(2508, 'The RegExp pattern used to match words.')),
                    default: '',
                },
                flags: {
                    type: 'string',
                    description: ( localize(2509, 'The RegExp flags used to match words.')),
                    default: 'g',
                    pattern: '^([gimuy]+)$',
                    patternErrorMessage: ( localize(2510, 'Must match the pattern `/^([gimuy]+)$/`.'))
                }
            }
        },
        indentationRules: {
            ...
            description: ( localize(2511, 'The language\'s indentation settings.')),
            type: 'object',
            properties: {
                increaseIndentPattern: {
                    type: ['string', 'object'],
                    ...
                    properties: {
                        pattern: {
                            type: 'string',
                            description: ( localize(2513, 'The RegExp pattern for increaseIndentPattern.')),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: ( localize(2514, 'The RegExp flags for increaseIndentPattern.')),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: ( localize(2515, 'Must match the pattern `/^([gimuy]+)$/`.'))
                        }
                    }
                },
                decreaseIndentPattern: {
                    ...
                    properties: {
                        pattern: {
                            type: 'string',
                            description: ( localize(2517, 'The RegExp pattern for decreaseIndentPattern.')),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: ( localize(2518, 'The RegExp flags for decreaseIndentPattern.')),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: ( localize(2519, 'Must match the pattern `/^([gimuy]+)$/`.'))
                        }
                    }
                },
                indentNextLinePattern: {
                    ...
                    properties: {
                        pattern: {
                            type: 'string',
                            description: ( localize(2521, 'The RegExp pattern for indentNextLinePattern.')),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: ( localize(2522, 'The RegExp flags for indentNextLinePattern.')),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: ( localize(2523, 'Must match the pattern `/^([gimuy]+)$/`.'))
                        }
                    }
                },
                unIndentedLinePattern: {
                    ...
                    properties: {
                        pattern: {
                            type: 'string',
                            description: ( localize(2525, 'The RegExp pattern for unIndentedLinePattern.')),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: ( localize(2526, 'The RegExp flags for unIndentedLinePattern.')),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: ( localize(2527, 'Must match the pattern `/^([gimuy]+)$/`.'))
                        }
                    }
                }
            }
        ...
        folding: {
            type: 'object',
            description: ( localize(2528, 'The language\'s folding settings.')),
            properties: {
                offSide: {
                    type: 'boolean',
                    description: ( localize(
        ...
        onEnterRules: {
            type: 'array',
            description: ( localize(2533, 'The language\'s rules to be evaluated when pressing Enter.')),
            items: {
                type: 'object',
                description: ( localize(2533, 'The language\'s rules to be evaluated when pressing Enter.')),
                ...
                properties: {
                    beforeText: {
                        ...
                        properties: {
                            pattern: {
                                type: 'string',
                                description: ( localize(2535, 'The RegExp pattern for beforeText.')),
                                default: '',
                            },
                            flags: {
                                type: 'string',
                                description: ( localize(2536, 'The RegExp flags for beforeText.')),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: ( localize(2537, 'Must match the pattern `/^([gimuy]+)$/`.'))
                            }
                        }
                    },
                    afterText: {
                        ...
                        properties: {
                            pattern: {
                                type: 'string',
                                description: ( localize(2539, 'The RegExp pattern for afterText.')),
                                default: '',
                            },
                            flags: {
                                type: 'string',
                                description: ( localize(2540, 'The RegExp flags for afterText.')),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: ( localize(2541, 'Must match the pattern `/^([gimuy]+)$/`.'))
                            }
                        }
                    },
                    previousLineText: {
                        ...
                        properties: {
                            pattern: {
                                type: 'string',
                                description: ( localize(2543, 'The RegExp pattern for previousLineText.')),
                                default: '',
                            },
                            flags: {
                                type: 'string',
                                description: ( localize(2544, 'The RegExp flags for previousLineText.')),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: ( localize(2545, 'Must match the pattern `/^([gimuy]+)$/`.'))
                            }
                        }
                    },
                    action: {
                        type: ['string', 'object'],
                        description: ( localize(2546, 'The action to execute.')),
                        required: ['indent'],
                        default: { 'indent': 'indent' },
                        properties: {
                            indent: {
                                type: 'string',
                                description: ( localize(2547, "Describe what to do with the indentation")),
                                default: 'indent',
                                enum: ['none', 'indent', 'indentOutdent', 'outdent'],
                                markdownEnumDescriptions: [
                                    ( localize(2548, "Insert new line and copy the previous line's indentation.")),
                                    ( localize(
                                        2549,
...
let LanguageConfigurationWorkbenchContribution = class LanguageConfigurationWorkbenchContribution {
    static { this.ID = 'workbench.contrib.languageConfigurationExtensionPoint'; }
    constructor(instantiationService) {
        this.instantiationService = instantiationService;
        this.instantiationService.createInstance(LanguageConfigurationFileHandler);
    }
};
LanguageConfigurationWorkbenchContribution = ( (__decorate([

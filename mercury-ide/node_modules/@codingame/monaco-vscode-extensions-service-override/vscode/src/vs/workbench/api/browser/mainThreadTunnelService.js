...
import { ExtHostContext, CandidatePortSource, MainContext } from 'vscode/vscode/vs/workbench/api/common/extHost.protocol';
import { TunnelDtoConverter } from 'vscode/vscode/vs/workbench/api/common/extHostTunnelService';
import { extHostNamedCustomer } from '../../services/extensions/common/extHostCustomers.js';
import { PORT_AUTO_FORWARD_SETTING, PORT_AUTO_SOURCE_SETTING, PORT_AUTO_SOURCE_SETTING_OUTPUT, PORT_AUTO_SOURCE_SETTING_HYBRID } from 'vscode/vscode/vs/workbench/services/remote/common/remoteExplorerService';
import { IRemoteExplorerService } from 'vscode/vscode/vs/workbench/services/remote/common/remoteExplorerService.service';
import { TunnelProtocol } from 'vscode/vscode/vs/platform/tunnel/common/tunnel';
...
import { TunnelSource, TunnelCloseReason, makeAddress, forwardedPortsViewEnabled } from 'vscode/vscode/vs/workbench/services/remote/common/tunnelModel';
...
let MainThreadTunnelService = class MainThreadTunnelService extends Disposable {
    ...
    async elevationPrompt(tunnelOptions, tunnel, source) {
        return this.notificationService.prompt(Severity$1.Info, ( localize(
            ...
            tunnelOptions.localAddressPort
                ...
                label: ( localize(4877, "Use Port {0} as Sudo...", tunnel.tunnelRemotePort)),
                run: async () => {
    ...
    async $getTunnels() {
        return (
             ((await this.tunnelService.tunnels).map(tunnel => {
                return {

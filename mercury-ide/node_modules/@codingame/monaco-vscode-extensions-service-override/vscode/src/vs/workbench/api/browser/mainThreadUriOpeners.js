...
import { defaultExternalUriOpenerId } from 'vscode/vscode/vs/workbench/contrib/externalUriOpener/common/configuration';
            ...
            openExternalUri: async (uri, ctx, token) => {
                try {
                    ...
                    if (!isCancellationError(e)) {
                        const openDefaultAction = ( (new Action('default', ( localize(4866, "Open using default opener")), undefined, undefined, async () => {

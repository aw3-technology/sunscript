...
import { StandaloneQuickInputService } from 'vscode/vscode/vs/editor/standalone/browser/quickInput/standaloneQuickInputService';
...
import 'vscode/vscode/vs/workbench/contrib/codeEditor/browser/quickaccess/gotoSymbolQuickAccess';
...
let shouldUseGlobalPicker = (_activeCodeEditor, _activeCodeEditorStandalone) => {
    return false;
};
